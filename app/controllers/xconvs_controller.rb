  ...
  def show
    ...
    respond_to do |format|
      ...
      format.all {
        ...
        send_file_with_range generator.real_path, type: Mime[generator.recipe_info.real_ext], disposition: params[:disposition] || "inline", filename: xconv_record.filename_human
      }
    end
  end
end
