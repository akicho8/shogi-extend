module Api
  class TrainingController
    concern :PutApi do
      ...
      # curl -d _method=put -d _user_id=1 -d remote_action=session_lock_token_set_handle -d session_lock_token=xxx http://localhost:3000/api/training.json
      ...
      # curl -d _method=put -d _user_id=1 -d remote_action=session_lock_token_valid_handle -d session_lock_token=xxx http://localhost:3000/api/training.json
      ...
      # curl -d _method=put -d _user_id=1 -d remote_action=session_lock_token_reset_handle http://localhost:3000/api/training.json
      # def session_lock_token_reset_handle
      #   current_user.actb_setting.update!(session_lock_token: nil)
      #   { status: "success" }
      # end

      # curl -d _method=put -d _user_id=1 -d remote_action=rule_key_set_handle -d rule_key=sy_marathon http://localhost:3000/api/training.json
