...
# >> |       user | {:id=>1, :name=>"SYSOP", :show_path=>"/online/users/1", :avatar_url=>"/assets/human/0030_fallback_face_icon-be08e49b2d7a08a5cd56200edc1c31b901847ba52392a4885ee632a9d0fe974d.png"} |
# >> |------------+------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
