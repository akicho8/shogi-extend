...
class BattleRoomShowSerializer < ApplicationSerializer
  ...
  attributes *[
    ...
    :current_users_count, :watch_memberships_count,
...
if $0 == __FILE__
  pp ams_sr(BattleRoom.last, serializer: BattleRoomShowSerializer, include: {memberships: :user, chat_messages: :user, watch_users: nil})
end
# >> I, [2018-06-12T20:36:01.376431 #38956]  INFO -- : Rendered BattleRoomShowSerializer with ActiveModelSerializers::Adapter::Attributes (1952.99ms)
# >> {:id=>53,
# >>  :name=>"#53",
...
# >>        "/assets/fallback_icons/0011_fallback_face_icon-28288cf16f08dc2cfc1a1fb81818a3fd0b2bda49e0f1884d38cbdfe2328f6f0b.png"}}],
# >>  :watch_users=>[]}
# >> I, [2018-06-12T20:36:01.406768 #38956]  INFO -- : Rendered BattleRoomShowSerializer with ActiveModelSerializers::Adapter::Attributes (14.62ms)
# >> {:id=>53,
# >>  :name=>"#53",
# >>  :show_path=>"/online/battles/53",
# >>  :begin_at=>Tue, 12 Jun 2018 20:22:30 JST +09:00,
