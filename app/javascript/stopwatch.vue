      ...
      const rule_dialog = this.$buefy.dialog.alert({
        ...
        message: `
          <div class="content is-size-7">
            ...
            <ul>
              <li>以前はURLに現在の状態を保持していましたが、それでブックマークしていると復帰したときに毎回その状態に戻ってしまうため、URLに状態を含めないようにしました。URLの後ろに「#」がついた状態でブックマークされている場合は、いったん破棄して、「#」がついていないURLでブックマークしなおしてみてください。そうすると前回の状態から再開できるようになります</li>
            </ul>
            <h5>基本</h5>
            <ol>
