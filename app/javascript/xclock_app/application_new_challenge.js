export const application_new_challenge = {
  ...
  methods: {
    ...
    async new_challenge_accept_handle(params) {
      ...
      }) // --> app/models/frontend_script/xclock_app_script/put_api.rb
    },
    ...
    new_challenge_message(params) {
      ...
      // app/javascript/xclock_app/application.sass で別定義あり
      return `<div class="xclock_app new_challenge_message is-flex">
               ${figure}${message}
              </div>`
    },
  }
