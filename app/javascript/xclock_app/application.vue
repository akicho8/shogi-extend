...
export default {
  ...
  data() {
    return {
      ...
      // リアクティブではないもの
      // $ac_school: null, // --> app/channels/xclock/school_channel.rb
      // $ac_lobby:  null, // --> app/channels/xclock/lobby_channel.rb
      // $ac_room:   null, // --> app/channels/xclock/room_channel.rb
      // $ac_battle: null, // --> app/channels/xclock/battle_channel.rb
    }
  },
  ...
  methods: {
    ...
    school_setup() {
      ...
      this.$ac_school = this.ac_subscription_create({channel: "Xclock::SchoolChannel"})
    },
    ...
    lobby_setup() {
      ...
      this.$ac_lobby = this.ac_subscription_create({channel: "Xclock::LobbyChannel"})
      this.lrt_start()
