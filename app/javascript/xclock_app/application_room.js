...
export const application_room = {
  ...
  methods: {
    ...
    room_setup(room) {
      ...
      this.$ac_room = this.ac_subscription_create({channel: "Xclock::RoomChannel", room_id: this.room.id})
    },
    ...
    // ↓
    // app/channels/xclock/room_channel.rb subscribed
    // ↓
    // app/jobs/xclock/battle_broadcast_job.rb broadcast
    // ↓
    ...
    room_speak(message_body) {
      ...
      this.$ac_battle.perform("speak", {message_body: message_body}) // --> app/channels/xclock/battle_channel.rb
    },
    ...
    ac_room_perform(action, params = {}) {
      ...
      this.$ac_room.perform(action, params) // --> app/channels/xclock/room_channel.rb
    },
