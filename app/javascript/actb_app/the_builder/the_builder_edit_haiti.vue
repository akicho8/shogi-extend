...
export default {
  ...
  created() {
    ...
    this.new_kifu_body = this.question.init_sfen
  },
  ...
  methods: {
    ...
    kifu_copy_handle() {
      this.sound_play("click")
      this.general_kifu_copy(this.question.init_sfen, {to_format: "kif"})
    },
  },

  computed: {
    piyo_shogi_app_with_params_url() { return this.piyo_shogi_auto_url({sfen: this.question.init_sfen, turn: 0, flip: false}) },
    kento_app_with_params_url()      { return this.kento_full_url({sfen: this.question.init_sfen, turn: 0, flip: false}) },
  },
}
</script>
