...
class User < ApplicationRecord
  ...
  concerning :MuteInfoMod do
    included do
      ...
      has_many :reverse_mute_infos, dependent: :destroy, class_name: "MuteInfo", foreign_key: :target_user_id, dependent: :destroy # 自分をミュートした人たち(中間情報)。定義しているのは外部キー制約があってもユーザー削除できるようにするためでもある
