...
module TsMaster
  class RuleInfo
    ...
    memory_record [
      ...
      { key: :rule_mate5_type1,  name: "5手詰",   mate:  5, o_count_max:  5, time_limit: nil, },
      { key: :rule_mate7_type1,  name: "7手詰",   mate:  7, o_count_max:  3, time_limit: nil, },
      { key: :rule_mate9_type1,  name: "9手詰",   mate:  9, o_count_max:  2, time_limit: nil, },
        ...
        def chartjs_datasets(params)
          ...
          names_hash.collect.with_index { |(name, _), i|
            ...
            v = result.find_all { |e| e.entry_name == name }
            {
              ...
              # app/javascript/ts_master_chart_mod.js
            }
          }.compact
