...
module AdminScript
  class Base < MyScript::Soul
    ...
    class_attribute :sub_label_name
    self.sub_label_name = nil

    class_attribute :icon_key
    self.icon_key = :question

    class_attribute :sql_log_display
    ...
    def script_body_run
      unless Rails.env.test?
        AlertLog.track("#{alert_log_subject}[開始]", :body => params.pretty_inspect)
      end
