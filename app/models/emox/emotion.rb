...
# == Schema Information ==
#
# エモーション (emox_emotions as Emox::Emotion)
#
# |------------+----------+-------------+-------------+---------------------------+-------|
...
# | folder_id  | Folder   | integer(8)  | NOT NULL    | => Emox::EmotionFolder#id | B     |
...
# 【警告:リレーション欠如】Emox::EmotionFolderモデルで has_many :emox/emotions されていません
#--------------------------------------------------------------------------------

# -*- compile-command: "rails r 'Emox::EmotionFolder.setup; User.first.emotions_setup(reset: true);'" -*-
...
module Emox
  class Emotion < ApplicationRecord
    ...
    belongs_to :folder, class_name: "Emox::EmotionFolder"
