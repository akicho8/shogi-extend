...
# == Schema Information ==
#
# Season xrecord (xclock_season_xrecords as Xclock::SeasonXrecord)
#
# |---------------------+---------------------+------------+-------------+--------------+-------|
...
module Xclock
  class SeasonXrecord < ApplicationRecord
    ...
    before_validation do
      ...
      self.create_count ||= user.xclock_season_xrecords.count.next
    end
    ...
    # 連勝通知
    # rails r "User.first.xclock_latest_xrecord.judge_set(Judge.fetch(:win))"
