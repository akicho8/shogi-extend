...
# == Schema Information ==
#
# エモーション (xclock_emotions as Xclock::Emotion)
#
# |------------+----------+-------------+-------------+---------------------------+-------|
...
# | folder_id  | Folder   | integer(8)  | NOT NULL    | => Xclock::EmotionFolder#id | B     |
...
# 【警告:リレーション欠如】Xclock::EmotionFolderモデルで has_many :xclock/emotions されていません
#--------------------------------------------------------------------------------

# -*- compile-command: "rails r 'Xclock::EmotionFolder.setup; User.first.emotions_setup(reset: true);'" -*-
...
module Xclock
  class Emotion < ApplicationRecord
    ...
    belongs_to :folder, class_name: "Xclock::EmotionFolder"
