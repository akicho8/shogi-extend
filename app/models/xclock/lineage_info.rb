# -*- compile-command: "rails r 'Xclock::Lineage.setup; tp Xclock::Lineage'" -*-

module Xclock
  # リネーム方法
  # rails r 'Xclock::Lineage.fetch("詰将棋(玉方持駒限定)").update!(key: "玉方持駒限定の似非詰将棋")'
  class LineageInfo
    ...
    memory_record [
      ...
      { key: "玉方持駒限定の似非詰将棋", type: "is-primary", mate_validate_on: true,  piece_counts_check_on: false, mochigomagentei: true,  black_piece_zero_check_on: false, },
