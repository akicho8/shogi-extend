...
# == Schema Information ==
#
# Battle membership (xclock_battle_memberships as Xclock::BattleMembership)
#
# |------------+----------+------------+-------------+--------------+-------|
...
module Xclock
  class BattleMembership < ApplicationRecord
    ...
    #     season_xrecord = user.xclock_latest_xrecord
    ...
    # def maeno_record
    #   s = user.xclock_battle_memberships
    #   if created_at
    ...
    # rails r "p Xclock::Battle.first.memberships.first.location_key"
    def location_key
