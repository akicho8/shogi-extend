...
# == Schema Information ==
#
# Battle (xclock_battles as Xclock::Battle)
#
# |------------+------------+------------+-------------+------+-------|
...
# end
#
# battle.room_messages.create!(user: user1, body: "a") # => #<Xclock::RoomMessage id: 1, user_id: 31, battle_id: 18, body: "a", created_at: "2020-05-05 07:18:46", updated_at: "2020-05-05 07:18:46">
#
module Xclock
  class Battle < ApplicationRecord
    ...
    after_create_commit do
      Xclock::BattleBroadcastJob.perform_later(self)
    end
    ...
    def battle_chain_create
      room.battle_create_with_members!(parent: self) # --> app/jobs/xclock/battle_broadcast_job.rb
    end
