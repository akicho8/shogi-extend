module Xclock::Question::InfoMod
  ...
  def info
    ...
    if Xclock::Config[:time_limit_sec_enable]
      a["制限時間"] = "#{time_limit_sec}秒"
    end

    if Xclock::Config[:difficulty_level_enable]
  ...
  def to_kif
    str = Xclock::Converter.sfen_to_kif_str(main_sfen)
