...
module Wkbk
  class Question < ApplicationRecord
    ...
    # rails r 'Wkbk::Question.tag_normalize_all; tp Wkbk::Question'
    ...
    def page_url(options = {})
      # UrlProxy.wrap2("/wkbk/questions/#{id}")
      UrlProxy.wrap2("/training?question_id=#{id}")
      # Rails.application.routes.url_helpers.url_for([:wkbk, {only_path: false, question_id: id}.merge(options)])
    end
    ...
    #   }
    #   question = user.wkbk_questions.build
