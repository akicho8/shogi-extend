...
- 本譜の棋譜を持っていて「対局設定がOFF」かつ「時計がOFFまたはPAUSE」のとき
...
- 「手番を知らせる効果音」と「次は○○の手番です」の発声は対局設定の面子が3人以上のときだけ
- 2人以下では順番が明確なので鳴らない
...
- 対局設定している状況では「先手」「後手」「観戦」の項目に名前が入る
- 対局設定していない状況では「面子」にすべてのメンバーの名前が入る
