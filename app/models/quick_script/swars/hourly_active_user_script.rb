  ...
  module Swars
    class HourlyActiveUserScript < Base
      ...
      def header_link_items
        super + [
          { name: "時間帯別対局者数", _v_bind: { href: "/lab/swars/hourly-active-user-count.html",    target: "_self" }, },
          { name: "時間帯別相対棋力", _v_bind: { href: "/lab/swars/hourly-active-user-strength.html", target: "_self" }, },
        ]
      end
