# rails r QuickScript::Swars::TacticCrossLegendGenerator.generate
module QuickScript
  module Swars
    class TacticCrossLegendGenerator
      def self.generate
        new.display
      end
      ...
      def aggregate
        url = "http://localhost:3000/api/lab/swars/tactic-cross.json?json_type=general"
        # url = "https://www.shogi-extend.com/api/lab/swars/tactic-cross.json?json_type=general"
