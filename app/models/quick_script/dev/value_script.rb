    ...
    class ValueScript < Base
      ...
      def call
        [
          ...
          { name: "nuxt-link (非推奨)",     type: "value_type_is_nuxt_link",    value: { _nuxt_link: { name: "(name)", to: { name: "lab-qs_group_key-qs_page_key", params: { qs_group_key: "dev", qs_page_key: "calc" }, query: { lhv: 100 } }, }, } },
          { name: "nuxt-link (改良版)",     type: "value_type_is_nuxt_link2",   value: { _nuxt_link2: "(name)", _v_bind: { to: { name: "lab-qs_group_key-qs_page_key", params: { qs_group_key: "dev", qs_page_key: "calc" }, query: { lhv: 100 }, }, :class => "has-text-weight-bold", }, } },
