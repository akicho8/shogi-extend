...
# | rating           | Rating           | integer(4) | NOT NULL    |                       | H     |
# | rating_last_diff | Rating last diff | integer(4) | NOT NULL    |                       | I     |
# | rating_max       | Rating max       | integer(4) | NOT NULL    |                       | J     |
...
# | disconnect_count | Disconnect count | integer(4) | NOT NULL    |                       | O     |
