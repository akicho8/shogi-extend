...
module Actb
  ...
  class RuleInfo
    ...
    memory_record [
      ...
      { key: :beginner_rule,      name: "1〜3手詰",             description: "実戦詰め筋を含む・評価50%未満除外",                display_p: true,  practice_only: false, time_ranges: [("12:30"..."13:00"), ("23:00"..."23:30")], strategy_key: :sy_singleton, development_only: false, time_limit_sec: 30, controll_limit_sec: 5, best_questions_limit:  20, b_score_max_for_win: 10, turn_max: 1..3,  select_order: :random, after_order: nil,         latest_move_to_top: nil, good_rate_gteq: 0.5, o_rate_gteq: nil, tagged_with_args: nil,                            lineage_keys_any: ["詰将棋", "玉方持駒限定の似非詰将棋", "実戦詰め筋"], },
