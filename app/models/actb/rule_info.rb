...
module Actb
  ...
  class RuleInfo
    ...
    memory_record [
      ...
      { key: :good_rule,          name: "おすすめ問題",         description: "最初はここからどうぞ",                             display_p: true,  practice_only: false, time_ranges: [("12:30"..."13:00"), ("23:00"..."23:30")], strategy_key: :sy_singleton, development_only: false, time_limit_sec: 30, controll_limit_sec: 5, best_questions_limit:  30, b_score_max_for_win:  5, turn_max: 1..9,  select_order: :good,   after_order: :shuffle,    latest_move_to_top: nil, good_rate_gteq: nil, o_rate_gteq: nil, tagged_with_args: ["アヒル戦法", exclude: true],  lineage_keys_any: nil,                                              },
