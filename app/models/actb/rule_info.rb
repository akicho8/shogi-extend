...
module Actb
  class RuleInfo
    ...
    memory_record [
      ...
      { key: :latest_rule,       name: "新着問題",             description: "",                                                 display_p: true,  strategy_key: :sy_singleton, development_only: false, time_limit_sec: 30, controll_limit_sec: 5, best_questions_limit: 20, b_score_max_for_win:  5, turn_max: 1..9,  select_order: :latest, after_order: nil,         latest_move_to_top: nil, good_rate_gteq: nil, o_rate_gteq: nil, tagged_with_args: nil,                            lineage_keys_any: nil,                      },
      ...
      { key: :hybrid_rule,       name: "ハイブリッド",         description: "マラソンルールだけど相手が解いたら次に進んじゃう", display_p: false, strategy_key: :sy_hybrid,    development_only: false, time_limit_sec: 60, controll_limit_sec: 5, best_questions_limit: 20, b_score_max_for_win:  5, turn_max: 1..9,  select_order: :random, after_order: nil,         latest_move_to_top: 0.5, good_rate_gteq: 0.1, o_rate_gteq: nil, tagged_with_args: nil,                            lineage_keys_any: nil,                      },
      { key: :classic_only_rule, name: "古典詰将棋",           description: "",                                                 display_p: true,  strategy_key: :sy_singleton, development_only: false, time_limit_sec: 30, controll_limit_sec: 5, best_questions_limit: 10, b_score_max_for_win:  5, turn_max: 1..9,  select_order: :random, after_order: nil,         latest_move_to_top: nil, good_rate_gteq: nil, o_rate_gteq: nil, tagged_with_args: ["古典詰将棋"],                 lineage_keys_any: nil,                      },
