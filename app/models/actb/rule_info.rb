...
module Actb
  class RuleInfo
    ...
    memory_record [
      ...
      { key: :hybrid_rule,     name: "ハイブリッド",           display_p: false, strategy_key: :sy_hybrid,    development_only: false, time_limit_sec: 60, controll_limit_sec: 5, best_questions_limit: 20, b_score_max_for_win:  5, turn_max: nil,  select_order: :random, after_order: nil,      latest_move_to_top_rate: 0.5, good_rate_gteq: 0.1, o_rate_gteq: 0,   tagged_with_args: nil,            lineage_keys: nil,                      description: "マラソンルールだけど相手が解いたら次に進んじゃう",              },

      { key: :latest_rule,     name: "新着問題",         display_p: true,  strategy_key: :sy_singleton, development_only: false, time_limit_sec: 30, controll_limit_sec: 5, best_questions_limit: 20, b_score_max_for_win:  5, turn_max: nil,  select_order: :latest, after_order: nil,      latest_move_to_top_rate: nil,  good_rate_gteq: nil, o_rate_gteq: nil, tagged_with_args: nil,            lineage_keys: nil, description: "5点先取で勝ち・考慮時間30秒", },
      { key: :ahiru_only_rule, name: "アヒル戦法ガチマッチ",   display_p: true,  strategy_key: :sy_singleton, development_only: false, time_limit_sec: 10, controll_limit_sec: 5, best_questions_limit: 20, b_score_max_for_win: 10, turn_max: nil,  select_order: :random, after_order: nil,      latest_move_to_top_rate: 0.5, good_rate_gteq: nil, o_rate_gteq: nil, tagged_with_args: ["アヒル戦法"], lineage_keys: nil,                      description: "アヒルガチ勢専用・10点先取で勝ち",                        },
    ]
