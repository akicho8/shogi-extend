...
module Actb
  ...
  class RuleInfo
    ...
    memory_record [
      # 王手飛車 マニアックス
      { key: :test_rule,          name: "テスト用",             description: "テスト用全部入り",                                 display_p: true,  practice_only: true,  time_ranges: [("12:30"..."13:00"), ("00:00"..."23:55")], strategy_key: :sy_singleton, development_only: true,  time_limit_sec: 15, controll_limit_sec: 5, best_questions_limit:  10, b_score_max_for_win:  3, turn_max: 1..7,  select_order: :random, after_order: :shuffle,    latest_move_to_top: 1.0, good_rate_gteq: 0.5, o_rate_gteq: 0.1, tagged_with_args: nil,                            lineage_keys_any: ["詰将棋", "玉方持駒限定の似非詰将棋"],               },
      { key: :good_rule,          name: "みんなのおすすめ",     description: "最初はここからどうぞ",                             display_p: true,  practice_only: false, time_ranges: [("12:30"..."13:00"), ("23:00"..."23:30")], strategy_key: :sy_singleton, development_only: false, time_limit_sec: 30, controll_limit_sec: 5, best_questions_limit:  30, b_score_max_for_win: 10, turn_max: 1..9,  select_order: :good,   after_order: nil,         latest_move_to_top: 1.0, good_rate_gteq: nil, o_rate_gteq: nil, tagged_with_args: nil,                            lineage_keys_any: nil,                                              },
      ...
      { key: :beginner_rule,      name: "1〜3手詰",             description: "実戦詰め筋を含む",                                 display_p: true,  practice_only: false, time_ranges: [("12:30"..."13:00"), ("23:00"..."23:30")], strategy_key: :sy_singleton, development_only: false, time_limit_sec: 30, controll_limit_sec: 5, best_questions_limit:  20, b_score_max_for_win: 10, turn_max: 1..3,  select_order: :random, after_order: nil,         latest_move_to_top: 0.5, good_rate_gteq: 0.4, o_rate_gteq: 0.5, tagged_with_args: nil,                            lineage_keys_any: ["詰将棋", "玉方持駒限定の似非詰将棋", "実戦詰め筋"], },
      { key: :normal_rule,        name: "5〜7手詰",             description: "実戦詰め筋を含む",                                 display_p: true,  practice_only: false, time_ranges: [("12:30"..."13:00"), ("23:00"..."23:30")], strategy_key: :sy_singleton, development_only: false, time_limit_sec: 45, controll_limit_sec: 5, best_questions_limit:  20, b_score_max_for_win:  5, turn_max: 5..7,  select_order: :random, after_order: nil,         latest_move_to_top: 0.5, good_rate_gteq: 0.4, o_rate_gteq: nil, tagged_with_args: nil,                            lineage_keys_any: ["詰将棋", "玉方持駒限定の似非詰将棋", "実戦詰め筋"], },
      { key: :pro_rule,           name: "9〜11手詰",            description: "実戦詰め筋を含む",                                 display_p: true,  practice_only: true,  time_ranges: [("12:30"..."13:00"), ("23:00"..."23:30")], strategy_key: :sy_singleton, development_only: false, time_limit_sec: 60, controll_limit_sec: 5, best_questions_limit:  20, b_score_max_for_win:  3, turn_max: 9..11, select_order: :random, after_order: nil,         latest_move_to_top: 0.5, good_rate_gteq: 0.4, o_rate_gteq: nil, tagged_with_args: nil,                            lineage_keys_any: ["詰将棋", "玉方持駒限定の似非詰将棋", "実戦詰め筋"], },
      ...
      { key: :singleton_rule,     name: "全問ランダム",         description: "",                                                 display_p: true,  practice_only: true,  time_ranges: [("12:30"..."13:00"), ("23:00"..."23:30")], strategy_key: :sy_singleton, development_only: false, time_limit_sec: 10, controll_limit_sec: 5, best_questions_limit:  20, b_score_max_for_win:  5, turn_max: 1..9,  select_order: :random, after_order: nil,         latest_move_to_top: 0.5, good_rate_gteq: 0.1, o_rate_gteq: nil, tagged_with_args: nil,                            lineage_keys_any: nil,                      },
