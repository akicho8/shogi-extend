...
# == Schema Information ==
#
# Battle membership (wbook_battle_memberships as Wbook::BattleMembership)
#
# |------------+----------+------------+-------------+--------------+-------|
...
module Wbook
  class BattleMembership < ApplicationRecord
    ...
    #     season_xrecord = user.wbook_latest_xrecord
    ...
    # def maeno_record
    #   s = user.wbook_battle_memberships
    #   if created_at
    ...
    # rails r "p Wbook::Battle.first.memberships.first.location_key"
    def location_key
