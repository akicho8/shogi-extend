...
# == Schema Information ==
#
# Season xrecord (wbook_season_xrecords as Wbook::SeasonXrecord)
#
# |---------------------+---------------------+------------+-------------+--------------+-------|
...
module Wbook
  class SeasonXrecord < ApplicationRecord
    ...
    before_validation do
      ...
      self.create_count ||= user.wbook_season_xrecords.count.next
    end
    ...
    # 連勝通知
    # rails r "User.first.wbook_latest_xrecord.judge_set(Judge.fetch(:win))"
