module Wbook::Question::InfoMod
  ...
  def info
    ...
    if Wbook::Config[:time_limit_sec_enable]
      a["制限時間"] = "#{time_limit_sec}秒"
    end

    if Wbook::Config[:difficulty_level_enable]
  ...
  def to_kif
    str = Wbook::Converter.sfen_to_kif_str(main_sfen)
