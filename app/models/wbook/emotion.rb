...
# == Schema Information ==
#
# エモーション (wbook_emotions as Wbook::Emotion)
#
# |------------+----------+-------------+-------------+---------------------------+-------|
...
# | folder_id  | Folder   | integer(8)  | NOT NULL    | => Wbook::EmotionFolder#id | B     |
...
# 【警告:リレーション欠如】Wbook::EmotionFolderモデルで has_many :wbook/emotions されていません
#--------------------------------------------------------------------------------

# -*- compile-command: "rails r 'Wbook::EmotionFolder.setup; User.first.wbook_emotions_setup(reset: true);'" -*-
...
module Wbook
  class Emotion < ApplicationRecord
    ...
    belongs_to :folder, class_name: "Wbook::EmotionFolder"
