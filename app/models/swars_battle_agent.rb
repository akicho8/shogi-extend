class SwarsBattleAgent
  ...
  concerning :HistoryGetMethods do
    def index_get(**params)
      ...
      doc.search(".contents").collect do |elem|
        ...
        if true
          row[:swars_battle_user_infos] = elem.search(".history_prof").collect do |e|
            [:user_key, :swars_battle_grade_key].zip(e.inner_text.scan(/\S+/)).to_h
          end
        end
  ...
  concerning :RecordGetMethods do
    def record_get(battle_key)
      ...
      if md = str.match(/\b(?:receiveMove)\("(?<__csa_data>.*)"\)/)
        ...
        info[:swars_battle_user_infos] = [
          {user_key: url_info[:black], swars_battle_grade_key: info[:gamedata][:dan0]},
  ...
  concerning :LegendSwarsBattleUserKeysMethods do
    # 騎士団フェスのときは何もとれない
    def legend_swars_battle_user_keys(**params)
      if @options[:run_remote]
...
if $0 == __FILE__
  tp SwarsBattleAgent.new.legend_swars_battle_user_keys
  # |-----------------|
  # | adventstart     |
  # | shu_chan        |
  # | syougi8         |
  ...
  tp SwarsBattleAgent.new.index_get(gtype: "",  user_key: "Apery8")
  tp SwarsBattleAgent.new.index_get(gtype: "",  user_key: "Apery8", page_index: 1)

  # tp SwarsBattleAgent.new.index_get(gtype: "sb",  user_key: "Apery8")
  # tp SwarsBattleAgent.new.index_get(gtype: "s1",  user_key: "Apery8")
  tp SwarsBattleAgent.new.record_get("hanairobiyori-ispt-20171104_220810")

  # |--------------------------------------------+----------------------------------------------------------------------------------------------------|
  # | battle_key                                 | swars_battle_user_infos                                                                                    |
  # |--------------------------------------------+----------------------------------------------------------------------------------------------------|
  # | hanairobiyori-ispt-20171104_220810         | [{:user_key=>"hanairobiyori", :swars_battle_grade_key=>"27級"}, {:user_key=>"ispt", :swars_battle_grade_key=>"3級"}]         |
  # | anklesam-hanairobiyori-20171104_220223     | [{:user_key=>"anklesam", :swars_battle_grade_key=>"2級"}, {:user_key=>"hanairobiyori", :swars_battle_grade_key=>"27級"}]     |
  # | komakoma1213-hanairobiyori-20171104_215841 | [{:user_key=>"komakoma1213", :swars_battle_grade_key=>"5級"}, {:user_key=>"hanairobiyori", :swars_battle_grade_key=>"28級"}] |
  # | hanairobiyori-mizumakura-20171104_215208   | [{:user_key=>"hanairobiyori", :swars_battle_grade_key=>"28級"}, {:user_key=>"mizumakura", :swars_battle_grade_key=>"3級"}]   |
  # | baldbull-hanairobiyori-20171104_213234     | [{:user_key=>"baldbull", :swars_battle_grade_key=>"3級"}, {:user_key=>"hanairobiyori", :swars_battle_grade_key=>"28級"}]     |
  # | hanairobiyori-chihaya_3-20171104_212752    | [{:user_key=>"hanairobiyori", :swars_battle_grade_key=>"28級"}, {:user_key=>"chihaya_3", :swars_battle_grade_key=>"2級"}]    |
  # | hanairobiyori-kazuruisena-20171104_212234  | [{:user_key=>"hanairobiyori", :swars_battle_grade_key=>"28級"}, {:user_key=>"kazuruisena", :swars_battle_grade_key=>"22級"}] |
  # | hanairobiyori-kanposs-20171104_211903      | [{:user_key=>"hanairobiyori", :swars_battle_grade_key=>"29級"}, {:user_key=>"kanposs", :swars_battle_grade_key=>"4級"}]      |
  # | hanairobiyori-Yuki1290-20171104_211225     | [{:user_key=>"hanairobiyori", :swars_battle_grade_key=>"29級"}, {:user_key=>"Yuki1290", :swars_battle_grade_key=>"2級"}]     |
  # | 9271-hanairobiyori-20171026_103138         | [{:user_key=>"9271", :swars_battle_grade_key=>"1級"}, {:user_key=>"hanairobiyori", :swars_battle_grade_key=>"29級"}]         |
  # |--------------------------------------------+----------------------------------------------------------------------------------------------------|
  # |-----------------+----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
  ...
  # | swars_battle_user_infos | [{:user_key=>"hanairobiyori", :swars_battle_grade_key=>"27級"}, {:user_key=>"ispt", :swars_battle_grade_key=>"3級"}]                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           |
