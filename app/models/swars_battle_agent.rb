      ...
      doc.search(".contents").collect do |elem|
        ...
        if true
          row[:swars_battle_user_infos] = elem.search(".history_prof").collect do |e|
            [:uid, :swars_battle_grade_key].zip(e.inner_text.scan(/\S+/)).to_h
          end
        end
    ...
    def record_get(battle_key)
      ...
      if md = str.match(/\b(?:receiveMove)\("(?<__csa_data>.*)"\)/)
        ...
        info[:swars_battle_user_infos] = [
          {uid: url_info[:black], swars_battle_grade_key: info[:gamedata][:dan0]},
          {uid: url_info[:white], swars_battle_grade_key: info[:gamedata][:dan1]},
        ]
...
if $0 == __FILE__
  ...
  tp SwarsBattleAgent.new.index_get(gtype: "",  uid: "Apery8")
  tp SwarsBattleAgent.new.index_get(gtype: "",  uid: "Apery8", page_index: 1)

  # tp SwarsBattleAgent.new.index_get(gtype: "sb",  uid: "Apery8")
  # tp SwarsBattleAgent.new.index_get(gtype: "s1",  uid: "Apery8")
  tp SwarsBattleAgent.new.record_get("hanairobiyori-ispt-20171104_220810")

  # |--------------------------------------------+----------------------------------------------------------------------------------------------------|
  # | battle_key                                 | swars_battle_user_infos                                                                                    |
  # |--------------------------------------------+----------------------------------------------------------------------------------------------------|
  # | hanairobiyori-ispt-20171104_220810         | [{:uid=>"hanairobiyori", :swars_battle_grade_key=>"27級"}, {:uid=>"ispt", :swars_battle_grade_key=>"3級"}]         |
  # | anklesam-hanairobiyori-20171104_220223     | [{:uid=>"anklesam", :swars_battle_grade_key=>"2級"}, {:uid=>"hanairobiyori", :swars_battle_grade_key=>"27級"}]     |
  # | komakoma1213-hanairobiyori-20171104_215841 | [{:uid=>"komakoma1213", :swars_battle_grade_key=>"5級"}, {:uid=>"hanairobiyori", :swars_battle_grade_key=>"28級"}] |
  # | hanairobiyori-mizumakura-20171104_215208   | [{:uid=>"hanairobiyori", :swars_battle_grade_key=>"28級"}, {:uid=>"mizumakura", :swars_battle_grade_key=>"3級"}]   |
  # | baldbull-hanairobiyori-20171104_213234     | [{:uid=>"baldbull", :swars_battle_grade_key=>"3級"}, {:uid=>"hanairobiyori", :swars_battle_grade_key=>"28級"}]     |
  # | hanairobiyori-chihaya_3-20171104_212752    | [{:uid=>"hanairobiyori", :swars_battle_grade_key=>"28級"}, {:uid=>"chihaya_3", :swars_battle_grade_key=>"2級"}]    |
  # | hanairobiyori-kazuruisena-20171104_212234  | [{:uid=>"hanairobiyori", :swars_battle_grade_key=>"28級"}, {:uid=>"kazuruisena", :swars_battle_grade_key=>"22級"}] |
  # | hanairobiyori-kanposs-20171104_211903      | [{:uid=>"hanairobiyori", :swars_battle_grade_key=>"29級"}, {:uid=>"kanposs", :swars_battle_grade_key=>"4級"}]      |
  # | hanairobiyori-Yuki1290-20171104_211225     | [{:uid=>"hanairobiyori", :swars_battle_grade_key=>"29級"}, {:uid=>"Yuki1290", :swars_battle_grade_key=>"2級"}]     |
  # | 9271-hanairobiyori-20171026_103138         | [{:uid=>"9271", :swars_battle_grade_key=>"1級"}, {:uid=>"hanairobiyori", :swars_battle_grade_key=>"29級"}]         |
  # |--------------------------------------------+----------------------------------------------------------------------------------------------------|
  # |-----------------+----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
  ...
  # | swars_battle_user_infos | [{:uid=>"hanairobiyori", :swars_battle_grade_key=>"27級"}, {:uid=>"ispt", :swars_battle_grade_key=>"3級"}]                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           |
