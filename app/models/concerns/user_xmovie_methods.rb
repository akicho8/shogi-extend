module UserXmovieMethods
  ...
  def my_records_broadcast
    ...
    Xmovie::RoomChannel.broadcast_to(self, {bc_action: :my_records_broadcasted, bc_params: bc_params})
  end
  ...
  def done_record_broadcast(done_record, params = {})
    ...
    Xmovie::RoomChannel.broadcast_to(self, {bc_action: :done_record_broadcasted, bc_params: bc_params})
  end
end
