...
# == Schema Information ==
#
# 対局時の両者テーブル (general_memberships as GeneralMembership)
#
# |--------------------------+-----------------------+-------------+-------------+---------------------------+-------|
# | カラム名                 | 意味                  | タイプ      | 属性        | 参照                      | INDEX |
# |--------------------------+-----------------------+-------------+-------------+---------------------------+-------|
# | id                       | ID                    | integer(8)  | NOT NULL PK |                           |       |
# | general_battle_id | General battle record | integer(8)  | NOT NULL    | => GeneralBattle#id | A! B  |
...
#
#- 備考 -------------------------------------------------------------------------
# ・GeneralMembership モデルは GeneralBattle モデルから has_many :general_memberships されています。
#--------------------------------------------------------------------------------

class GeneralMembership < ApplicationRecord
  belongs_to :general_battle            # 対局

  acts_as_list top_of_list: 0, scope: :general_battle
  ...
  with_options allow_blank: true do
    ...
    validates :location_key, uniqueness: {scope: :general_battle_id}
