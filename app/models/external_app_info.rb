class ExternalAppInfo
  ...
  memory_record [
    ...
    { key: :kento,      name: "KENTO",    shortcut_name: "直前KENTO",    redirect_in_controller: true,  other_window: true,  external_url_func: -> h, record { h.kento_app_url_switch(record, only_path: false) }, }, # iOS Safari では other_window が効かない
  ]
