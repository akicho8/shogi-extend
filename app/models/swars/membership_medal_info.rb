...
module Swars
  class MembershipMedalInfo
    ...
    memory_record [
      ...
      { key: "棋神マン",           message: "棋神召喚疑惑あり",                                                                                  medal_params: "🤖", if_cond: -> m { m.judge_key == "win" && m.battle.turn_max >= 50 && (m.obt_auto_max || 0) >= AiCop.obt_auto_max_gteq } }, # m.battle.rule_key != "three_min" && 
