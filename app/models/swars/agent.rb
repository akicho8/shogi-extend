...
module Swars
  ...
  if $0 == __FILE__
    ...
    # |             url | http://kif-pona.heroz.jp/games/devuser1-ispt-20171104_220810?locale=ja                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          |
...
# >> | key                                     | user_infos                                                                                       |
# >> |-----------------------------------------+--------------------------------------------------------------------------------------------------|
# >> | myasuMan-chrono_-20200116_232605        | [{:user_key=>"myasuMan", :grade_key=>"三段"}, {:user_key=>"chrono_", :grade_key=>"四段"}]        |
# >> | chrono_-Biibaa-20200116_183504          | [{:user_key=>"chrono_", :grade_key=>"四段"}, {:user_key=>"Biibaa", :grade_key=>"三段"}]          |
# >> | Emotional_music-chrono_-20200116_182436 | [{:user_key=>"Emotional_music", :grade_key=>"14級"}, {:user_key=>"chrono_", :grade_key=>"四段"}] |
# >> | atmy125-chrono_-20200116_135406         | [{:user_key=>"atmy125", :grade_key=>"三段"}, {:user_key=>"chrono_", :grade_key=>"四段"}]         |
# >> | chrono_-aobadai-20200115_173733         | [{:user_key=>"chrono_", :grade_key=>"四段"}, {:user_key=>"aobadai", :grade_key=>"四段"}]         |
# >> | chrono_-nibannte-20200115_110615        | [{:user_key=>"chrono_", :grade_key=>"四段"}, {:user_key=>"nibannte", :grade_key=>"三段"}]        |
# >> | chrono_-cx100mm-20200114_215541         | [{:user_key=>"chrono_", :grade_key=>"四段"}, {:user_key=>"cx100mm", :grade_key=>"三段"}]         |
# >> | ksakai100-chrono_-20200114_213559       | [{:user_key=>"ksakai100", :grade_key=>"20級"}, {:user_key=>"chrono_", :grade_key=>"四段"}]       |
# >> | neru1022-chrono_-20200114_212648        | [{:user_key=>"neru1022", :grade_key=>"19級"}, {:user_key=>"chrono_", :grade_key=>"四段"}]        |
# >> | Syoog-chrono_-20200114_190606           | [{:user_key=>"Syoog", :grade_key=>"三段"}, {:user_key=>"chrono_", :grade_key=>"四段"}]           |
# >> |-----------------------------------------+--------------------------------------------------------------------------------------------------|
# >> |--------------------------------------+-----------------------------------------------------------------------------------------------|
# >> | key                                  | user_infos                                                                                    |
# >> |--------------------------------------+-----------------------------------------------------------------------------------------------|
# >> | kiricu-chrono_-20200117_002456       | [{:user_key=>"kiricu", :grade_key=>"1級"}, {:user_key=>"chrono_", :grade_key=>"四段"}]        |
# >> | YomeTime-chrono_-20200117_001940     | [{:user_key=>"YomeTime", :grade_key=>"24級"}, {:user_key=>"chrono_", :grade_key=>"四段"}]     |
# >> | chrono_-kinesis-20200117_001308      | [{:user_key=>"chrono_", :grade_key=>"四段"}, {:user_key=>"kinesis", :grade_key=>"30級"}]      |
# >> | chrono_-yakyuu43-20200117_000531     | [{:user_key=>"chrono_", :grade_key=>"四段"}, {:user_key=>"yakyuu43", :grade_key=>"1級"}]      |
# >> | chrono_-sourin-20200116_235945       | [{:user_key=>"chrono_", :grade_key=>"四段"}, {:user_key=>"sourin", :grade_key=>"初段"}]       |
# >> | deppon-chrono_-20200116_235158       | [{:user_key=>"deppon", :grade_key=>"五段"}, {:user_key=>"chrono_", :grade_key=>"四段"}]       |
# >> | chrono_-peso3-20200116_231902        | [{:user_key=>"chrono_", :grade_key=>"四段"}, {:user_key=>"peso3", :grade_key=>"二段"}]        |
# >> | a487603-chrono_-20200116_231245      | [{:user_key=>"a487603", :grade_key=>"四段"}, {:user_key=>"chrono_", :grade_key=>"四段"}]      |
# >> | ahooooahooou-chrono_-20200116_230723 | [{:user_key=>"ahooooahooou", :grade_key=>"三段"}, {:user_key=>"chrono_", :grade_key=>"四段"}] |
# >> | chrono_-HIHUMI-20200116_225950       | [{:user_key=>"chrono_", :grade_key=>"四段"}, {:user_key=>"HIHUMI", :grade_key=>"四段"}]       |
# >> |--------------------------------------+-----------------------------------------------------------------------------------------------|
# >> |-------------------+---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
