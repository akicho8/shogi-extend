...
if $0 == __FILE__
  ...
  # tp Swars::Agent.new.index_get(gtype: "sb",  user_key: "Apery8")
  # tp Swars::Agent.new.index_get(gtype: "s1",  user_key: "Apery8")
  tp Swars::Agent.new.record_get("hanairobiyori-ispt-20171104_220810")
