...
module Swars
  class MedalInfo
    ...
    memory_record [
      ...
      { key: "カニ執着マン",       medal_params: { message: "カニ系の戦法や囲いで勝った",             method: "raw",  name: "🦀",                type: nil, },          if_cond: proc { (win_and_all_tag_ratio_for("カニカニ銀") > 0 || win_and_all_tag_ratio_for("カニカニ金") > 0) || win_and_all_tag_ratio_for("カニ囲い") >= 0.2 || win_and_all_tag_ratio_for("カニ缶囲い") > 0 },},
      { key: "カメレオンマン",     medal_params: { message: "カメレオン系の戦法で勝った",             method: "raw",  name: "🦎",                type: nil, },          if_cond: proc { (win_and_all_tag_ratio_for("英春流カメレオン") > 0) || (win_and_all_tag_ratio_for("カメレオン戦法") > 0) },},
      { key: "ポンポンマン",       medal_params: { message: "ポンポン桂で勝った",                     method: "raw",  name: "🐴",                type: nil, },          if_cond: proc { win_and_all_tag_ratio_for("ポンポン桂") > 0 },},
      { key: "右四間飛車マン",     medal_params: { message: "右四間飛車でけっこう勝った",             method: "raw",  name: "🌋",                type: nil, },          if_cond: proc { (win_and_all_tag_ratio_for("右四間飛車") + win_and_all_tag_ratio_for("右四間飛車急戦") + win_and_all_tag_ratio_for("右四間飛車左美濃")) >= 0.3 }},
      ...
      { key: "チョコレートマン",   medal_params: { message: "チョコレート囲いを使って勝った",         method: "raw",  name: "🍫",                type: nil, },          if_cond: proc { win_and_all_tag_ratio_for("チョコレート囲い") > 0 },},
      { key: "極限早繰りマン",     medal_params: { message: "極限早繰り銀を使って勝った",             method: "raw",  name: "🏃🏻",                type: nil, },          if_cond: proc { win_and_all_tag_ratio_for("極限早繰り銀") > 0 },},
      { key: "坊主マン",           medal_params: { message: "坊主美濃を使って勝った",                 method: "raw",  name: "👴🏻",                type: nil, },          if_cond: proc { win_and_all_tag_ratio_for("坊主美濃") > 0 },},
      { key: "中飛車マン",         medal_params: { message: "中飛車を使った",                         method: "raw",  name: "🀄",                type: nil, },          if_cond: proc { all_tag_names_join.include?("中飛車") },},
      ...
      { key: "ただの千日手",       medal_params: { message: "千日手があった",                         method: "icon", name: "💔",                type: nil },          if_cond: proc { (r = draw_ratio) && r > 0 } },
