...
module Swars
  class MedalInfo
    ...
    memory_record [
      ...
      { key: "右玉マン",           medal_params: { message: "右玉党",                                 method: "tag",  name: "右",                type: "is-light", },   if_cond: proc { (win_and_all_tag_ratio_for("右玉") + win_and_all_tag_ratio_for("糸谷流右玉") + win_and_all_tag_ratio_for("羽生流右玉")) > 0.2 },},
      ...
      { key: "穴熊マン",           medal_params: { message: "穴熊の使い手",                           method: "raw",  name: "🐻",                type: nil, },          if_cond: proc { all_tag_names_join.include?("熊") },},
