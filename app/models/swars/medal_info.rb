...
module Swars
  class MedalInfo
    ...
    memory_record [
      ...
      { key: "嬉野マン",           medal_params: { method: "tag",  name: "嬉",                type: "is-light", },   if_cond: proc { win_and_all_tag_ratio_for("嬉野流") >= 0.2                      },},
      { key: "パックマン野郎",     medal_params: { method: "icon", name: "pac-man",           type: "is-warning", }, if_cond: proc { win_and_all_tag_ratio_for("パックマン戦法") > 0                 },},
      { key: "耀龍マン",           medal_params: { method: "raw",  name: "🐉",                type: nil, },          if_cond: proc { (win_and_all_tag_ratio_for("耀龍四間飛車") + win_and_all_tag_ratio_for("耀龍ひねり飛車")) > 0 },},
      { key: "ロケットマン",       medal_params: { method: "raw",  name: "🚀",                type: nil, },          if_cond: proc { win_and_all_tag_ratio_for("ロケット") > 0 },},
      { key: "UFOマン",            medal_params: { method: "raw",  name: "🛸",                type: nil, },          if_cond: proc { win_and_all_tag_ratio_for("UFO銀") > 0 },},
      { key: "カニ執着マン",       medal_params: { method: "raw",  name: "🦀",                type: nil, },          if_cond: proc { (win_and_all_tag_ratio_for("カニカニ銀") > 0 || win_and_all_tag_ratio_for("カニカニ金") > 0) || win_and_all_tag_ratio_for("カニ囲い") >= 0.2 || win_and_all_tag_ratio_for("蟹罐囲い") > 0 },},
      { key: "穴熊マン",           medal_params: { method: "raw",  name: "🐻",                type: nil, },          if_cond: proc { all_tag_names_join.include?("熊") },},
      { key: "ダイヤマン",         medal_params: { method: "raw",  name: "💎",                type: nil, },          if_cond: proc { win_and_all_tag_ratio_for("ダイヤモンド美濃") > 0 },},
      { key: "レグスペマン",       medal_params: { method: "raw",  name: "🐔",                type: nil, },          if_cond: proc { win_and_all_tag_ratio_for("レグスペ") > 0 },},
      ...
      { key: "エルモマン",         medal_params: { method: "raw",  name: "🐒",                type: nil, },          if_cond: proc { win_and_all_tag_ratio_for("elmo囲い") > 0 },},
      ...
      { key: "5連勝",              medal_params: { method: "raw",  name: "🍰",                type: nil, },          if_cond: proc { (5..7).cover?(win_lose_streak_max_hash["win"]) },},
      { key: "8連勝",              medal_params: { method: "raw",  name: "🍣",                type: nil, },          if_cond: proc { (8..10).cover?(win_lose_streak_max_hash["win"]) },},
      { key: "11連勝",             medal_params: { method: "raw",  name: "🏆",                type: nil, },          if_cond: proc { (11..255).cover?(win_lose_streak_max_hash["win"]) },},
      ...
      { key: "角不成マン",         medal_params: { method: "raw",  name: "☠",                 type: nil, },          if_cond: proc { all_tag_ratio_for("角不成") > 0 }           },
      { key: "飛車不成マン",       medal_params: { method: "raw",  name: "💀",                type: nil, },          if_cond: proc { all_tag_ratio_for("飛車不成") > 0 }           },
      ...
      { key: "開幕千日手",         medal_params: { method: "raw",  name: "❓",                type: nil },           if_cond: proc { (r = start_draw_ratio) && r > 0 } },
