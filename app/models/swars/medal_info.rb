...
module Swars
  class MedalInfo
    ...
    memory_record [
      ...
      { key: "鬼殺されマン",       medal_params: { message: "鬼殺し系を食らって負けた", method: "raw",  name: "👹",                type: nil, },          if_cond: proc { defeated_tag_counts["鬼殺し向かい飛車"] > 0 || defeated_tag_counts["鬼殺し"] > 0 || defeated_tag_counts["新鬼殺し"] > 0 },},

      { key: "アヒル初級",         medal_params: { message: "アヒル戦法初級", method: "raw",  name: "🐣",                type: nil, },          if_cond: proc { (0.1...0.3).cover?(all_tag_ratio_for("アヒル囲い"))            },},
      { key: "アヒル中級",         medal_params: { message: "アヒル戦法中級", method: "raw",  name: "🐥",                type: nil, },          if_cond: proc { (0.3...0.5).cover?(all_tag_ratio_for("アヒル囲い"))            },},
      { key: "アヒル上級",         medal_params: { message: "アヒル戦法上級", method: "raw",  name: "🐤",                type: nil, },          if_cond: proc { (0.5..1.0).cover?(all_tag_ratio_for("アヒル囲い")) && win_ratio >= 0.5 },},
