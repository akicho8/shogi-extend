...
module Swars
  class MedalInfo
    ...
    memory_record [
      ...
      { key: "耀龍マン",           medal_params: { message: "耀龍戦法の使い手",                       method: "raw",  name: "🐉",                type: nil, },          if_cond: proc { win_and_all_tag_names_join.include?("耀龍") }, },
      ...
      { key: "遠見の角マン",       medal_params: { message: "遠見の角の使い手",                       method: "raw",  name: "🔭",                type: nil, },          if_cond: proc { win_and_all_tag_ratio_for("遠見の角") > 0 },},
