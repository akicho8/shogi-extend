  ...
  concerning :HistoryGetMethods do
    def index_get(**params)
      ...
      doc.search(".contents").collect do |elem|
        ...
        if true
          row[:battle_user_infos] = elem.search(".history_prof").collect do |e|
            [:user_key, :battle_grade_key].zip(e.inner_text.scan(/\S+/)).to_h
          end
        end
  ...
  concerning :RecordGetMethods do
    def record_get(battle_key)
      ...
      if md = str.match(/\b(?:receiveMove)\("(?<__csa_data>.*)"\)/)
        ...
        info[:battle_user_infos] = [
          {user_key: url_info[:black], battle_grade_key: info[:gamedata][:dan0]},
          {user_key: url_info[:white], battle_grade_key: info[:gamedata][:dan1]},
        ]
...
if $0 == __FILE__
  tp Swars::BattleAgent.new.legend_battle_user_keys
  # |-----------------|
  # | adventstart     |
  # | shu_chan        |
  # | syougi8         |
  ...
  tp Swars::BattleAgent.new.index_get(gtype: "",  user_key: "Apery8")
  tp Swars::BattleAgent.new.index_get(gtype: "",  user_key: "Apery8", page_index: 1)

  # tp Swars::BattleAgent.new.index_get(gtype: "sb",  user_key: "Apery8")
  # tp Swars::BattleAgent.new.index_get(gtype: "s1",  user_key: "Apery8")
  tp Swars::BattleAgent.new.record_get("hanairobiyori-ispt-20171104_220810")

  # |--------------------------------------------+----------------------------------------------------------------------------------------------------|
  # | battle_key                                 | battle_user_infos                                                                                    |
  # |--------------------------------------------+----------------------------------------------------------------------------------------------------|
  # | hanairobiyori-ispt-20171104_220810         | [{:user_key=>"hanairobiyori", :battle_grade_key=>"27級"}, {:user_key=>"ispt", :battle_grade_key=>"3級"}]         |
  # | anklesam-hanairobiyori-20171104_220223     | [{:user_key=>"anklesam", :battle_grade_key=>"2級"}, {:user_key=>"hanairobiyori", :battle_grade_key=>"27級"}]     |
  # | komakoma1213-hanairobiyori-20171104_215841 | [{:user_key=>"komakoma1213", :battle_grade_key=>"5級"}, {:user_key=>"hanairobiyori", :battle_grade_key=>"28級"}] |
  # | hanairobiyori-mizumakura-20171104_215208   | [{:user_key=>"hanairobiyori", :battle_grade_key=>"28級"}, {:user_key=>"mizumakura", :battle_grade_key=>"3級"}]   |
  # | baldbull-hanairobiyori-20171104_213234     | [{:user_key=>"baldbull", :battle_grade_key=>"3級"}, {:user_key=>"hanairobiyori", :battle_grade_key=>"28級"}]     |
  # | hanairobiyori-chihaya_3-20171104_212752    | [{:user_key=>"hanairobiyori", :battle_grade_key=>"28級"}, {:user_key=>"chihaya_3", :battle_grade_key=>"2級"}]    |
  # | hanairobiyori-kazuruisena-20171104_212234  | [{:user_key=>"hanairobiyori", :battle_grade_key=>"28級"}, {:user_key=>"kazuruisena", :battle_grade_key=>"22級"}] |
  # | hanairobiyori-kanposs-20171104_211903      | [{:user_key=>"hanairobiyori", :battle_grade_key=>"29級"}, {:user_key=>"kanposs", :battle_grade_key=>"4級"}]      |
  # | hanairobiyori-Yuki1290-20171104_211225     | [{:user_key=>"hanairobiyori", :battle_grade_key=>"29級"}, {:user_key=>"Yuki1290", :battle_grade_key=>"2級"}]     |
  # | 9271-hanairobiyori-20171026_103138         | [{:user_key=>"9271", :battle_grade_key=>"1級"}, {:user_key=>"hanairobiyori", :battle_grade_key=>"29級"}]         |
  # |--------------------------------------------+----------------------------------------------------------------------------------------------------|
  # |-----------------+----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
  ...
  # | battle_user_infos | [{:user_key=>"hanairobiyori", :battle_grade_key=>"27級"}, {:user_key=>"ispt", :battle_grade_key=>"3級"}]                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           |
