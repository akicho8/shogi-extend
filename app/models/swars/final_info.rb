...
module Swars
  class FinalInfo
    ...
    memory_record [
      ...
      { key: :ENTERINGKING,  name: "入玉",             alias_name: nil,        label_color: "primary", csa_last_action_key: :KACHI,      draw: false, toryo_or_tsumi: false, chart_required: false, grade_segment_label: "入玉",             },
