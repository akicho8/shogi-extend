module Swars
  class RuleInfo
    ...
    memory_record [
      { key: :ten_min,   name: "10分", long_name: "10分切れ負け", sw_side_key: "",   csa_time_limit: "00:10+00", life_time: 10.minutes, real_life_time: nil, ittezume_jirasi_sec: 1.0.minutes, kangaesugi_sec: 2.5.minutes, kangaesugi_like_houti_sec: 3.minutes, toryo_houti_sec: 1.minutes, taisekimati_sec: 5.minutes, related_time_p: true,  resignation_limit: 3.minutes, most_min_turn_max_limit: 35, },
      { key: :three_min, name: "3分",  long_name: "3分切れ負け",  sw_side_key: "sb", csa_time_limit: "00:03+00", life_time: 3.minutes,  real_life_time: nil, ittezume_jirasi_sec: 45.seconds,  kangaesugi_sec: 30.seconds,  kangaesugi_like_houti_sec: 1.minutes, toryo_houti_sec: 1.minutes, taisekimati_sec: 2.minutes, related_time_p: true,  resignation_limit: 1.minutes, most_min_turn_max_limit: 35, },
