  ...
  module UserStat
    class OtherInfo
      ...
      memory_record [
        ...
        { key: "大駒全ブッチ",     chart_type: :win_lose_circle, chart_options: { click_method: :win_lose_with_tag_click_handle, tag: "大駒全ブッチ",     }, body: proc { note_stat.to_chart("大駒全ブッチ")     }, },
        { key: "大駒コンプリート", chart_type: :win_lose_circle, chart_options: { click_method: :win_lose_with_tag_click_handle, tag: "大駒コンプリート", }, body: proc { note_stat.to_chart("大駒コンプリート") }, },
        { key: "入玉",             chart_type: :win_lose_circle, chart_options: { click_method: :win_lose_with_tag_click_handle, tag: "入玉",             }, body: proc { note_stat.to_chart("入玉") }, },
