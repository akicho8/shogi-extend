  ...
  module User::Stat
    class OtherInfo
      ...
      memory_record [
        ...
        { key: "先手で千日手にした",               local_only: false, body: proc { draw_stat.black_sennichi_count                }, chart_type: :simple, chart_options: { simple_type: :numeric_with_unit, unit: "回", }, },
        ...
        { key: "大駒全ブッチ",        local_only: false, body: proc { tag_stat.to_win_lose_chart(:"大駒全ブッチ")                    }, chart_type: :win_lose_circle, chart_options: { click_method: :win_lose_click_handle, with_search_params: { tag: "大駒全ブッチ",     }, }, },
        { key: "大駒コンプリート",    local_only: false, body: proc { tag_stat.to_win_lose_chart(:"大駒コンプリート")                }, chart_type: :win_lose_circle, chart_options: { click_method: :win_lose_click_handle, with_search_params: { tag: "大駒コンプリート", }, }, },

        # 「大駒全ブッチ」と「vs 大駒コンプリート」の勝敗数は同等になるため両方を表示する意味がない
        { key: "vs 大駒全ブッチ",     local_only: true,  body: proc { op_tag_stat.to_win_lose_chart(:"大駒全ブッチ", swap: true)     }, chart_type: :win_lose_circle, chart_options: { click_method: :win_lose_click_handle, with_search_params: { "vs-tag": "大駒全ブッチ", }, }, },
        { key: "vs 大駒コンプリート", local_only: true,  body: proc { op_tag_stat.to_win_lose_chart(:"大駒コンプリート", swap: true) }, chart_type: :win_lose_circle, chart_options: { click_method: :win_lose_click_handle, with_search_params: { "vs-tag": "大駒コンプリート", }, }, },

        ################################################################################

        { key: "[win-lose] 角不成",      display_name: "角不成",      local_only: false, body: proc { tag_stat.to_win_lose_chart(:"角不成")                    }, chart_type: :win_lose_circle, chart_options: { click_method: :win_lose_click_handle, with_search_params: { tag: "角不成",     }, }, },
        { key: "[win-lose] vs 角不成",   display_name: "vs 角不成",   local_only: false, body: proc { op_tag_stat.to_win_lose_chart(:"角不成", swap: true)     }, chart_type: :win_lose_circle, chart_options: { click_method: :win_lose_click_handle, with_search_params: { "vs-tag": "角不成", }, }, },
        { key: "[win-lose] 飛車不成",    display_name: "飛車不成",    local_only: false, body: proc { tag_stat.to_win_lose_chart(:"飛車不成")                    }, chart_type: :win_lose_circle, chart_options: { click_method: :win_lose_click_handle, with_search_params: { tag: "飛車不成",     }, }, },
        { key: "[win-lose] vs 飛車不成", display_name: "vs 飛車不成", local_only: false, body: proc { op_tag_stat.to_win_lose_chart(:"飛車不成", swap: true)     }, chart_type: :win_lose_circle, chart_options: { click_method: :win_lose_click_handle, with_search_params: { "vs-tag": "飛車不成", }, }, },

        ################################################################################

        { key: "[win-lose] 相居玉",      display_name: "相居玉",      local_only: false, body: proc { tag_stat.to_win_lose_chart(:"相居玉")                    }, chart_type: :win_lose_circle, chart_options: { click_method: :win_lose_click_handle, with_search_params: { tag: "相居玉",     }, }, },

        ################################################################################

        { key: "[win-lose] 入玉",    display_name: "入玉",    local_only: false, body: proc { tag_stat.to_win_lose_chart(:"入玉")                    }, chart_type: :win_lose_circle, chart_options: { click_method: :win_lose_click_handle, with_search_params: { tag: "入玉",     }, }, },
        { key: "[win-lose] vs 入玉", display_name: "vs 入玉", local_only: false, body: proc { op_tag_stat.to_win_lose_chart(:"入玉", swap: true)     }, chart_type: :win_lose_circle, chart_options: { click_method: :win_lose_click_handle, with_search_params: { "vs-tag": "入玉", }, }, },
