  ...
  module User::Stat
    class PenaltyInfo
      ...
      memory_record [
        ...
        { weight:  15.0, key: "1手詰を焦らした対局数",            short_name: "1手詰焦らし",    x_count: proc { mate_stat.count                                          }, },
        { weight:  20.0, key: "1手詰を焦らした対局数2",           short_name: "1手詰焦らし2",   x_count: proc { mate2_stat.count                                          }, },
