  ...
  module User::Stat
    class PenaltyInfo
      ...
      memory_record [
        ...
        { weight:   1.0, key: "舐めプ戦法を使った対局数",         short_name: "舐めプ戦法",     x_count: proc { namepu_stat.namepu_count                                 }, },
        ...
        { weight:   9.0, key: "1手詰を焦らした対局数",            short_name: "1手詰焦らし",    x_count: proc { mate_stat.count                                          }, },
        { weight:  10.0, key: "人に対して棋神を使った対局数",     short_name: "棋神",           x_count: proc { fraud_stat.count                                         }, },
        { weight:   3.0, key: "恐怖の級位者として振る舞った",     short_name: "逆棋力詐欺(強)", x_count: proc { gdiff_stat.reverse_kiryoku_sagi_count                    }, },
        { weight:   5.0, key: "適正な棋力帯で対局しなかった",     short_name: "棋力詐欺(弱)",   x_count: proc { user.grade_info.teacher ? 0 : gdiff_stat.bad_grade_ratio }, },
