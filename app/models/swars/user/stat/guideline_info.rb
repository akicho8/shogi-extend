  ...
  module User::Stat
    class GuidelineInfo
      ...
      memory_record [
        ...
        { weight:  4, key: "角不成をしていない",             desc: "角不成の回数が0回か？",                   if_cond: proc { tag_stat.count_by(:"角不成").zero? }, },
        { weight:  4, key: "飛車不成をしていない",           desc: "飛車不成の回数が0回か？",                 if_cond: proc { tag_stat.count_by(:"飛車不成").zero? }, },
        ...
        { weight: 10, key: "友達対局で無双していない",       desc: "「友対5局以上かつ勝率0.75以上」ではない", if_cond: proc { !xmode_judge_stat.friend_battle_musou? }, },
