...
export class RectSizeInfo extends MemoryRecord {
  ...
  static get define() {
    return [
      ...
      { key: "is_rect_size_1920x1080", name: "1920x1080",      aspect_ratio: "16:9",   icon: "youtube", type: "is-danger", recommend: "◎", general_name: "FULL HD",     width: 1920, height: 1080,  type: "is-primary", environment: ["development", "staging", "production"], message: "高画質",        },
      { separator: true                                                                                                                                                                                                                                                                        },
