...
export class ColorThemeInfo extends MemoryRecord {
  ...
  static get define() {
    return [
      ...
      { separator: true },
      { key: "color_theme_is_wars",                    name: "ウォーズ(?)",    media_name: null, type: "is-primary", message: null, },
      { key: "color_theme_is_club24",                  name: "24(?)" ,         media_name: null, type: "is-primary", message: null, },
      { separator: true },
      ...
      { key: "color_theme_is_gradiention5",            name: "グラデーション5",     media_name: null, type: "is-primary", message: null, },
      { key: "color_theme_is_gradiention6",            name: "グラデーション6",     media_name: null, type: "is-primary", message: null, },
      { separator: true },
      { key: "color_theme_is_plasma_blur1",     name: "プラズマブラー1",     media_name: null, type: "is-primary", message: null, },
      { key: "color_theme_is_plasma_blur2",     name: "プラズマブラー2",     media_name: null, type: "is-primary", message: null, },
      { key: "color_theme_is_plasma_blur3",     name: "プラズマブラー3",     media_name: null, type: "is-primary", message: null, },
      { key: "color_theme_is_plasma_blur4",     name: "プラズマブラー4",     media_name: null, type: "is-primary", message: null, },
      { key: "color_theme_is_plasma_blur5",     name: "プラズマブラー5",     media_name: null, type: "is-primary", message: null, },
      { key: "color_theme_is_plasma_blur6",     name: "プラズマブラー6",     media_name: null, type: "is-primary", message: null, },
      { separator: true },
      { key: "color_theme_is_radial_gradiention1",     name: "放射グラデーション1", media_name: null, type: "is-primary", message: null, },
      { key: "color_theme_is_radial_gradiention2",     name: "放射グラデーション2", media_name: null, type: "is-primary", message: null, },
      { key: "color_theme_is_radial_gradiention3",     name: "放射グラデーション3", media_name: null, type: "is-primary", message: null, },
      { key: "color_theme_is_radial_gradiention4",     name: "放射グラデーション4", media_name: null, type: "is-primary", message: null, },
      { key: "color_theme_is_radial_gradiention5",     name: "放射グラデーション5", media_name: null, type: "is-primary", message: null, },
      { key: "color_theme_is_radial_gradiention6",     name: "放射グラデーション6", media_name: null, type: "is-primary", message: null, },
      { separator: true },
      ...
      { separator: true },
      { key: "color_theme_is_splatoon_stripe_red",      name: "スプラトゥーン赤",    media_name: null, type: "is-primary", message: null, },
      { key: "color_theme_is_splatoon_stripe_green",    name: "スプラトゥーン緑",    media_name: null, type: "is-primary", message: null, },
      { key: "color_theme_is_splatoon_stripe_purple",   name: "スプラトゥーン紫",    media_name: null, type: "is-primary", message: null, },
