...
export class ColorThemeInfo extends MemoryRecord {
  ...
  static get define() {
    return [
      { key: "is_color_theme_groovy_board_texture01",  name: "木目盤1",             },
      { key: "is_color_theme_groovy_board_texture02",  name: "木目盤2",             },
      { key: "is_color_theme_groovy_board_texture03",  name: "木目盤3",             },
      { key: "is_color_theme_groovy_board_texture04",  name: "木目盤4",             },
      ...
      { key: "is_color_theme_wars_red",                name: "ウォーズ赤(?)",         },
      { key: "is_color_theme_wars_blue",               name: "ウォーズ青(?)",         },
      { key: "is_color_theme_club24",                  name: "24(?)" ,              },
      { key: "is_color_theme_piyo",                    name: "ぴよ将棋(?)" ,        },
