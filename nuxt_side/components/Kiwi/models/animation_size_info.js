...
export class AnimationSizeInfo extends MemoryRecord {
  ...
  static get define() {
    return [
      ...
      { separator: true                                                                                                                                                                                                                                                                        },
      { key: "is854x480",   name: "854x480",        aspect_ratio: "16:9",   icon: "youtube", type: "is-danger", recommend: "◎", general_name: "FULL HD",     width: 854, height: 480,    type: "is-primary", environment: ["development", "staging", "production"], message: "低画質",        },
      { key: "is1280x720",  name: "1280x720",       aspect_ratio: "16:9",   icon: "youtube", type: "is-danger", recommend: "◎", general_name: "HD",          width: 1280, height:  720,  type: "is-primary", environment: ["development", "staging", "production"], message: "普通画質",      },
      { key: "is1920x1080", name: "1920x1080",      aspect_ratio: "16:9",   icon: "youtube", type: "is-danger", recommend: "◎", general_name: "FULL HD",     width: 1920, height: 1080,  type: "is-primary", environment: ["development", "staging", "production"], message: "高画質",        },
      { separator: true                                                                                                                                                                                                                                                                        },
