...
export class ParamInfo extends MemoryRecord {
  static get define() {
    return [
      ...
      { key: "rect_size_key",      type: "string",  name: "サイズ",              default: "is_1920x1080",              permanent: true,  relation: "RectSizeInfo",      desc: "",           },
      ...
      { key: "main_volume"   ,     type: "float",   name: "音量",                default: 0.3,                         permanent: true,  relation: null,                desc: "",           },
