...
.KiwiBananaShowMain.columns.is-multiline.is-variable.is-0-mobile.is-4-tablet.is-5-desktop.is-6-widescreen.is-7-fullhd
  .column.is-12-tablet.is-10-desktop.is-8-widescreen
    ...
    .media
      .media-left
        nuxt-link.image.is_avatar_image(:to="{name: 'users-id', params: {id: base.banana.user.id}}" @click.native="sfx_click()")
      ...
      .media-content
        ...
        .nav_line
          .nav_line_left.is_line_break_on.has-text-grey
            nuxt-link(:to="{name: 'users-id', params: {id: base.banana.user.id}}" @click.native="sfx_click()")
          ...
          .nav_line_right
            .buttons.mb-0
              ...
              b-button.mb-0(type="is-primary" @click.native="sfx_click()" tag="nuxt-link" :to="{name: 'video-studio-banana_key-edit', params: {banana_key: base.banana.key}}" v-if="base.banana && base.owner_p") 編集
