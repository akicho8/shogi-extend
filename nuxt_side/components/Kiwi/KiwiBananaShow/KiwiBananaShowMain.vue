        ...
        .nav_line
          ...
          .nav_line_right
            .buttons.mb-0
              ...
              b-button.mb-0(type="is-primary" @click.native="sound_play_click()" tag="nuxt-link" :to="{name: 'video-studio-banana_key-edit', params: {banana_key: base.banana.key}}" v-if="base.banana && base.owner_p") 編集
