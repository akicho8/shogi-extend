...
.KiwiLemonIndexApp
  ...
  .MainContainer
    KiwiLemonIndexSidebar(:base="base")
    KiwiLemonIndexNavbar(:base="base")
    MainSection
      .container.is-fluid
        KiwiLemonIndexSearchAppear(:base="base")
        KiwiLemonIndexCardListTag(:base="base")
        KiwiLemonIndexCardList(:base="base")
...
export default {
  ...
  fetch() {
    ...
    return this.$axios.$get("/api/kiwi/lemons/index.json", {params}).then(e => {
      this.meta = e.meta
      ...
      this.lemons = e.lemons.map(e => new Lemon(this, e))
      // this.total       = e.total
      // this.lemon_counts = e.lemon_counts
    })
  },
