<template lang="pug">
MainNavbar.KiwiLemonIndexNavbar(:spaced="false" wrapper-class="container is-fluid px-0")
  template(slot="brand")
    NavbarItemHome
  ...
  template(slot="start")
    b-navbar-item.is-hidden-touch.with_search_field(tag="div")
      KiwiLemonIndexSearch(:base="base")
