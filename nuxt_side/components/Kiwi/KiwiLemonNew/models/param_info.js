...
export class ParamInfo extends ParamBase {
  static get define() {
    return [
      ...
      { key: "piece_font_weight_key", type: "string",  name: "駒書体の太さ",        default: "is_piece_font_weight_normal",          permanent: true,  relation: "PieceFontWeightInfo", desc: "",           },
      ...
      { key: "column_size_code",      type: "integer", name: "配色カラムサイズ",    default: 1,                                      permanent: true,  relation: "ColumnSizeInfo",      desc: "",           },
    ]
  }
}
