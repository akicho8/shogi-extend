...
.KiwiLemonNewFormText
  ...
  .field_block.body_field
    ...
    b-field.mb-0.mt-2(:type="base.body_field_type")
      ...
      b-input(type="textarea" ref="body" v-model.trim="base.body" expanded rows="4" placeholder="KIF KI2 CSA SFEN BOD の本体かURL。共有将棋盤・ぴよ将棋・KENTO・将棋DB2のように棋譜をパラメータに含むURL。棋譜URLをコンテンツに含むサイトURL。戦法名・囲い名などを入力してください")
