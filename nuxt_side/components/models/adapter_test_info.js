    ...
    return [
      ...
      },
      {
        ...
        items: [
          ...
          { name: "将棋DB2の対局画面",    success: true,  body: "https://shogidb2.com/games/0e0f7f6518bca14e5b784015963d5f38795c86a7", },
          ...
          { name: "二歩のURL",            success: true,  body: "https://www.shogi-extend.com/share-board?body=position.sfen.4k4%2F9%2F4p4%2F9%2F9%2F9%2F4P4%2F9%2F4K4.b.P.1.moves.5g5f.5c5d.P%2a5e", },
          { name: "パラメータ(kif)",      success: true,  body: "http://example.com/?kif=76%E6%AD%A9"                  },
          { name: "パラメータ(ki2)",      success: true,  body: "http://example.com/?ki2=76%E6%AD%A9"                  },
          { name: "パラメータ(csa)",      success: true,  body: "http://example.com/?csa=76%E6%AD%A9"                  },
          { name: "パラメータ(bod)",      success: true,  body: "http://example.com/?bod=76%E6%AD%A9"                  },
          { name: "パラメータ(kifu)",     success: true,  body: "http://example.com/?kifu=76%E6%AD%A9"                 },
          { name: "パラメータ(body)",     success: true,  body: "http://example.com/?body=76%E6%AD%A9"                 },
          { name: "パラメータ(text)",     success: true,  body: "http://example.com/?text=76%E6%AD%A9"                 },
          { name: "パラメータ(content)",  success: true,  body: "http://example.com/?content=76%E6%AD%A9"              },
          { name: "パラメータ(fragment)", success: true,  body: "http://example.com/#76%E6%AD%A9"                      },
        ],
      },
