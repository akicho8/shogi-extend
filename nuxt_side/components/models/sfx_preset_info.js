...
export class SfxPresetInfo extends ApplicationMemoryRecord {
  static get define() {
    return [
      ...
      { key: "se_piece_lift_cancel",         name: "持ち上げキャンセル",       volume: 0.3,  source: require("@/assets/USF/ELEMENTS/Water/Drops/DROP_Designed_mono.wav"), },
      ...
      { key: "se_piece_put",                 name: "置く",                     volume: 0.3,  source: require("@/static/sound_effect/audiostock/as1301271.wav"),                                    }, // ::SE_PIECE_PUT_VOLUME:: nuxt_side/components/ShareBoard/models/param_info.js と合わせる

      // { key: "se_piece_put",                 name: "置く",                     volume: 0.3,  source: require("@/assets/USF/WEAPONS/Firearms/Fire_First_Person_Shooter_FPS/FIREARM_Shotgun_Model_02_Fire_Single_RR1_stereo.wav"),                                    }, // ::SE_PIECE_PUT_VOLUME:: nuxt_side/components/models/sfx_preset_info.js と合わせる
      // { key: "se_piece_put",                 name: "置く",                     volume: 0.3,  source: require("@/assets/USF/IMPACTS/Bricks/IMPACT_Brick_vs_Brick_RR1_mono.wav"),                                    }, // ::SE_PIECE_PUT_VOLUME:: nuxt_side/components/models/sfx_preset_info.js と合わせる
