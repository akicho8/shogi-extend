...
export class CcRuleInfo extends ApplicationMemoryRecord {
  static get define() {
    return [
      ...
      { name: "24 早指 1分持ち 秒読み30",   cc_params_one: { initial_main_min: 1,  initial_read_sec:30, initial_extra_sec: 0,  every_plus:0, }, },
      { name: "24 早指2 秒読み30 猶予60",  cc_params_one: { initial_main_min: 0,  initial_read_sec:30, initial_extra_sec: 60, every_plus:0, }, },
