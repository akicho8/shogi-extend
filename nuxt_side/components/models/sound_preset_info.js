...
export class SoundPresetInfo extends ApplicationMemoryRecord {
  static get define() {
    return [
      ...
      { key: "se_toggle_on",                  name: "トグルON",                 source: require("@/assets/SND01_sine/toggle_on.wav"),       volume: 0.1, },
      { key: "se_toggle_off",                 name: "トグルOFF",                source: require("@/assets/SND01_sine/toggle_off.wav"),      volume: 0.1, },
      ...
      { key: "se_caution",                    name: "危険",                     source: require("@/assets/SND01_sine/caution.wav"),         volume: 0.5, },
      { key: "se_transition_up",              name: "遷移(進む)",               source: require("@/assets/SND01_sine/transition_up.wav"),   volume: 0.5, },
      { key: "se_transition_down",            name: "遷移(戻る)",               source: require("@/assets/SND01_sine/transition_down.wav"), volume: 0.5, },
      { key: "se_celebration",                name: "完了祝福",                 source: require("@/assets/SND01_sine/celebration.wav"),     volume: 0.5, },
      ...
      { key: "lose",          name: "負け",                                     source: require("@/static/sound_effect/oto_logic/Onmtp-Ding05-1.mp3"),                                           volume: 0.30, },
      ...
      { key: "bgm_battle_toryo1",   name: "終局BGM1",                           source: require("@/assets/bgm/bgm1.mp3"),       volume: 0.50, },
      { key: "bgm_battle_toryo2",   name: "終局BGM2",                           source: require("@/assets/bgm/bgm2.mp3"),       volume: 0.50, },
      { key: "bgm_battle_toryo3",   name: "終局BGM3",                           source: require("@/assets/bgm/bgm3.mp3"),       volume: 0.50, },
      { key: "bgm_battle_toryo4",   name: "終局BGM4",                           source: require("@/assets/bgm/bgm4.mp3"),       volume: 0.50, },
      { key: "bgm_battle_toryo5",   name: "終局BGM5",                           source: require("@/assets/bgm/bgm5.mp3"),       volume: 0.50, },
