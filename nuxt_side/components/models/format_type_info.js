...
export class FormatTypeInfo extends ApplicationMemoryRecord {
  static get define() {
    return [
      { key: "kif_utf8",      name: `KIF`,              name_with_turn: t => `KIF`,              format_key: "kif",  body_encode: "UTF-8",     show: true,  clipboard: true,  },
      { key: "kif_shiftjis",  name: `KIF (Shift_JIS)`,  name_with_turn: t => `KIF (Shift_JIS)`,  format_key: "kif",  body_encode: "Shift_JIS", show: false, clipboard: false, },
