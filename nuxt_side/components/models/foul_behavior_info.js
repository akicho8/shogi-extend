...
export class FoulBehaviorInfo extends ApplicationMemoryRecord {
  ...
  static get define() {
    return [
      ...
      // |----------------+-------+-------+--------------------------------------------------+--------|
      { key: "is_foul_behavior_auto",   name: "したら負け", message: "自動的に指摘する(24風)",       sp_play_mode_foul_check_p: true,  sp_play_mode_foul_break_p: false, environment: ["development", "staging", "production"], },
