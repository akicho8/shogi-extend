  ...
  methods: {
    edit_warn_modal_open() {
      ...
      this.edit_warn_modal_instance = this.dialog_confirm({
        ...
        message: [
          `<div class="content">`,
          // /**/ `<p>1手戻したいだけならメニューから<b>1手戻す</b>を選択してください。</p>`,
          // /**/ `<p>局面編集すると、現時点までの棋譜を破棄し、編集後の局面を0手目とした棋譜になってしまいます。</p>`,
          // /**/ `<p>共有中の局面編集は基本的に手合割にない変則的な配置から対局したいときにだけ使ってください。</p>`,
          /**/ `<p>編集すると現時点までの棋譜を失う</p>`,
          // /**/ `<p class="is-size-7">共有中の局面編集は手合割にない変則的な配置から対局したいときにだけ使ってください</p>`,
          `</div>`,
        ].join(""),
