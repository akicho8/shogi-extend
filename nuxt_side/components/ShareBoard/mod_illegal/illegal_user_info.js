  ...
  static get define() {
    return [
      ...
      },
      {
        ...
        resign_click_message: null,
        takebacked_message: (context)   => `${context.my_call_name}が仲間の反則を取り消しました`,
      },
      {
        key: "op_team",
        name: "対戦者",
        modal_body_message: (context)   => `${context.my_call_name}は「待った」で反則を取り消せます`,
        resign_click_message: (context) => `${context.my_call_name}は対戦相手なので投了できません`,
        takebacked_message: (context)   => `${context.my_call_name}がお情けで反則を取り消しました`,
      },
      {
        key: "watcher",
        name: "観戦者",
        modal_body_message: (context)   => `${context.my_call_name}は観戦者ですが「待った」で反則を取り消せます`,
        resign_click_message: (context) => `${context.my_call_name}は観戦者なので投了できません`,
        takebacked_message: (context)   => `${context.my_call_name}が反則を取り消しました`,
      },
    ]
  }
}
