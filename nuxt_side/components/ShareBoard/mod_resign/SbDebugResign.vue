  ...
  .columns.is-multiline
    .column.is-4
      .panel
        ...
        a.panel-block(@click="SB.resign_direct_run_with_valid") 投了ボタン(バリデーションあり)
        a.panel-block(@click="SB.resign_direct_run('black')") ☗側の投了実処理
        ...
        a.panel-block(@click="SB.resign_direct_run(null)") 引分
    .column.is-4
      .panel.assert_var
        .panel-heading
          | [assert_var]
