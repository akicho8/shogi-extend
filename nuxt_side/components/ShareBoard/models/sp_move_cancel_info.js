...
export class SpMoveCancelInfo extends ApplicationMemoryRecord {
  ...
  static get define() {
    return [
      ...
      { key: "is_move_cancel_reality",  name: "元の位置",   type: "is-primary", message: "従来の方法。リアルで指すのと同じように元の位置に戻す。そうしてほしかった。しかし他のアプリに慣れすぎてしまい順応できない者たちが多かったため仕方なく初期値を変更した。右クリックやESCキーでもキャンセルできる", },
    ]
  }
}
