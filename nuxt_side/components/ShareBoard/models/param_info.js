...
export class ParamInfo extends ApplicationMemoryRecord {
  static get define() {
    return [
      ...
      // { key: "piece_font_weight_key",          type: "string",  name: "駒を太字にする条件",  default: "is_piece_font_weight_normal",           permanent: true,  relation: null,                desc: "",           },
