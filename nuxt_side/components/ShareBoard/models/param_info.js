...
export class ParamInfo extends ParamBase {
  static get define() {
    return [
      ...
      { key: "sp_move_cancel_key",       type: "string",  name: "駒移動キャンセル",              defaults: { development: "is_move_cancel_easy",  production: "is_move_cancel_hard",         }, permanent: true,  relation: "SpMoveCancelInfo",    desc: null, },
      ...
      { key: "message_scope_key",        type: "string",  name: "メッセージ送信スコープ",        defaults: { development: null,                   production: "is_ms_all",                      }, permanent: false, relation: "MessageScopeInfo",    desc: null, },
    ]
  }
}
