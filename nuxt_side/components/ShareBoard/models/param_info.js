...
export class ParamInfo extends ParamBase {
  static get define() {
    return [
      ...
      { key: "color_theme_key",          type: "string",  name: "画像の配色",                    defaults: { development: null,                      production: "is_color_theme_paper_simple", }, permanent: true,  relation: "ColorThemeInfo",      desc: null, },
      { key: "main_theme_key",           type: "string",  name: "基本配色",                      defaults: { development: null,                      production: "is_main_theme_a",  }, permanent: true,  relation: "MainThemeInfo",       desc: null, },
      ...
      { key: "howl_play_mode_key",       type: "string",  name: "再生方法",                      defaults: { development: null,                      production: "web_audio_api",               }, permanent: true,  relation: "HowlPlayModeInfo",    desc: null, },
      ...
      { key: "two_pawn_mode_key",        type: "string",  name: "二歩の扱い",                    defaults: { development: null,                      production: "two_pawn_mode_allow",         }, permanent: false, relation: "TwoPawnModeInfo",     desc: null, },
      { key: "hand_every_n",             type: "integer", name: "N手毎交代",                     defaults: { development: null,                      production: 1,                             }, permanent: false, relation: null,                  desc: null, },
      { key: "board_width",              type: "float",   name: "盤の大きさ",                    defaults: { development: null,                      production: 84.0,                          }, permanent: true,  relation: null,                  desc: null, },
