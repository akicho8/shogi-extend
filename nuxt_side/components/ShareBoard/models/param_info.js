...
export class ParamInfo extends ParamBase {
  static get define() {
    return [
      ...
      { key: "shout2_mode_key",          type: "string",  name: "二歩禁止モード",                defaults: { development: null,                      production: "is_shout2_mode_off",          }, permanent: false, relation: "Shout2ModeInfo",      desc: null, },
