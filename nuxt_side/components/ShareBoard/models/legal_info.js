...
export class LegalInfo extends ApplicationMemoryRecord {
  ...
  static field_message = "無視にすると禁じ手や手番の制約がなくなる。つまり自分の手番で相手の駒を操作できる。それを利用して後手のときも先手の駒を動かせばずっと先手側を操作できるので先手だけの囲いの手順の棋譜(SFENに限る)を作ったりするのが簡単になる。しかし反則のため他のアプリでは読めない棋譜になってしまう"
