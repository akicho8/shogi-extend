...
export class ImageSizeInfo extends ApplicationMemoryRecord {
  ...
  static get define() {
    return [
      ...
      { key: "is_image_size_1280x960",  name: "1280x960",  width: 1280, height: 960,  master_scale: 1.0, aspect_ratio: "4:3",  environment: ["development", "staging", "production"], },
      { key: "is_image_size_1080x810",  name: "1080x810",  width: 1080, height: 810,  master_scale: 1.0, aspect_ratio: "4:3",  environment: ["development", "staging", "production"], },
      ...
      { key: "is_image_size_1280x720",  name: "1280x720",  width: 1280, height: 720,  master_scale: 1.0, aspect_ratio: "16:9", environment: ["development", "staging", "production"], },
      { key: "is_image_size_1080x608",  name: "1080x608",  width: 1080, height: 608,  master_scale: 1.0, aspect_ratio: "16:9", environment: ["development", "staging", "production"], },
      { separator: true                                                                                                                                                               },
      { key: "is_image_size_1200x1200", name: "1200x1200", width: 1200, height: 1200, master_scale: 0.8, aspect_ratio: "1:1",  environment: ["development"],                          },
