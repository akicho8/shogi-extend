...
.SbDebugPanelsHowler.column.is-4
  .panel
    .panel-heading
      | 無音化不具合検証用
    a.panel-block(@click="TheSb.sound_resume_modal_handle") 画面タップ催促表示確認
    a.panel-block(@click="TheSb.sound_resume_modal_close") 画面タップ催促閉じる
    a.panel-block(@click="TheSb.sound_bug_start") ガヤ開始
    a.panel-block(@click="TheSb.sound_bug_stop") ガヤ停止
    a.panel-block(v-if="TheSb.sb_counter") ガヤ回数 {{TheSb.sb_counter.counter}}
