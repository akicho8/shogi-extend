...
export class CcBehaviorInfo extends ApplicationMemoryRecord {
  static get define() {
    return [
      ...
      { key: "cc_behavior_silent_pause",  receive_message: "一時停止しました",   label: "一時停止",         label_type: null,         with_url: false, with_member_data: false, log_level: "info", toast_p: false, with_talk: false, history: true,  },
      ...
      // { key: "cc_behavior_silent_resume", receive_message: "時計を再開しました", label: "時計再開",         label_type: null,         with_url: false, with_member_data: false, log_level: null,   toast_p: false, with_talk: false, history: true,  },
      ...
      { key: "cc_behavior_silent_stop",   receive_message: "時計を停止しました", label: "時計停止",         label_type: "is-primary", with_url: true,  with_member_data: true,  log_level: "info", toast_p: false, with_talk: false, history: true,  },
      { key: "cc_behavior_timeout",       receive_message: "時間切れ",           label: "時間切れ",         label_type: "is-danger",  with_url: true,  with_member_data: false, log_level: "info", toast_p: false, with_talk: false, history: true,  }, // 特別処理
