...
export class CcBehaviorInfo extends ApplicationMemoryRecord {
  static get define() {
    return [
      ...
      { key: "cc_behavior_start",         receive_message: "対局を開始しました", label: "対戦開始",         label_type: "is-primary", with_url: false, with_member_data: true,  log_level: "info", toast_p: false, with_talk: false, history: true,  }, // 特別処理
      ...
      { key: "cc_behavior_pause_silent",  receive_message: null,                 label: "一時停止",         label_type: "is-primary", with_url: false, with_member_data: false, log_level: "info", toast_p: false, with_talk: false, history: true,  },
      ...
      { key: "cc_behavior_resume_silent", receive_message: null,                 label: "時計再開",         label_type: "is-primary", with_url: false, with_member_data: false, log_level: null,   toast_p: false, with_talk: false, history: true,  },
      ...
      { key: "cc_behavior_stop_silent",   receive_message: null,                 label: "時計停止",         label_type: "is-primary", with_url: true,  with_member_data: true,  log_level: "info", toast_p: false, with_talk: false, history: true,  },
