...
export class CcBehaviorInfo extends ApplicationMemoryRecord {
  static get define() {
    return [
      ...
      { key: "cc_behavior_start",         receive_message: "開始しました",       label: "対局開始",         label_type: "is-primary", with_url: false, with_member_data: true,  log_level: "info", toast_p: false, with_talk: false, history: true,  }, // 特別処理
