...
export class CcBehaviorInfo extends ApplicationMemoryRecord {
  static get define() {
    return [
      ...
      { key: "cc_behavior_start",         receive_message: "開始しました",       label: "対局開始",         label_type: "is-primary", with_url: false, with_member_data: true,  log_level: "important", toast_p: false, with_talk: false, history: true,  }, // 特別処理
      ...
      { key: "cc_behavior_stop",          receive_message: "時計を停止しました", label: "時計停止",         label_type: "is-primary", with_url: true,  with_member_data: true,  log_level: "important", toast_p: true,  with_talk: true,  history: true,  },
      { key: "cc_behavior_silent_stop",   receive_message: "時計を停止しました", label: "時計停止",         label_type: "is-primary", with_url: true,  with_member_data: true,  log_level: "important", toast_p: true,  with_talk: false, history: true,  },
      { key: "cc_behavior_timeout",       receive_message: "時間切れ",           label: "時間切れ",         label_type: "is-danger",  with_url: true,  with_member_data: false, log_level: "important", toast_p: false, with_talk: false, history: true,  }, // 特別処理
