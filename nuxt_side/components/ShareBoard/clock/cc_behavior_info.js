...
export class CcBehaviorInfo extends ApplicationMemoryRecord {
  static get define() {
    return [
      ...
      { key: "cc_behavior_silent_stop",   receive_message: "時計を停止しました", label: "時計停止",         label_type: "is-primary", with_url: true,  with_member_data: true,  log_level: "info", toast_p: true,  with_talk: false, history: true,  },
