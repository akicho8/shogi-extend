...
export class ShortcutInfo extends ApplicationMemoryRecord {
  static get define() {
    return [
      { category_key: "インポート",   name: "棋譜の張り付け",         trigger_type: "key",  trigger_key: "V",         if_mode: "play", if_debug: false, method: "kifu_load_from_clipboard",              },
      { category_key: "インポート",   name: "棋譜の読み込み",         trigger_type: "key",  trigger_key: "R",         if_mode: "play", if_debug: false, method: "kifu_loader_modal_open_handle",         },
      { category_key: "インポート",   name: "局面編集 / 完了",        trigger_type: "key",  trigger_key: "E",         if_mode: null,   if_debug: false, method: "play_edit_mode_toggle_handle",          },
      { category_key: "インポート",   name: "対局履歴 / 閉じる",      trigger_type: "key",  trigger_key: "l",         if_mode: "play", if_debug: false, method: "battle_list_modal_toggle_handle",       },
      ...
      { category_key: "検討",         name: "初期配置に戻す",         trigger_type: "key",  trigger_key: "0",         if_mode: "play", if_debug: false, method: "turn_change_to_zero_modal_open_handle", },
      ...
      { category_key: "対局",         name: "ダイレクト入室",         trigger_type: "key",  trigger_key: "I",         if_mode: "play", if_debug: false, method: "gate_direct_enter_handle",              },
      { category_key: "対局",         name: "ダイレクト退室",         trigger_type: "key",  trigger_key: "Q",         if_mode: "play", if_debug: false, method: "gate_leave_handle",                     },

      { category_key: "検討",         name: "現局面を本譜とする",     trigger_type: "key",  trigger_key: "W",         if_mode: "play", if_debug: false, method: "honpu_master_setup_for_shortcut",       },
      { category_key: "検討",         name: "本譜を開く",             trigger_type: "key",  trigger_key: "h",         if_mode: "play", if_debug: false, method: "honpu_modal_toggle_handle",             },
      { category_key: "検討",         name: "本譜に戻る",             trigger_type: "key",  trigger_key: "Z",         if_mode: "play", if_debug: false, method: "honpu_direct_return_handle",            },
