...
** 順番設定あり・時計作動中
   ...
   http://localhost:4000/share-board?room_code=my_room&force_user_name=alice&ordered_member_names=alice,bob&clock_box_initial_main_min=60&clock_box_play_handle=true
