...
** 自分は a で部屋に abcdef いて順番が abcd で順番設定を開く
   ...
   http://localhost:4000/share-board?room_key=dev_room&user_name=a&fixed_member=a,b,c,d,e&fixed_order_state=to_o1_state&fixed_order=a,b,c,d&handle_name_validate_p=false&room_enter_autoexec=os_modal_open_handle
