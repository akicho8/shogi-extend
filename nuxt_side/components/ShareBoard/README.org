...
** 振り駒
   ...
   # 常に反転 x 2回 なので 歩5枚
   http://localhost:4000/share-board?room_key=a&user_name=alice&fixed_order_state=to_o1_state&fixed_order=alice,bob,carol,dave&room_after_create=os_modal_open_handle&furigoma_random_key=is_true&shakashaka_count=2

   # 常に反転 x 3回 なので と金5枚
   http://localhost:4000/share-board?room_key=a&user_name=alice&fixed_order_state=to_o1_state&fixed_order=alice,bob,carol,dave&room_after_create=os_modal_open_handle&furigoma_random_key=is_true&shakashaka_count=3
