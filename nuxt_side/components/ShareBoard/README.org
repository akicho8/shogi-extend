...
** 自分は a で部屋に abcd いて順番が abcd で順番設定を開く

   http://localhost:4000/share-board?room_code=my_room&fixed_user_name=a&fixed_member_names=a,b,c,d&fixed_order_names=a,b,c,d&handle_name_validate=false&autoexec=os_modal_handle
