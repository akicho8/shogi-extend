<template lang="pug">
b-dropdown.SbColorThemeDropdown(v-model="SB.color_theme_key" @active-change="e => e && $sound.play_click()" position="is-bottom-left" :max-height="screen_is_desktop ? '50vh' : null" :scrollable="screen_is_desktop" @change="SB.color_theme_key_change_handle")
  template(#trigger)
