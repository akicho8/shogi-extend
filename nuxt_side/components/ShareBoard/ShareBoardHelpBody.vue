...
.ShareBoardHelpBody
  .content
    ...
    article
      ...
      .article_body
        ul
          li 現在の棋譜の指し手を遡って「0手目」に戻し、全員に盤を転送する
          li 「平手の初期配置にセットする」のではない

    article
      h2 「初期配置に戻す」をタップしたのに平手の初期配置に戻らない原因は？
      .article_body
        p 盤面編集したから。
        p 盤面編集するとそれまでの棋譜が失なわれ確定した局面が0手目になる。「初期配置に戻す」は0手目に戻す動作なので、正しく初期配置になっているものの「平手の初期配置にセットする」の意図だったため齟齬が起きている
    ...
    article
      ...
      .article_body
        p 棋譜リンクコピー
        p 棋譜コピーでも良いがURLだとタップするだけで確認できる
        ...
        table.table
          ...
          tr
            ...
            td
              ...
              | この値だけは変動しない<br>
              | これを設定するときは分かりやすさのため「秒読み」「猶予」は設定しないほうがよい<br>
