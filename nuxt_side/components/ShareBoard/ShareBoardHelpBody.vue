  ...
  .content
      ...
      .article_body
        ...
        ol.mt-2
          ...
          li
            ...
            ul.is-size-6.mt-1
              ...
              li 観戦をしに来ただけの人がいたら「OK」を「観戦」に変更する
              li 奇数人でやってもいいけど1周する度に<b>先後がずれる</b>
          li
            | 対局時計
            ul.is-size-6.mt-1
              li
        ...
        ol.mt-2
          ...
          li
            ...
            ul.is-size-6.mt-1
              li もう検討が始まっていて本筋を上書きしてしまった場合は、右の履歴から「時計停止」をタップし、その中の「リンク」をタップする
    ...
    article
      ...
      .article_body
        p
          | ☗または☖をタップ
        p
          | 時計を開始したタイミングで後手番になった人の盤だけ自動的に反転するので基本的に自分で操作するは必要はない。
    ...
    article
      ...
      .article_body
        ul
          li 1周するたびに先後がずれる
          li 何か新しい遊びができるかもしれないので制限はしてない

    article
      h2 リレー将棋を1人で試すには？
      .article_body
        p 部屋を立てて1人で順番設定して時計を設置して始める。自分対自分になる
    ...
    article
      ...
      .article_body
        ul
          ...
          li 実行は一瞬だが内部では実際に5枚の歩を10回から20回しゃかしゃかやっている
    ...
    article
      ...
      .article_body
        table.table
          ...
          tr
            th 1手毎加算(秒)
            td フィッシャールール用の1手指すごとに「持ち時間」に加算する秒数。この値だけはプレイ中に変動しない。これを設定するときは「秒読み」「猶予」は設定しないほうがよい。設定するとややこしくなる。
    ...
    article
      ...
      .article_body
        ul
          ...
          li ハンドルネームの入力初期値がログイン名になっているというだけの関係
