<template lang="pug">
b-dropdown.SbColorThemeDropdown(
  append-to-body
  v-model="SB.color_theme_key"
  @active-change="e => e && sfx_click()"
  position="is-bottom-left"
  :max-height="screen_is_desktop ? '50dvh' : null"
  :scrollable="screen_is_desktop"
  @change="SB.color_theme_key_change_handle"
  )
  template(#trigger)
