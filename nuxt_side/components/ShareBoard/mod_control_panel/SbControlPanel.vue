    ...
    .mt-4
      ...
      b-menu
        b-menu-list(label="局面操作")
          //- 即実行
          b-menu-item.is_active_unset.reflector_turn_zero_handle(icon="page-first" label="初期配置に戻す"   @click="SB.reflector_turn_zero_handle" :class="SB.bold_if(SB.current_turn >= 1)")
          b-menu-item.is_active_unset.reflector_turn_previous_handle(icon="undo"   label="1手戻す (待った)" @click="SB.reflector_turn_previous_handle")
          //- モーダル版
        ...
        b-menu-list(label="その他")
          ...
          b-menu-item.is_active_unset(icon="cog-outline" label="個人設定"                    @click="SB.general_setting_modal_open_handle")
