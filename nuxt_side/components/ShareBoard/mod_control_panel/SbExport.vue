...
.SbExport
  b-menu-list(label="EXPORT")
    ...
    b-menu-item.is_active_unset(__unuse__icon="clipboard-plus-outline" @click="sfx_click()")
    ...
    b-menu-item.is_active_unset(__unuse__icon="eye" :expanded="false" @click="sfx_click()")
      template(slot="label" slot-scope="props")
        | 棋譜表示
        b-icon.is-pulled-right(:icon="props.expanded ? 'menu-up' : 'menu-down'")
      template(v-for="e in base.FormatTypeInfo.values")
    ...
    b-menu-item.is_active_unset(__unuse__icon="download" @click="sfx_click()")
      template(slot="label" slot-scope="props")
        | 棋譜ダウンロード
        b-icon.is-pulled-right(:icon="props.expanded ? 'menu-up' : 'menu-down'")
      template(v-for="e in base.FormatTypeInfo.values")
