    ...
    .mt-4
      b-menu
        ...
        b-menu-list(label="検討")
          ...
          b-menu-item.is_active_unset.is-hidden-mobile(icon="alpha-p-box-outline"    label="局面ペディア"     :href="base.kpedia_url"              :target="target_default" @click="base.other_app_click_handle('局面ペディア')")
