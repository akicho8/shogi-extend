      ...
      if (this.room_restore_feature_p) {
        ...
        if (e) {
          if (this.room_restore_update_p) {
            ...
            this.tl_p(`this.current_title = "${e.room_name}"`)
          }
        }
        this.tl_p("room_restore_call: 4")
      }
      this.tl_p("<-- room_restore_call")
    },
  },
