export const mod_room_board_setup = {
  methods: {
    ...
    setup_info_send(params) {
      this.$gs.assert(params.to_connection_id != null, "params.to_connection_id != null")
      this.$gs.assert(params.to_user_name != null, "params.to_user_name != null")
