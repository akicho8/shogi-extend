...
.columns.is-multiline.SbFesPanel
  .column.is-3
    .panel
      .panel-heading
        | 投票(ホスト側)
      a.panel-block(href="/share-board?room_key=dev_room&user_name=a&fixed_member=a,b,c,d,e&fixed_order_state=to_o2_state&handle_name_validate=false&autoexec=client_vote_sample") 確認用の環境に変更する
