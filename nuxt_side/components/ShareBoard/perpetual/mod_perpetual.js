        ...
        if (e.op_king_check) {
          ...
          if (this.cc_play_p) {
            ...
            if (this.foul_mode_info.perpetual_check_mode === "show_warning") {
              // 反則しても待ったできるとき
              this.xhistory_action({label: illegal_hv.illegal_info.name, label_type: "is-danger", full_message: this.perpetual_check_warn_message, duration_sec: 10, __standalone_mode__: true})
            ...
            // 検討中
            this.sfx_play("x")
            this.xhistory_action({label: illegal_hv.illegal_info.name, label_type: "is-danger", __standalone_mode__: true})
          }
          ...
          if (this.cc_play_p) {
            ...
            if (this.foul_mode_info.perpetual_mode === "show_warning") {
              this.xhistory_action({label: "千日手", label_type: "is-danger", full_message: this.perpetual_warn_message, duration_sec: 10, __standalone_mode__: true})
            }
          } else {
            // 検討中
            this.sfx_play("x")
            this.xhistory_action({label: "千日手", label_type: "is-danger", __standalone_mode__: true})
          }
