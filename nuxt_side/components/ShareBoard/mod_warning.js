...
export const mod_warning = {
  ...
  computed: {
    // 不整合状態
    inconsistency_order_only() { return this.cable_p && this.order_enable_p  && !this.cc_play_p                          }, // 入室中に順番だけが有効になっている？
    inconsistency_clock_only() { return this.cable_p && !this.order_enable_p &&  this.cc_play_p                          }, // 入室中に時計だけが有効になっている？
    inconsistency_p()          { return this.cable_p && (this.inconsistency_order_only || this.inconsistency_clock_only) }, // つまり不整合な状態か？
