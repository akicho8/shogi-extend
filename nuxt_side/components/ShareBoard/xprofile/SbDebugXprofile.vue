  ...
  .columns.is-multiline
    .column.is-6
      .panel
        .panel-heading
          | 勝率情報
        a.panel-block(href="?room_key=dev_room1&user_name=alice&fixed_member=alice,bob&fixed_order=alice,bob&fixed_order_state=to_o2_state&room_enter_autoexec=cc_auto_start") URL: 確認用の環境に変更する
