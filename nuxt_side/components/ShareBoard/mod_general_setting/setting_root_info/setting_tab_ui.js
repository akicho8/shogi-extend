...
export class SettingTabUi extends SettingTabBase {
  static get define() {
    return [
      ...
      { key: "chat_button_visibility_key",       show: true,  resetable: true, component_name: "SettingInput", },
      { key: "send_trigger_key",                 show: false, resetable: true, component_name: "SettingInput", },
      { key: "origin_mark_behavior_key",         show: true,  resetable: true, component_name: "SettingInput", },
