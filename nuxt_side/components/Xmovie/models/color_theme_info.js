...
export class ColorThemeInfo extends MemoryRecord {
  ...
  static get define() {
    return [
      ...
      { key: "style_editor_aiiro_theme", name: "藍色",                media_name: null, type: "is-primary", message: null, },
      { key: "youtube_red_theme",        name: "Youtube",             media_name: null, type: "is-primary", message: null, },
      { key: "mario_sky_theme",          name: "マリオの空",          media_name: null, type: "is-primary", message: null, },

      { separator: true },
      { key: "splatoon_red_black_theme",     name: "スプラトゥーンA", media_name: null, type: "is-primary", message: null, },
      { key: "splatoon_green_black_theme",   name: "スプラトゥーンB", media_name: null, type: "is-primary", message: null, },
      { separator: true },
