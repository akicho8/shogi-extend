...
export class ColorThemeInfo extends MemoryRecord {
  ...
  static get define() {
    return [
      { separator: true },
      { key: "color_theme_is_real_wood1",              name: "リアル木1",           media_name: null, type: "is-primary", message: null, },
      { key: "color_theme_is_real_wood2",              name: "リアル木2",           media_name: null, type: "is-primary", message: null, },
      { key: "color_theme_is_real_wood3",              name: "リアル木3",           media_name: null, type: "is-primary", message: null, },
      { key: "color_theme_is_cg_wood1",           name: "CGの木1",             media_name: null, type: "is-primary", message: null, },
      { key: "color_theme_is_cg_wood2",           name: "CGの木2",             media_name: null, type: "is-primary", message: null, },
      { key: "color_theme_is_cg_wood3",           name: "CGの木3",             media_name: null, type: "is-primary", message: null, },
      { key: "color_theme_is_cg_wood4",           name: "CGの木3",             media_name: null, type: "is-primary", message: null, },
      { separator: true },
      ...
      { separator: true },
      { key: "color_theme_is_youtube_red",             name: "Youtube の赤",        media_name: null, type: "is-primary", message: null, },
