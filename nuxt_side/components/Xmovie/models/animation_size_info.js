...
export class AnimationSizeInfo extends MemoryRecord {
  ...
  static get define() {
    return [
      ...
      { separator: true },
      { key: "is854x480",   name: "854x480",        aspect_ratio: "16:9",   icon: "youtube", type: "is-danger", recommend: "◎", general_name: "FULL HD",     width: 854, height: 480,    type: "is-primary", environment: ["development", "staging", "production"], message: "動画サイト向け 低画質",   },
      { key: "is1280x720",  name: "1280x720",       aspect_ratio: "16:9",   icon: "youtube", type: "is-danger", recommend: "◎", general_name: "HD",          width: 1280, height:  720,  type: "is-primary", environment: ["development", "staging", "production"], message: "動画サイト向け おすすめ", },
      { key: "is1920x1080", name: "1920x1080",      aspect_ratio: "16:9",   icon: "youtube", type: "is-danger", recommend: "◎", general_name: "FULL HD",     width: 1920, height: 1080,  type: "is-primary", environment: ["development", "staging", "production"], message: "動画サイト向け 高画質",   },
      { separator: true },
      ...
      { key: "is1024x768",  name: "1024x768",       aspect_ratio: "4:3",    icon: "rss",     type: "is-orange", recommend: "○", general_name: "XGA",         width: 1024, height:  768,  type: "is-primary", environment: ["development", "staging", "production"], message: "ブログ向け",            },
      { key: "is1280x960",  name: "1280x960",       aspect_ratio: "4:3",    icon: "rss",     type: "is-orange", recommend: "○", general_name: "Quad VGA",    width: 1280, height:  960,  type: "is-primary", environment: ["development", "staging", "production"], message: "ブログ向け",            },
      { key: "is1600x1200", name: "1600x1200",      aspect_ratio: "4:3",    icon: "rss",     type: "is-orange", recommend: "○", general_name: "UXGA",        width: 1600, height: 1200,  type: "is-primary", environment: ["development", "staging", "production"], message: "ブログ向け？",          },
      { separator: true },
