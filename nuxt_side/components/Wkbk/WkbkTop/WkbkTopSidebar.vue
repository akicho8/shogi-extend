    ...
    .mt-4
      b-menu
        b-menu-list(label="Action")
          //- b-menu-item.is_active_unset(tag="nuxt-link" :to="{name: 'rack-books-new'}" label="問題集作成" @click.native="sound_play('click')")
          b-menu-item.is_active_unset(tag="nuxt-link" :to="{name: 'rack-articles'}" label="問題リスト" @click.native="sound_play('click')")
