...
export class ParamInfo extends ParamBase {
  static get define() {
    return [
      ...
      { key: "appearance_theme_key",      type: "string",  name: "外観",                           defaults: { development: null, production: "is_appearance_theme_modern", }, permanent: true,  relation: "AppearanceThemeInfo",      input_attrs: null, desc: null, after_set: null, },
