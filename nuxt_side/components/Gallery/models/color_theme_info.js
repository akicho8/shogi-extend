...
export class ColorThemeInfo extends ApplicationMemoryRecord {
  ...
  static get define() {
    return [
      // // { key: "is_color_theme_groovy_board_texture1",  name: "木目1",             },
      // // { key: "is_color_theme_groovy_board_texture2",  name: "木目2",             },
      // { key: "is_color_theme_groovy_board_texture3",  name: "木目3",             },
      // // { key: "is_color_theme_groovy_board_texture4",  name: "木目4",             },
      // // { key: "is_color_theme_groovy_board_texture5",  name: "木目5",             },
      // // { key: "is_color_theme_groovy_board_texture6",  name: "木目6",             },
      // // { key: "is_color_theme_groovy_board_texture7",  name: "木目7",             },
      // { key: "is_color_theme_groovy_board_texture1",  name: "木目8",             },
      // // { key: "is_color_theme_groovy_board_texture9",  name: "木目9",             },
      // // { key: "is_color_theme_groovy_board_texture10",  name: "木目10",            },
      // // { key: "is_color_theme_groovy_board_texture11",  name: "木目11",            },
      // // { key: "is_color_theme_groovy_board_texture12",  name: "木目12",            },
      // { key: "is_color_theme_groovy_board_texture13",  name: "木目13",            },
      // // { key: "is_color_theme_groovy_board_texture14",  name: "木目14",            },
      // // { key: "is_color_theme_groovy_board_texture15",  name: "木目15",            },
      ...
      // { key: "is_color_theme_alpha_usubudou",   name: "薄葡萄 (うすぶどう)", },
