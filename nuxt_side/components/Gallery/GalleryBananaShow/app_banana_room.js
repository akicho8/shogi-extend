export const app_banana_room = {
  ...
  methods: {
    banana_room_create() {
      this.__assert__(this.ac_banana_room == null, "this.ac_banana_room == null")
      // alert(this.banana.id)
      this.ac_banana_room = this.ac_subscription_create({channel: "Gallery::BananaRoomChannel", banana_id: this.banana.id}, {
        connected: e => {
    ...
    ac_banana_room_perform(action, params = {}) {
      if (this.ac_banana_room) {
        this.ac_banana_room.perform(action, {
          ...
          ...params,
        }) // --> app/channels/gallery/banana_room_channel.rb
      }
    },
    ...
    gallery_banana_message_pong_singlecast(data) {
      this.debug_alert(`singlecast: ${data.pong}`)
    },

    gallery_banana_message_pong_broadcast(data) {
