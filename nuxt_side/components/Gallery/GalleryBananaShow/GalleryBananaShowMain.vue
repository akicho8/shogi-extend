<template lang="pug">
.GalleryBananaShowMain.columns.is-multiline.is-variable.is-0-mobile.is-4-tablet.is-5-desktop.is-6-widescreen.is-7-fullhd
  .column.is-12-tablet.is-10-desktop.is-8-widescreen
    ...
    .media
      ...
      .media-content
        ...
        GalleryTagList.mt-2(:tag_list="base.banana.tag_list" :tag_click_handle="base.tag_click_handle")
        .content.mt-1(v-if="base.banana.description")
          .description(v-html="base.message_decorate(base.banana.description)")

  .column
     GalleryBananaShowMessage(:base="base")
</template>
