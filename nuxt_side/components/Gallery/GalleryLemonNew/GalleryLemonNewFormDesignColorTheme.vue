<template lang="pug">
.GalleryLemonNewFormDesignColorTheme.field_block
  ...
  GalleryLemonNewImageUpload(:base="base" label="背景"           :file_info.sync="base.u_bg_file")
  GalleryLemonNewImageUpload(:base="base" label="盤面テクスチャ" :file_info.sync="base.u_fg_file")
  GalleryLemonNewImageUpload(:base="base" label="駒テクスチャ"   :file_info.sync="base.u_pt_file")
</template>
...
export default {
  name: "GalleryLemonNewFormDesignColorTheme",
  mixins: [support_child],
}
</script>

<style lang="sass">
.GalleryLemonNewFormDesignColorTheme
  // 上下の不自然な隙間を取る
  .dropdown-content
    padding-top: 0
    padding-bottom: 0
