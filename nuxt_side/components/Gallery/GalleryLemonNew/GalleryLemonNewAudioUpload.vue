<template lang="pug">
.GalleryLemonNewAudioUpload(v-if="base.audio_theme_info.key === 'is_audio_theme_custom'")
  b-field
  ...
  .audio_preview(v-if="new_file_info")
    GalleryLemonNewAudioPlay(:base="base" :src="new_file_info.url" :volume="base.main_volume" @play="e => base.current_play_instance = e")
...
export default {
  name: "GalleryLemonNewAudioUpload",
