<template lang="pug">
.GalleryLemonNewFormDesignAudioTheme.field_block
      ...
      b-dropdown(v-model="base.audio_theme_key" @active-change="base.active_change_handle")
        ...
        template(v-for="e in base.AudioThemeInfo.values")
          template(v-if="e.environment == null || e.environment.includes($config.STAGE)")
            ...
            template(v-else)
              b-dropdown-item(:value="e.key" @click="sound_play_click()")
                .media
                  .media-left(v-if="e.sample_source")
                    GalleryLemonNewAudioPlay(:base="base" :src="e.sample_source" :volume="base.main_volume" @play="e => base.current_play_instance = e")
                  .media-content
                    | {{e.name}}
  ...
  GalleryLemonNewAudioUpload(:base="base" label="序盤" :file_info.sync="base.u_audio_file_a")
  GalleryLemonNewAudioUpload(:base="base" label="中盤" :file_info.sync="base.u_audio_file_b")
  ...
  //-     .media-left
  //-       GalleryLemonNewAudioPlay(:base="base" :src="file.url" @play="e => base.current_play_instance = e" v-if="file.url")
  //-     .media-content
...
export default {
  name: "GalleryLemonNewFormDesignAudioTheme",
  mixins: [support_child],
}
</script>

<style lang="sass">
.GalleryLemonNewFormDesignAudioTheme
  .dropdown-item
