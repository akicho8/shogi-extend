...
export const app_form = {
  ...
  methods: {
    ...
    body_focus() {
      ...
      // this.desktop_focus_to(this.$refs.GalleryLemonNewForm?.$refs.body.$refs?.textarea)
    },
    reset_handle() {
    ...
    submit_handle() {
      ...
      this.$axios.$post("/api/gallery/lemons/record_create.json", this.post_params).then(e => {
        // ../../../../app/controllers/api/gallery/lemons_controller.rb
        if (e.bs_error) {
