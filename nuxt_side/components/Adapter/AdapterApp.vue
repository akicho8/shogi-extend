      ...
      .columns.is-centered
        .column.MainColumn
          b-field(:type="input_text_field_type")
            b-input(type="textarea" ref="input_text" v-model.trim="input_text" expanded rows="8" placeholder="KIF KI2 CSA SFEN BOD の本体かURL。共有将棋盤・ぴよ将棋・KENTO・将棋DB2のように棋譜をパラメータに含むURL。棋譜URLをコンテンツに含むサイトURL。戦法名・囲い名などを入力してください")
