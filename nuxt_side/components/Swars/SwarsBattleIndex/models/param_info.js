...
export class ParamInfo extends ParamBase {
  static get define() {
    return [
      ...
      { key: "complement_user_keys_prepend_key", type: "string",  name: "入力履歴に取り込む種類", defaults: { development: null, production: "user_key",                }, permanent: false, relation: "ComplementUserKeysPrependInfo", desc: null, },
