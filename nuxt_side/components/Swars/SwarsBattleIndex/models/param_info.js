...
const visible_hash_default = Gs.as_visible_hash(ColumnInfo.values)
console.log(visible_hash_default)
...
export class ParamInfo extends ParamBase {
  static get define() {
    return [
      ...
      { key: "visible_hash",          type: "hash",    name: "カラム表示",           defaults: { development: null, production: visible_hash_default, }, permanent: true,  relation: null,          desc: null, },
    ]
  }
}
