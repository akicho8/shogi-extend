...
export class PerInfo extends ApplicationMemoryRecord {
  ...
  static get define() {
    return [
      ...
      { key: "is_per10",  name: "10 (おすすめ)",   per:  10, available_env: { development: true, staging: true,  production: true,  }, },
      ...
      { key: "is_per200", name: "200 (激重注意)",  per: 200, available_env: { development: true, staging: true,  production: true,  }, },
    ]
  }
