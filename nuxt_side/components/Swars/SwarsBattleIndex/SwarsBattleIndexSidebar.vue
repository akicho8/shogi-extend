    ...
    .mt-4
      b-menu
        b-menu-list(label="Action")
          b-menu-item.is_active_unset.swars_users_key_handle(tag="nuxt-link" :to="{name: 'swars-users-key', params: {key: APP.xi.current_swars_user_key}, query: {query: APP.user_stat_query}}" @click.native="$sound.play_click()" label="プレイヤー情報" :disabled="menu_item_disabled")
        ...
        b-menu-list(label="まとめて取得")
          b-menu-item.is_active_unset.swars_direct_download_handle(
            ...
            tag="nuxt-link"
            :to="{name: 'swars-direct-download', query: APP.current_route_query}"
