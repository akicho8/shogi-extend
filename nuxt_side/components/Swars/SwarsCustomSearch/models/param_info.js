...
export class ParamInfo extends ParamBase {
  static get define() {
    return [
      ...
      { key: "my_think_max_enabled",     type: "boolean", name: "最大思考有効",       defaults: { development: null, production: false,  }, permanent: true, relation: null, desc: null, },
      { key: "my_think_max",             type: "integer", name: "最大思考",           defaults: { development: null, production: 4*60,   }, permanent: true, relation: null, desc: null, },
      { key: "my_think_max_compare",     type: "string",  name: "最大思考演算子",     defaults: { development: null, production: "gteq", }, permanent: true, relation: null, desc: null, },

      { key: "my_think_avg_enabled",     type: "boolean", name: "平均思考有効",       defaults: { development: null, production: false,  }, permanent: true, relation: null, desc: null, },
      { key: "my_think_avg",             type: "integer", name: "平均思考",           defaults: { development: null, production: 10,     }, permanent: true, relation: null, desc: null, },
      { key: "my_think_avg_compare",     type: "string",  name: "平均思考演算子",     defaults: { development: null, production: "gteq", }, permanent: true, relation: null, desc: null, },
