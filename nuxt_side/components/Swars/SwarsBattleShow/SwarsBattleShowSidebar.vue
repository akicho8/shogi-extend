    ...
    .mt-4
      b-menu
        ...
        ShareBoardSidebarExport(:base="base")
          ...
          b-menu-item.is_active_unset(label="動画変換" tag="nuxt-link" :to="{name: 'video-new', query: {body: base.record.sfen_body, viewpoint_key: base.new_viewpoint}}" @click.native="sound_play_click()")
