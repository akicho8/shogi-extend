    ...
    .mt-4
      b-menu
        b-menu-list(label="Action")
          ...
          b-menu-item.is_active_unset.is-hidden-mobile(:label="`局面ペディア #${base.current_turn}`" :href="base.kpedia_url" :target="target_default" @click="base.other_app_click_handle('局面ペディア')")
