import { V1Operation } from "@/components/ShareBoard/mod_order/order_flow/v1_operation.js"
import { Item } from "@/components/ShareBoard/mod_order/order_flow/item.js"
import { Location } from "shogi-player/components/models/location.js"

describe("V1Operation", () => {
  test("swap_run", () => {
    const object = new V1Operation(["a", "b", "c"].map(e => Item.create(e)))
    object.swap_run()
  ...
  test("real_order_users_to_s", () => {
    const object = new V1Operation([Item.create("a"), Item.create("b"), Item.create("c")])
