...
gem "nokogiri", ">= 1.19.1" # 「force_ruby_platform: true」を指定してない理由は nokogiri だけじゃないから。bigdecimal なども native build しないといけないので capistrano 側で全体適用している。
...
# activesupport に require "benchmark" が含まれなくなったため
gem "benchmark"
