  ...
  ja: {
    ...
    errors: {
      ...
      messages: {
        ...
        greater_than: "は%{count}より大きい値にしよう",
        greater_than_or_equal_to: "は%{count}以上の値にしよう",
        equal_to: "は%{count}にしよう",
        less_than: "は%{count}より小さい値にしよう",
        less_than_or_equal_to: "は%{count}以下の値にしよう",
        odd: "は奇数にしよう",
        even: "は偶数にしよう",
