...
# every("30 5 * * *")   { runner "Swars::Battle.import(:reception_import, sleep: 5, limit: 10, page_max: 1)"                                       }
...
# every("0 3 * * *")    { runner "Swars::Battle.import(:remake)"                                                                                   }
every("30 4 * * *")   { runner "Swars::Battle.import(:old_record_destroy)"                                                                       }
# every("0 */3 * * *")  { runner "GeneralBattle.import(:all_import, sample: 100)"                                                                }
# every("0 6 * * *")    { runner "GeneralBattle.import(:old_record_destroy)"                                                                     }
