...
Rails.application.configure do
  ...
  # /usr/local/var/rbenv/versions/3.4.8/lib/ruby/gems/3.2.0/gems/spring-4.1.1/lib/spring/application.rb:100:in `block in preload': Spring reloads, and therefore needs the application to have reloading enabled.
