<template lang="pug">
MainNavbar.WbookQuestionEditNavbar(:spaced="false")
  template(slot="brand")
  ...
  template(slot="start")
    ...
    template(v-else)
      b-navbar-item(tag="div") {{base.question.new_record_p ? '新規' : '編集'}}
  template(slot="end")
