<template lang="pug">
.WbookHistoryRow.is-flex(@click="base.ov_question_info_set(row.question.id)")
  .left_block.is-flex
    ...
    .question_block.is-flex
      ...
      .bottom_block.is-flex
        WbookHistoryRowVote(:base="base" :row="row")
</template>
...
export default {
  ...
  computed: {
    board_image_url() {
      // return "/share-board.png?body=position+sfen+ln1g1g1nl%2F1ks2r3%2F1pppp1bpp%2Fp3spp2%2F9%2FP1P1SP1PP%2F1P1PP1P2%2F1BK1GR3%2FLNSG3NL+b+-+1&turn=0&title=%E3%83%AA%E3%83%AC%E3%83%BC%E5%B0%86%E6%A3%8B&image_viewpoint=black&image_preset=small"
      const params = {
        format: "png",
