export const application_matching = {
  ...
  methods: {
    ...
    matching_search() {
      ...
      }) // --> base/channels/wbook/lobby_channel.rb (matching_search)
    },
    ...
    room_broadcasted(params) {
      ...
      const membership = params.room.memberships.find(e => e.user.wbook_setting.session_lock_token === this.current_user.session_lock_token)
      if (membership) {
