...
.WbookBattleApp
  ...
  WbookRoomEmotion(:base="base")

  template(v-if="base.current_strategy_key === 'sy_versus'")
    WbookBattleQuestionSyVersus(:base="base")
  ...
  template(v-if="base.current_strategy_key === 'sy_marathon' || base.current_strategy_key === 'sy_singleton' || base.current_strategy_key === 'sy_hybrid'")
    .vs_container.is-flex
      template(v-for="(membership, i) in base.ordered_memberships")
        WbookBattleMembership(:base="base" :membership="membership" :key="membership.id")
    ...
    template(v-if="base.sub_mode === 'sm4_tactic' || base.sub_mode === 'sm5_correct'")
      WbookQuestionAuthor(:question="base.current_question" :title_display_p="false")
      WbookBattleQuestionSyMarathon(:base="base" v-if="base.current_strategy_key === 'sy_marathon' || base.current_strategy_key === 'sy_hybrid'")
      WbookBattleQuestionSySingleton(:base="base" v-if="base.current_strategy_key === 'sy_singleton'")
      WbookRoomMessage(:base="base")
