<template lang="pug">
.WbookBattleQuestionSyVersus
  WbookBattleQuestionSyVersusMembership.mt-3(:membership="base.opponent_membership")
  ...
  WbookBattleQuestionSyVersusMembership.mt-3(:membership="base.current_membership")
...
export default {
  name: "WbookBattleQuestionSyVersus",
  mixins: [
    support_child,
  ],
