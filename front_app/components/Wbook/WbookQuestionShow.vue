<template lang="pug">
.WbookApp.WbookQuestionShow.modal-card
  .modal-card-body.box
    ...
    .vote_container.is-flex.mt-4
      WbookHistoryRowVote(:base="base" :row="new_ov_question_info")
    ...
    WbookQuestionShowMessage.mt-6(:base="base" :question="question")
</template>
