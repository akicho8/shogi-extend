export const application_new_challenge = {
  ...
  methods: {
    ...
    async new_challenge_accept_handle(params) {
      ...
      }) // --> base/models/frontend_script/wbook_app_script/put_api.rb
    },
    ...
    new_challenge_message(params) {
      ...
      // base/javascript/WbookApp/application.sass で別定義あり
      return `<div class="WbookApp new_challenge_message is-flex">
               ${figure}${message}
              </div>`
    },
  }
