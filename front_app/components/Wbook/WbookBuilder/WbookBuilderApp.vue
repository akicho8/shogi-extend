<template lang="pug">
.WbookBuilderApp
  WbookBuilderIndex(:base="base" :bapp="bapp" v-if="!question")
  WbookBuilderEdit(:base="base" :bapp="bapp" v-if="question" ref="WbookBuilderEdit")
...
export default {
  ...
  methods: {
    ...
    // FIXME: イベントで受けとる
    current_moves() {
      return this.$refs.WbookBuilderEdit.$refs.WbookBuilderEditSeikai.$refs.main_sp.sp_object().moves_take_turn_offset
    },
