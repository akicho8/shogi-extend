...
.WbookBuilderEdit
  ...
  ////////////////////////////////////////////////////////////////////////////////
  WbookBuilderEditHaiti(:base="base" :bapp="bapp"  v-if="bapp.current_tab_info.key === 'haiti_mode'")
  WbookBuilderEditSeikai(:base="base" :bapp="bapp" v-if="bapp.current_tab_info.key === 'seikai_mode'" ref="WbookBuilderEditSeikai")
  WbookBuilderEditForm(:base="base" :bapp="bapp"   v-if="bapp.current_tab_info.key === 'form_mode'")
  WbookBuilderEditKensho(:base="base" :bapp="bapp" v-if="bapp.current_tab_info.key === 'kensho_mode'")
</template>
