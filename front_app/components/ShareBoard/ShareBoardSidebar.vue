    ...
    .mt-4
      b-menu
        b-menu-list(label="リアルタイム共有")
          ...
          b-menu-item.is_active_unset(label="自分の盤を全員に反映"          @click="base.force_sync_modal_handle"   :disabled="!base.connectable_p")
          b-menu-item.is_active_unset(label="再接続 (なんかおかしいとき用)" @click="base.room_recreate_modal_handle"  :disabled="!base.connectable_p")
