  ...
  .content
      ...
      .article_body
        ...
        ol.mt-2
          ...
          li
            ...
            span.is-size-7
              | このとき「部屋のリンク」を伝えるのをおすすめする<br>
              | 伝えられた側は合言葉を入力する手間を省略できる
          li みんなが来るのを待つ
          li 必要であれば「手合割」をする
          li 「順番設定」
          li 「時計設定」
          li ニワトリが鳴いたら手番の人から指していく
    ...
    article
      ...
      .article_body
        ...
        p
          | 棋譜はすべてURLに含まれるので、指名されていない人がイタズラの意図で盤を動かしても、指名された人が指す局面には何も影響がない
    ...
    article
      ...
      .article_body
        ul
          li 「初期配置に戻す」
        p
          | 初手を指す人がｺﾝﾄﾛｰﾗｰの左ボタンで0手目に戻すのとほぼ同じ
