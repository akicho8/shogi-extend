...
.ShareBoardHelpBody
  ...
  .content
    article
      ...
      .article_body
        ...
        ol.mt-2
          ...
          li この対局に参加していないメンバーに棋譜を見せたいときは「棋譜だけを含むリンクのコピー」をタップして渡す
    ...
    article
      ...
      .article_body
        ul
          li 指し手を正確に転送するための機能で、自家が下家に局面を転送したあと下家から自家に応答がないと再送ダイアログを表示する
          li 通信不調などで自家は指したつもりになっているが下家は受け取っていない状況を防ぐ
          li 順番設定しているときだけ動作する
