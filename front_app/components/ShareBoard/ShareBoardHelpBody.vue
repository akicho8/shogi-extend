      ...
      .article_body
        ...
        ol.mt-2
          ...
          li
            | みんなが来るのを待つ
            ul.is-size-7.mt-1
              li 待ってる間に「手合割」や「時計設定」をしてもいい
          li 必要であれば「手合割」をする (だいたいしない)
          li
            | 「順番設定」
            ul.is-size-7.mt-1
              li 有効にした時点で居るメンバー全員参加になる
              li 棋力が偏ってたらシャッフルや「↓」「↑」で調整する
              li 観戦しに来ただけって言う人がいたら「OK」を「観戦」に変更する
              li 奇数人でやってもいいけど1周する度に先後がずれるので注意
          li
            | 「時計設定」の
        ...
        ol.mt-2
          ...
          li
            | 対局に参加していないメンバーに棋譜を見せたいときは「棋譜だけを含むリンクのコピー」をタップしてチャットアプリ等に貼る
            .is-size-7
