<template lang="pug">
b-sidebar.GifConvSidebar.is-unselectable(fullheight right v-model="base.sidebar_p")
  .mx-4.my-4
    ...
    .mt-4
      b-menu
        ...
        b-menu-list(label="ANOTHER")
          b-menu-item.is_active_unset(label="対応フォーマットの確認" tag="nuxt-link" :to="{name: 'gif_conv-description'}" @click.native="sound_play('click')")
</template>
