<template lang="pug">
b-sidebar.WkbkQuestionIndexSidebar.is-unselectable(fullheight right overlay v-model="base.sidebar_p")
  .mx-4.my-4
    ...
    .mt-4
      b-menu
        b-menu-list(label="Action")
          b-menu-item(tag="nuxt-link" :to="{name: 'wkbk-questions-new'}" label="問題作成" @click.native="sound_play('click')")
