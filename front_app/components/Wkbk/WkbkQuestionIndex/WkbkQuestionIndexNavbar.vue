<template lang="pug">
MainNavbar.WkbkQuestionIndexNavbar(:spaced="false")
  template(slot="brand")
    NavbarItemHome
    b-navbar-item.has-text-weight-bold(tag="nuxt-link" :to="{name: 'wkbk-questions'}") 問題一覧
  ...
  template(slot="end")
    ...
    b-navbar-item.has-text-weight-bold.px-5(tag="nuxt-link" :to="{name: 'wkbk-questions-new'}" @click.native="sound_play('click')")
      b-icon(icon="plus")
