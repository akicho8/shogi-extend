...
b-table.WkbkTopTable(
  ...
  b-table-column(v-slot="{row}" custom-key="key" field="key" :label="base.BookIndexColumnInfo.fetch('key').name"               sortable numeric :width="0" :visible="!!base.visible_hash.key") {{row.key}}
