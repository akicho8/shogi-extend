<template lang="pug">
.WkbkBookEditPlacement.columns.is-gapless.is-centered
  .column
...
export default {
  ...
  created() {
    ...
    this.sp_body = this.base.book.init_sfen
  ...
  methods: {
    ...
    kifu_copy_handle() {
      this.sound_play("click")
      this.general_kifu_copy(this.base.book.init_sfen, {to_format: "kif"})
    },
  ...
  computed: {
    piyo_shogi_app_with_params_url() { return this.piyo_shogi_auto_url({sfen: this.base.book.init_sfen, turn: 0, viewpoint: "black"}) },
    kento_app_with_params_url()      { return this.kento_full_url({sfen: this.base.book.init_sfen, turn: 0, viewpoint: "black"}) },
  },
}
</script>
