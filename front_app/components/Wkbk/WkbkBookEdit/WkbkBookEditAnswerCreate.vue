<template lang="pug">
.WkbkBookEditAnswerCreate.columns.is-gapless.is-centered
  .column.LeftColumn
  ...
  .column.RightColumn
    b-tabs(v-model="base.answer_tab_index" position="is-centered" :vertical="false" :expanded="true" :animated="false" v-if="base.book.moves_answers.length >= 1" @input="sound_play('click')")
      template(v-for="(e, i) in base.book.moves_answers")
