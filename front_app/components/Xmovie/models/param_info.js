...
export class ParamInfo extends MemoryRecord {
  static get define() {
    return [
      ...
      { key: "animation_size_key", type: "string",  name: "サイズ",             default: "is1024x768",                      permanent: true,  relation: "AnimationSizeInfo", desc: "", },
      ...
      { key: "color_theme_key",    type: "string",  name: "配色",               default: "first_light_theme",               permanent: true,  relation: "ColorThemeInfo",    desc: "", },
