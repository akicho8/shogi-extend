...
export class AnimationSizeInfo extends MemoryRecord {
  ...
  static get define() {
    return [
      ...
      { key: "is320x240",   name: "320x240",        aspect_ratio: "4:3",    recommend: "×", general_name: "Quarter VGA", width:  320, height:  240,  type: "is-primary", environment: ["development", "staging",             ], message: "フォント呆け",          },
      { key: "is640x480",   name: "640x480",        aspect_ratio: "4:3",    recommend: "△", general_name: "VGA",         width:  640, height:  480,  type: "is-primary", environment: ["development", "staging",             ], message: null,                    },
