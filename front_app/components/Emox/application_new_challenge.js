export const application_new_challenge = {
  ...
  methods: {
    ...
    async new_challenge_accept_handle(params) {
      ...
      }) // --> app/models/frontend_script/emox_app_script/put_api.rb
    },
    ...
    new_challenge_message(params) {
      ...
      // app/javascript/EmoxApp/application.sass で別定義あり
      return `<div class="EmoxApp new_challenge_message is-flex">
               ${figure}${message}
              </div>`
    },
  }
