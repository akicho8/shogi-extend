...
export default {
  ...
  methods: {
    ...
    question_subscribe() {
      ...
      this.$ac_question = this.ac_subscription_create({channel: "Emox::QuestionChannel", question_id: this.new_question.id})
    },
    ////////////////////////////////////////////////////////////////////////////////
    speak_init() {
      this.message_body = ""
    ...
    speak(message_body) {
      this.$ac_question.perform("speak", {message_body: message_body}) // --> app/channels/emox/question_channel.rb
    },
