        ...
        .mx-4.my-4
          b-menu
            b-menu-list(label="Action")
              b-menu-item(label="問題作成"               tag="nuxt-link" :to="{name: 'rack-articles-new', query: {body: record.sfen_body, turn: new_turn, viewpoint: new_viewpoint}}" @click.native="sound_play('click')")
