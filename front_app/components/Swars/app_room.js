export const app_room = {
  ...
  methods: {
    ...
    room_setup(options = {}) {
      ...
      this.$ac_room = this.ac_subscription_create({channel: "SwarsSearch::RoomChannel", room_code: this.room_code}, {
        connected: () => {
    ...
    ac_room_perform(action, params = {}) {
      ...
      if (this.$ac_room) {
        this.$ac_room.perform(action, params) // --> app/channels/swars_search/room_channel.rb
      }
    },
    ...
    sfen_share(sfen) {
      ...
      }) // --> app/channels/swars_search/room_channel.rb
    },
