<template lang="pug">
.SwarsUserShowTabContent3VsAttack.tab_content(v-if="base.tab_index === 3")
  template(v-for="(row, i) in base.info.every_vs_attack_list")
...
export default {
  name: "SwarsUserShowTabContent3VsAttack",
