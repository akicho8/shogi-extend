  ...
  .section
    .container
      ...
      b-notification(:closable="false")
        ...
        | <br><br>
        | たとえば、3分切れ負けをいきなり100局やったあと検索しても最後の10局分しか取り込んでないので残り90局は表示されません。
        | 最初に対局した90局のなかに検討したかった対局がある場合は困るでしょう。
        | <br><br>
        | そんなときに下の<b>棋譜取得の予約</b>をすると残りの90局を取ってきます。深夜に古い棋譜(※最大直近1ヶ月分)を探しに行きます。
