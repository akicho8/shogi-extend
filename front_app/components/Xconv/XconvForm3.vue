...
.XconvForm3
  ...
  b-field.one_block.animation_size_field(label="サイズプリセット" :message="[base.animation_size_info.message]")
    .control
  ...
  b-field.one_block.video_width_height(label="サイズ" :type="{'is-danger': base.i_size_danger_p}" :message="[base.i_size_aspect_ratio_human]" v-if="base.animation_size_info.key === 'is_custom'")
    b-input(required type="number" v-model.number="base.i_width"  :min="0" :max="development_p ? 3200 : 1600" :step="1" expanded placeholder="width" )
    b-input(required type="number" v-model.number="base.i_height" :min="0" :max="development_p ? 3200 : 1200" :step="1" expanded placeholder="height")
