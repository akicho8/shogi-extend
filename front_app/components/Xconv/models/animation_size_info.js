...
export class AnimationSizeInfo extends MemoryRecord {
  ...
  static get define() {
    return [
      ...
      { key: "is640x480",   name: "640x480",        aspect_ratio: "4:3",    recommend: "△", general_name: "VGA",         width:  640, height: 480,   type: "is-primary", environment: ["development", "staging", "production"], message: "ボケている気がする",   },
      ...
      { key: "is1600x1200", name: "1600x1200",      aspect_ratio: "4:3",    recommend: "△", general_name: "UXGA",        width: 1600, height: 1200,  type: "is-primary", environment: ["development", "staging", "production"], message: "無駄にでかいので時間がかかる",       },
