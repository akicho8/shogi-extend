...
export class AnimationSizeInfo extends MemoryRecord {
  ...
  static get define() {
    return [
      ...
      { key: "is1200x630",  name: "1200x630",       aspect_ratio: "1.91:1", recommend: "画", general_name: "OGP",         width: 1200, height: 630,   type: "is-primary", message: "OGP画像サイズと合わせたいとき用", },
      ...
      { key: "is_custom",   name: "ユーザー指定",   aspect_ratio: null,     recommend: null, general_name: null,          width:  null, height: null, type: "is-primary", message: null, },
