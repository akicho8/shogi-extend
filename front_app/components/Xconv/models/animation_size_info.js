...
export class AnimationSizeInfo extends MemoryRecord {
  ...
  static get define() {
    return [
      ...
      { key: "is320x240",   name: "320x240",        aspect_ratio: "4:3",    recommend: "×", general_name: "Quarter VGA", width:  320, height: 240,   type: "is-primary", environment: ["development", "staging",             ], message: "フォントがボケる", },
      { key: "is640x480",   name: "640x480",        aspect_ratio: "4:3",    recommend: "△", general_name: "VGA",         width:  640, height: 480,   type: "is-primary", environment: ["development", "staging",             ], message: "ボケている気がする",   },
      ...
      { key: "is1280x720",  name: "1280x720",       aspect_ratio: "16:9",   recommend: "○", general_name: "HD",          width: 1280, height: 720,   type: "is-primary", environment: ["development", "staging", "production"], message: "横長",   },
      { key: "is1600x1200", name: "1600x1200",      aspect_ratio: "4:3",    recommend: "△", general_name: "UXGA",        width: 1600, height: 1200,  type: "is-primary", environment: ["development", "staging", "production"], message: "無駄にでかい",       },
