...
export class AnimationSizeInfo extends MemoryRecord {
  ...
  static get define() {
    return [
      ...
      { key: "is320x240",   name: "320x240", aspect_ratio: "4:3",    recommend: "×", general_name: "Quarter VGA", width:  320, height: 240,  type: "is-primary", message: "小さすぎてボケる", },
      { key: "is640x480",   name: "640x480", aspect_ratio: "4:3",    recommend: "△", general_name: "VGA",         width:  640, height: 480,  type: "is-primary", message: null,   },
      { key: "is720x540",   name: "720x540", aspect_ratio: "4:3",    recommend: "？", general_name: "",            width:  720, height: 540,  type: "is-primary", message: "短い方が720以下ならエンコードされないらしい説あり", },
      ...
      { key: "is1200x630",  name: "1200x630", aspect_ratio: "1.91:1",   recommend: "△", general_name: "",            width: 1200, height: 630,  type: "is-primary", message: "無駄に横長になるのでおすすめしないがOGP画像の推奨サイズと合わせたいときに有用", },
      { key: "is1280x960",  name: "1280x960", aspect_ratio: "16:9",   recommend: "◎", general_name: "Quad VGA",    width: 1280, height: 960,  type: "is-primary", message: null,   },
      { key: "is1280x720",  name: "1280x720", aspect_ratio: "4:3",   recommend: "○", general_name: "HD",          width: 1280, height: 720,  type: "is-primary", message: "推奨と書いているサイトもある",   },
