...
export class XoutFormatInfo extends MemoryRecord {
  ...
  static get define() {
    return [
      ...
      { key: "is_format_webp",            name: "WebP",              real_ext: "webp", respond_html_tag: "image", environment: ["development", "staging", "production"], type: "is-primary", message: "×Twitter",                                               },
      { key: "is_format_apng",            name: "APNG",              real_ext: "apng", respond_html_tag: "image", environment: ["development", "staging", "production"], type: "is-primary", message: "×Twitter",                                               },
      { key: "is_format_png",             name: "PNG",               real_ext: "png",  respond_html_tag: "image", environment: ["development", "staging", "production"], type: "is-primary", message: "最後の局面の画像",                                        },
      ...
      { key: "is_format_mp4_yuv444p10le", name: "MP4 (yuv444p10le)", real_ext: "mp4",  respond_html_tag: "video", environment: ["development"],                          type: "is-primary", message: "PC(WEB)から投稿できない。モバイルアプリからは投稿できる", },
