...
export class XoutFormatInfo extends MemoryRecord {
  ...
  static get define() {
    return [
      ...
      { key: "is_format_mp4_twitter",     name: "MP4",               real_ext: "mp4",  respond_html_tag: "video", type: "is-primary", message: "◎Twitter ○画質 ◎シーク",                               development_only: false, },
      { key: "is_format_gif",             name: "GIF",               real_ext: "gif",  respond_html_tag: "image", type: "is-primary", message: "◎Twitter ◎画質 ×シーク",                               development_only: false, },
