...
export class XmatchRuleInfo extends MemoryRecord {
  static get define() {
    return [
      ...
      { key: "rule_1vs1_05_00_00_5",         members_count_max: 2, name: "1 vs 1",       rule_desc: "5分+10秒",      handicap_preset_key: "平手",       cc_params: { initial_main_min:  5, initial_read_sec: 0, initial_extra_sec: 0, every_plus: 10, }, stage_only: ["development", "staging", "production"], },
      ...
      { key: "rule_self_05_00_00_5",         members_count_max: 1, name: "対自分",       rule_desc: "5分+10秒",      handicap_preset_key: "平手",       cc_params: { initial_main_min:  5, initial_read_sec:  0, initial_extra_sec:  0, every_plus: 10, }, stage_only: ["development", "staging", "production"], },
      { key: "rule_2vs2_05_00_00_5_pRvsB",   members_count_max: 4, name: "飛 vs 角",     rule_desc: "5分+10秒",      handicap_preset_key: "飛vs角",   cc_params: { initial_main_min:  5, initial_read_sec:  0, initial_extra_sec:  0, every_plus: 10, }, stage_only: ["development", "staging", "production"], },
