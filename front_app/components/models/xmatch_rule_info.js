...
export class XmatchRuleInfo extends MemoryRecord {
  static get define() {
    return [
      ...
      { key: "rule_1vs1_10_15_00_0",         members_count_max: 2, name: "10分",       rule_desc: "10分 秒読み15秒",     handicap_preset_key: "平手",       cc_params: { initial_main_min: 10, initial_read_sec: 15, initial_extra_sec: 0, every_plus: 0, }, stage_only: ["development", "staging", "production"], },
      { key: "rule_1vs1_03_10_00_0",         members_count_max: 2, name: "3分",        rule_desc: "3分 秒読み10秒",      handicap_preset_key: "平手",       cc_params: { initial_main_min:  3, initial_read_sec: 10, initial_extra_sec: 0, every_plus: 0, }, stage_only: ["development", "staging", "production"], },
      { key: "rule_1vs1_00_10_60_0",         members_count_max: 2, name: "10秒",       rule_desc: "秒読み10秒 猶予60秒", handicap_preset_key: "平手",       cc_params: { initial_main_min:  0, initial_read_sec: 10, initial_extra_sec: 60, every_plus: 0, }, stage_only: ["development", "staging", "production"], },
