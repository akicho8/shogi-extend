...
export class XmatchRuleInfo extends MemoryRecord {
  static get define() {
    return [
      ...
      { key: "rule_1vs1_0_10_60_0_pRvsB",    name: "1 vs 1 (飛車vs角)", rule_desc: "1手10秒 猶予60秒", members_count_max: 2, handicap_preset_key: "飛車vs角",   cc_params: { initial_main_min:  0, initial_read_sec:  0, initial_extra_sec:  0, every_plus: 0, }, stage_only: ["development", "staging", "production"], },
      { key: "rule_self_0_03_60_0",          name: "自分 vs 自分",      rule_desc: "3分",              members_count_max: 1, handicap_preset_key: "平手",       cc_params: { initial_main_min:  3, initial_read_sec:  0, initial_extra_sec:  0, every_plus: 0, }, stage_only: ["development", "staging", "production"], },
