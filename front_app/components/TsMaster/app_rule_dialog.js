const DIALOG_MESSAGE = `
 <div class="content is-size-7">
   <ul>
     <li>規定の正解数に達っするまでの時間を競います</li>
     <li>正解の判定とかないので合ってると思ったら次に進んでください</li>
...
const TALK_MESSAGE = `
規定の正解数に達っするまでの時間を競います
正解の判定とかないので合ってると思ったら次に進んでください
...
問題はすべてやねうら王公式クリスマスプレゼント詰将棋500万問から出題しています
`
