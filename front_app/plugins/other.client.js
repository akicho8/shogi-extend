...
Chart.defaults.global.elements.line.backgroundColor  = function(context) { return color_select(context, 0.1) }
Chart.defaults.global.elements.line.borderColor      = function(context) { return color_select(context, 0.6) }
