...
ActiveRecord::Schema.define(version: 2021_08_26_132700) do
  ...
  create_table "xmov_records", charset: "utf8mb4", collation: "utf8mb4_bin", force: :cascade do |t|
    t.bigint "user_id", null: false, comment: "対局者"
    t.string "recordable_type", null: false
    t.bigint "recordable_id", null: false, comment: "対象レコード"
    t.text "convert_params", null: false, comment: "変換パラメータ"
    ...
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["created_at"], name: "index_xmov_records_on_created_at"
    t.index ["errored_at"], name: "index_xmov_records_on_errored_at"
    t.index ["process_begin_at"], name: "index_xmov_records_on_process_begin_at"
    t.index ["process_end_at"], name: "index_xmov_records_on_process_end_at"
    t.index ["recordable_type", "recordable_id"], name: "index_xmov_records_on_recordable_type_and_recordable_id"
    t.index ["successed_at"], name: "index_xmov_records_on_successed_at"
    t.index ["user_id"], name: "index_xmov_records_on_user_id"
  end
