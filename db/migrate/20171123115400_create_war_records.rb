...
class CreateWarRecords < ActiveRecord::Migration[5.1]
  def up
    create_table :war_users, force: true do |t|
      t.string :unique_key, null: false
      t.string :user_key, null: false
      t.belongs_to :war_rank
      t.timestamps null: false
    end

    create_table :war_records, force: true do |t|
      t.string :unique_key, null: false
    ...
    create_table :war_ships, force: true do |t|
      t.belongs_to :war_record
      t.belongs_to :war_user
      t.belongs_to :war_rank # そのときの段位
      t.boolean :win_flag, null: false
      t.integer :position
      t.timestamps null: false
    end

    create_table :war_ranks, force: true do |t|
      t.string :unique_key, null: false
