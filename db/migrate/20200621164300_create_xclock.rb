class CreateXclock < ActiveRecord::Migration[6.0]
  def change
    DbCop.foreign_key_checks_disable do
      ################################################################################ 静的

      # フォルダ
      create_table :xclock_folders, force: true do |t|
      ...
      # 問題の種類
      create_table :xclock_lineages, force: true do |t|
      ...
      # static
      create_table :xclock_ox_marks, force: true do |t|
      ...
      # 勝ち負け
      create_table :xclock_judges, force: true do |t|
        t.string :key, null: false
        t.integer :position, null: false, index: true
        t.timestamps
      end
      ...
      # ルール
      create_table :xclock_rules, force: true do |t|
        t.string :key, null: false
        t.integer :position, null: false, index: true
        t.timestamps
      end
      ...
      # 結果
      create_table :xclock_finals, force: true do |t|
        t.string :key, null: false
        t.integer :position, null: false, index: true
        t.timestamps
      end
      ...
      # ウデマエ
      create_table :xclock_skills, force: true do |t|
        t.string :key, null: false
        t.integer :position, null: false, index: true
        t.timestamps
      end
      ...
      create_table :xclock_rooms, force: true do |t|
        t.datetime :begin_at,     null: false, index: true, comment: "対戦開始日時"
        t.datetime :end_at,       null: true,  index: true, comment: "対戦終了日時"
        t.belongs_to :rule, foreign_key: {to_table: :xclock_rules}, null: false,              comment: "ルール"
        t.timestamps
        t.integer :battles_count, null: false, index: true, default: 0, comment: "連戦数"
      end

      create_table :xclock_room_memberships, force: true do |t|
        t.belongs_to :room, foreign_key: {to_table: :xclock_rooms},  null: false,              comment: "対戦部屋"
      ...
      create_table :xclock_battles, force: true do |t|
        t.belongs_to :room,   foreign_key: {to_table: :xclock_rooms},      null: false,               comment: "部屋"
        t.belongs_to :parent, foreign_key: {to_table: :xclock_battles},    null: true,                comment: "親"
        t.belongs_to :rule,   foreign_key: {to_table: :xclock_rules},      null: false,               comment: "ルール"
        t.belongs_to :final,  foreign_key: {to_table: :xclock_finals},     null: false,               comment: "結果"
        t.datetime :begin_at,    null: false,  index: true, comment: "対戦開始日時"
        t.datetime :end_at,      null: true,   index: true, comment: "対戦終了日時"
      ...
      # Xclock::BattleMembership
      create_table :xclock_battle_memberships, force: true do |t|
        t.belongs_to :battle, foreign_key: {to_table: :xclock_battles},    null: false,              comment: "対戦"
        t.belongs_to :user, foreign_key: true,      null: false,              comment: "対戦者"
        t.belongs_to :judge, foreign_key: {to_table: :xclock_judges},     null: false,              comment: "勝敗"
        t.integer :position,     null: false, index: true, comment: "順序"
        t.timestamps
      ...
      create_table :xclock_settings, force: true do |t|
        t.belongs_to :user, foreign_key: true, null: false, comment: "自分"
        t.belongs_to :rule, foreign_key: {to_table: :xclock_rules}, null: false, comment: "選択ルール"
        t.timestamps
      end

      # Xclock::MainXrecord
      common_columns_define = -> t {
        t.belongs_to :judge, foreign_key: {to_table: :xclock_judges},                                 null: false,               comment: "直前の勝敗"
        t.belongs_to :final, foreign_key: {to_table: :xclock_finals},                                 null: false,               comment: "直前の結果"
        ...
        t.belongs_to :skill, foreign_key: {to_table: :xclock_skills},                                null: false, index: true,  comment: "ウデマエ"
      ...
      # Xclock::SeasonXrecord
      create_table :xclock_season_xrecords, force: true do |t|
        common_columns_define.call(t)
        t.belongs_to :user, foreign_key: true,          null: false, index: true, comment: "対戦者"
        t.belongs_to :season, foreign_key: {to_table: :xclock_seasons},        null: false,              comment: "期"
        t.integer :create_count,     null: false, index: true, comment: "users.xclock_season_xrecord.create_count は users.xclock_season_xrecords.count と一致"
      ...
      create_table :xclock_room_messages, force: true do |t|
        t.belongs_to :user, foreign_key: true,         null: false, comment: "対戦者"
        t.belongs_to :room, foreign_key: {to_table: :xclock_rooms},         null: false, comment: "対戦部屋"
      ...
      create_table :xclock_lobby_messages, force: true do |t|
        t.belongs_to :user, foreign_key: true,         null: false, comment: "対戦者"
        t.string :body, limit: 140, null: false, comment: "発言"
        t.timestamps
      end

      create_table :xclock_questions, force: true do |t|
        t.string :key, null: false, index: true

        t.belongs_to :user, foreign_key: true,    null: false, comment: "作成者"
        t.belongs_to :folder, foreign_key: {to_table: :xclock_folders},  null: false, comment: "フォルダ"
        t.belongs_to :lineage, foreign_key: {to_table: :xclock_lineages}, null: false, comment: "種類"
      ...
      create_table :xclock_good_marks, force: true do |t|
        t.belongs_to :user, foreign_key: true,      null: false,comment: "自分"
        t.belongs_to :question, foreign_key: {to_table: :xclock_questions},  null: false,comment: "出題"
        t.timestamps
        t.index [:user_id, :question_id], unique: true
      end

      create_table :xclock_bad_marks, force: true do |t|
        t.belongs_to :user, foreign_key: true,      null: false, comment: "自分"
        t.belongs_to :question, foreign_key: {to_table: :xclock_questions},  null: false, comment: "出題"
        t.timestamps
        t.index [:user_id, :question_id], unique: true
      ...
      create_table :xclock_clip_marks, force: true do |t|
        t.belongs_to :user, foreign_key: true,      null: false,comment: "自分"
        t.belongs_to :question, foreign_key: {to_table: :xclock_questions},  null: false,comment: "出題"
        t.timestamps
        t.index [:user_id, :question_id], unique: true
      ...
      create_table :xclock_question_messages, force: true do |t|
        t.belongs_to :user, foreign_key: true,          null: false, comment: "発言者"
        t.belongs_to :question, foreign_key: {to_table: :xclock_questions},      null: false, comment: "問題"
        t.string :body, limit: 140,  null: false, comment: "発言"
        t.timestamps
      end

      create_table :xclock_histories, force: true do |t|
        t.belongs_to :user, foreign_key: true,     null: false, comment: "自分"
        t.belongs_to :question, foreign_key: {to_table: :xclock_questions}, null: false, comment: "出題"
        t.timestamps
        ...
        t.belongs_to :room, foreign_key: {to_table: :xclock_rooms},        null: false,               comment: "部屋"
        t.belongs_to :battle, foreign_key: {to_table: :xclock_battles},      null: false,               comment: "対戦"
        t.belongs_to :membership, foreign_key: {to_table: :xclock_battle_memberships},  null: false,               comment: "自分と相手"
        t.belongs_to :ox_mark, foreign_key: {to_table: :xclock_ox_marks},     null: false,               comment: "解答"
        t.float :rating,         null: false, index: false, comment: "レーティング"
      end

      create_table :xclock_ox_records, force: true do |t|
        t.belongs_to :question, foreign_key: {to_table: :xclock_questions},                    null: false, index: { unique: true }, comment: "問題"
      ...
      # MovesAnswer
      create_table :xclock_moves_answers, force: true do |t|
        t.belongs_to :question, foreign_key: {to_table: :xclock_questions}, null: false,               comment: "問題"
