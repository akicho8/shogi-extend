class CreateAcns3 < ActiveRecord::Migration[6.0]
  def change
    create_table :acns3_rooms do |t|
    ...
    create_table :acns3_memberships do |t|
    ...
    create_table :acns3_profiles do |t|
      t.belongs_to :user,                                    comment: "対戦者"
    ...
    create_table :acns3_messages do |t|
      t.belongs_to :user,         comment: "対戦者"
      t.belongs_to :room,         comment: "対戦部屋"
    ...
    create_table :acns3_questions do |t|
    ...
    create_table :acns3_moves_answers do |t|
    ...
    create_table :acns3_endpos_answers do |t|
      t.belongs_to :question,                            comment: "問題"
      t.integer :limit_turn,  null: false, index: true,  comment: "N手"
