class CreateWbook < ActiveRecord::Migration[6.0]
  def change
    DbCop.foreign_key_checks_disable do
      ################################################################################ 静的

      # フォルダ
      create_table :wbook_folders, force: true do |t|
      ...
      # 問題の種類
      create_table :wbook_lineages, force: true do |t|
      ...
      # static
      create_table :wbook_ox_marks, force: true do |t|
      ...
      # 勝ち負け
      create_table :wbook_judges, force: true do |t|
        t.string :key, null: false
        t.integer :position, null: false, index: true
        t.timestamps
      end
      ...
      # ルール
      create_table :wbook_rules, force: true do |t|
        t.string :key, null: false
        t.integer :position, null: false, index: true
        t.timestamps
      end
      ...
      # 結果
      create_table :wbook_finals, force: true do |t|
        t.string :key, null: false
        t.integer :position, null: false, index: true
        t.timestamps
      end
      ...
      # ウデマエ
      create_table :wbook_skills, force: true do |t|
        t.string :key, null: false
        t.integer :position, null: false, index: true
        t.timestamps
      end
      ...
      create_table :wbook_rooms, force: true do |t|
        t.datetime :begin_at,     null: false, index: true, comment: "対戦開始日時"
        t.datetime :end_at,       null: true,  index: true, comment: "対戦終了日時"
        t.belongs_to :rule, foreign_key: {to_table: :wbook_rules}, null: false,              comment: "ルール"
        t.timestamps
      ...
      create_table :wbook_room_memberships, force: true do |t|
        t.belongs_to :room, foreign_key: {to_table: :wbook_rooms},  null: false,              comment: "対戦部屋"
      ...
      create_table :wbook_battles, force: true do |t|
        t.belongs_to :room,   foreign_key: {to_table: :wbook_rooms},      null: false,               comment: "部屋"
        t.belongs_to :parent, foreign_key: {to_table: :wbook_battles},    null: true,                comment: "親"
        t.belongs_to :rule,   foreign_key: {to_table: :wbook_rules},      null: false,               comment: "ルール"
        t.belongs_to :final,  foreign_key: {to_table: :wbook_finals},     null: false,               comment: "結果"
        t.datetime :begin_at,    null: false,  index: true, comment: "対戦開始日時"
        t.datetime :end_at,      null: true,   index: true, comment: "対戦終了日時"
      ...
      # Wbook::BattleMembership
      create_table :wbook_battle_memberships, force: true do |t|
        t.belongs_to :battle, foreign_key: {to_table: :wbook_battles},    null: false,              comment: "対戦"
        t.belongs_to :user, foreign_key: true,      null: false,              comment: "対戦者"
        t.belongs_to :judge, foreign_key: {to_table: :wbook_judges},     null: false,              comment: "勝敗"
        t.integer :position,     null: false, index: true, comment: "順序"
        t.timestamps
      ...
      create_table :wbook_settings, force: true do |t|
        t.belongs_to :user, foreign_key: true, null: false, comment: "自分"
        t.belongs_to :rule, foreign_key: {to_table: :wbook_rules}, null: false, comment: "選択ルール"
      ...
      common_columns_define = -> t {
        t.belongs_to :judge, foreign_key: {to_table: :wbook_judges},                                 null: false,               comment: "直前の勝敗"
        t.belongs_to :final, foreign_key: {to_table: :wbook_finals},                                 null: false,               comment: "直前の結果"
        ...
        t.belongs_to :skill, foreign_key: {to_table: :wbook_skills},                                null: false, index: true,  comment: "ウデマエ"
      ...
      # Wbook::SeasonXrecord
      create_table :wbook_season_xrecords, force: true do |t|
        common_columns_define.call(t)
        t.belongs_to :user, foreign_key: true,          null: false, index: true, comment: "対戦者"
        t.belongs_to :season, foreign_key: {to_table: :wbook_seasons},        null: false,              comment: "期"
        t.integer :create_count,     null: false, index: true, comment: "users.wbook_season_xrecord.create_count は users.wbook_season_xrecords.count と一致"
      ...
      create_table :wbook_room_messages, force: true do |t|
        t.belongs_to :user, foreign_key: true,         null: false, comment: "対戦者"
        t.belongs_to :room, foreign_key: {to_table: :wbook_rooms},         null: false, comment: "対戦部屋"
      ...
      create_table :wbook_lobby_messages, force: true do |t|
        t.belongs_to :user, foreign_key: true,         null: false, comment: "対戦者"
        t.string :body, limit: 512, null: false, comment: "発言"
        t.timestamps
      end

      create_table :wbook_questions, force: true do |t|
        t.string :key, null: false, index: true

        t.belongs_to :user,    null: false, foreign_key: true,                          comment: "作成者"
        t.belongs_to :folder,  null: false, foreign_key: {to_table: :wbook_folders},   comment: "フォルダ"
        t.belongs_to :lineage, null: false, foreign_key: {to_table: :wbook_lineages}, comment: "種類"
        ...
        t.belongs_to :source_about,        null: true,  foreign_key: {to_table: :wbook_source_abouts}, comment: "所在"
      ...
      create_table :wbook_source_abouts, force: true do |t|
        t.string :key, null: false
        t.integer :position, null: false, index: true
        t.timestamps
      end
      ...
      create_table :wbook_good_marks, force: true do |t|
        t.belongs_to :user, foreign_key: true,      null: false,comment: "自分"
        t.belongs_to :question, foreign_key: {to_table: :wbook_questions},  null: false,comment: "出題"
        t.timestamps
        t.index [:user_id, :question_id], unique: true
      end

      create_table :wbook_bad_marks, force: true do |t|
        t.belongs_to :user, foreign_key: true,      null: false, comment: "自分"
        t.belongs_to :question, foreign_key: {to_table: :wbook_questions},  null: false, comment: "出題"
        t.timestamps
        t.index [:user_id, :question_id], unique: true
      ...
      create_table :wbook_clip_marks, force: true do |t|
        t.belongs_to :user, foreign_key: true,      null: false,comment: "自分"
        t.belongs_to :question, foreign_key: {to_table: :wbook_questions},  null: false,comment: "出題"
        t.timestamps
        t.index [:user_id, :question_id], unique: true
      ...
      create_table :wbook_question_messages, force: true do |t|
        t.belongs_to :user, foreign_key: true,          null: false, comment: "発言者"
        t.belongs_to :question, foreign_key: {to_table: :wbook_questions},      null: false, comment: "問題"
        t.string :body, limit: 512,  null: false, comment: "発言"
        t.timestamps
      end

      create_table :wbook_histories, force: true do |t|
        t.belongs_to :user, foreign_key: true,     null: false, comment: "自分"
        t.belongs_to :question, foreign_key: {to_table: :wbook_questions}, null: false, comment: "出題"
        t.belongs_to :room, foreign_key: {to_table: :wbook_rooms}, null: true, comment: "対戦部屋"
        t.timestamps

        #  おまけ
        t.belongs_to :ox_mark, foreign_key: {to_table: :wbook_ox_marks},     null: false,               comment: "解答"
      end

      create_table :wbook_ox_records, force: true do |t|
        t.belongs_to :question, foreign_key: {to_table: :wbook_questions},                    null: false, index: { unique: true }, comment: "問題"
      ...
      # MovesAnswer
      create_table :wbook_moves_answers, force: true do |t|
        t.belongs_to :question, foreign_key: {to_table: :wbook_questions}, null: false,               comment: "問題"
      ...
      create_table :wbook_notifications, force: true do |t|
        t.belongs_to :question_message, foreign_key: { to_table: :wbook_question_messages }, null: false, comment: "問題コメント"
        t.belongs_to :user,             foreign_key: { to_table: :users                  }, null: false, comment: "通知先"
        t.datetime   :opened_at,                                                            null: true,  comment: "開封日時"
        t.timestamps
      end

      create_table :wbook_emotion_folders, force: true do |t|
        t.string :key,       null: false
        t.integer :position, null: false, index: true
        t.timestamps
      end
      create_table :wbook_emotions, force: true do |t|
        t.belongs_to :user,     foreign_key: true,                              null: false, comment: "所有者"
        t.belongs_to :folder, foreign_key: { to_table: :wbook_emotion_folders }, null: false, comment: "フォルダ"
      ...
      create_table :wbook_vs_records, force: true do |t|
        t.belongs_to :battle, foreign_key: {to_table: :wbook_battles},    null: false, comment: "対戦"
