  ...
  def change
    DbCop.foreign_key_checks_disable do
      ...
      create_table :actb_questions, force: true do |t|
        ...
        t.belongs_to :folder,  null: false, foreign_key: {to_table: :actb_folders},   comment: "フォルダ"
        t.belongs_to :lineage, null: false, foreign_key: {to_table: :actb_lineages}, comment: "種類"
        ...
        t.belongs_to :source_about,        null: true,  foreign_key: {to_table: :actb_source_abouts}, comment: "所在"
