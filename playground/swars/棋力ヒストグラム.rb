...
# >> |---------------------+---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
# >> |       processed_sec | 0.018678999971598387                                                                                                                                                                                                                                                                                                                                                                                                      |
...
# >> | custom_chart_params | {:data=>{:labels=>["9", "8", "7", "6", "5", "4", "3", "2", "1", "初", "二", "三", "四", "五", "六", "七", "八", "九"], :datasets=>[{:label=>nil, :data=>[0, 0, 0, 0, 0, 0, 0, 2, 4, 0, 0, 0, 0, 0, 0, 0, 0, 0]}]}, :scales_yAxes_ticks=>nil, :scales_yAxes_display=>false...                                                                                                                                              |
# >> |            rule_key |                                                                                                                                                                                                                                                                                                                                                                                                                           |
# >> |                xtag |                                                                                                                                                                                                                                                                                                                                                                                                                           |
# >> |    real_total_count | 6                                                                                                                                                                                                                                                                                                                                                                                                                         |
# >> |   xtag_select_names | ["花村流名古屋戦法", "清野流岐阜戦法", "GAVA角", "▲５五龍中飛車", "ノーガード戦法", "▲３七銀戦法", "脇システム", "ウソ矢倉", "矢倉棒銀", "森下システム", "雀刺し", "米長流急戦矢倉", "カニカニ銀", "カニカニ金", "中原流急戦矢倉", "阿久津流急戦矢倉", "藤森流急戦矢倉", "屋敷流二枚銀", "屋敷流二枚銀棒銀型", "矢倉中飛車", "右四間飛車", "原始棒銀", "かまいたち戦法", "英春流カメレオン", "パックマン戦法", "山崎... |
# >> |---------------------+---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
