...
m.first_matched_medal # => #<Swars::MembershipMedalInfo:0x00007fb0044a81a0 @attributes={:key=>:運営支えマン, :medal_params=>"🤖", :if_cond=>#<Proc:0x00007fb0044a9d20@/Users/ikeda/src/shogi_web/app/models/swars/membership_medal_info.rb:8 (lambda)>, :code=>1}>
