...
Swars::Importer::BattleImporter.new(key: "MinoriChihara-Yamada_Taro-20190111_084942").run
...
# >> |  2 | Yamada_Taro     |        1 |                   |                 0 | 2019-01-12 15:54:24 +0900 | 2019-01-12 17:04:24 +0900 |
# >> |----+---------------+----------+-------------------+-------------------+---------------------------+---------------------------|
# >> |-------------------+---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
# >> |               key | MinoriChihara-Yamada_Taro-20190111_084942                                                                                                                                                                                                                             |
# >> |               url | https://shogiwars.heroz.jp/games/MinoriChihara-Yamada_Taro-20190111_084942?locale=ja                                                                                                                                                                                    |
# >> |        battled_at | 20190111_084942                                                                                                                                                                                                                                                     |
# >> | preset_magic_number | 5                                                                                                                                                                                                                                                                   |
# >> |          gamedata | {:name=>"MinoriChihara-Yamada_Taro-20190111_084942", :avatar0=>"_e1812s10c", :avatar1=>"coach04", :dan0=>"2級", :dan1=>"十段", :gtype=>""}                                                                                                                            |
...
# >> |       win_user_id | 2                                                                                                                                                                                                                                                                                                          |
# >> |          turn_max | 67                                                                                                                                                                                                                                                                                                         |
# >> |         meta_info | {:header=>{"先手"=>"MinoriChihara 2級", "後手"=>"Yamada_Taro 十段", "開始日時"=>"2019/01/11 08:49:42", "棋戦"=>"将棋ウォーズ(10分切れ負け 指導対局 二枚落ち)", "持ち時間"=>"00:10+00"}, :detail_names=>[[], []], :simple_names=>[[["MinoriChihara", "2級"]], [["Yamada_Taro", "十段"]]], :skill_set_hash=>{... |
