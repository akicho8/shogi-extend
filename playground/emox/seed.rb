...
# Emox::Question.count            # => 1
# exit

Emox::Lineage.all.collect(&:key)                 # => ["詰将棋", "実戦詰め筋", "手筋", "必死", "必死逃れ", "定跡", "秘密"]
Emox::Judge.all.collect(&:key)                   # => ["win", "lose", "draw", "pending"]
Emox::Rule.all.collect(&:key)                    # => ["sy_marathon", "sy_singleton", "sy_hybrid"]
Emox::Final.all.collect(&:key)                   # => ["f_give_up", "f_disconnect", "f_success", "f_draw", "f_pending"]

10.times do
  Emox::Season.create!
end
Emox::Season.count              # => 11
...
# 問題作成
10.times do |i|
  question = user1.emox_questions.create! do |e|
...
# 最初の問題だけゴミ箱へ
question = Emox::Question.first!
# question.update!(folder: question.user.emox_trash_box) の方法はださい
question.user.emox_trash_box.questions << question
question.folder # => #<Emox::TrashBox id: 3, user_id: 1, type: "Emox::TrashBox", created_at: "2020-07-03 12:06:18", updated_at: "2020-07-03 12:06:18">

# 2番目の問題は下書きへ
question = Emox::Question.second!
question.folder_key           # => "active"
question.folder_key = :draft
question.save!                 # => true
question.folder.type           # => "Emox::DraftBox"
# tp question.as_json
# exit

# 部屋を立てる
room = Emox::Room.create! do |e|
...
battle                          # => #<Emox::Battle id: 1, room_id: 1, parent_id: nil, rule_id: 1, final_id: 5, begin_at: "2020-07-03 12:06:35", end_at: nil, battle_pos: 0, created_at: "2020-07-03 12:06:35", updated_at: "2020-07-03 12:06:35">

battle.users.count                # => 2
battle.battle_pos               # => 0

battle2 = battle.battle_chain_create # => #<Emox::Battle id: 2, room_id: 1, parent_id: 1, rule_id: 1, final_id: 5, begin_at: "2020-07-03 12:06:35", end_at: nil, battle_pos: 1, created_at: "2020-07-03 12:06:35", updated_at: "2020-07-03 12:06:35">
...
# # すべての問題に解答する
Emox::Question.all.each.with_index do |question, i|
  ox_mark_key = Emox::OxMarkInfo[i.modulo(Emox::OxMarkInfo.count)].key
  user1.emox_histories.create!(question: question, ox_mark: Emox::OxMark.fetch(ox_mark_key))
end

# tp Emox::Season.all
# tp user1.emox_season_xrecords
# 
# exit
puts user1.info
# exit
...
# 切断したことにする
user1.emox_latest_xrecord.update!(final: Emox::Final.fetch(:f_disconnect))
tp user1.emox_latest_xrecord
tp user1.emox_main_xrecord

# Good, Bad, Clip
user1.emox_good_marks.create!(question: Emox::Question.first!)
user1.emox_bad_marks.create!(question: Emox::Question.second!)
user1.emox_clip_marks.create!(question: Emox::Question.third!)

# 問題に対してコメント
5.times do
  question = Emox::Question.first!
  question.messages.create!(user: user1, body: "message") # => #<Emox::QuestionMessage id: 1, user_id: 1, question_id: 1, body: "message", created_at: "2020-07-03 12:06:36", updated_at: "2020-07-03 12:06:36">, #<Emox::QuestionMessage id: 2, user_id: 1, question_id: 1, body: "message", created_at: "2020-07-03 12:06:37", updated_at: "2020-07-03 12:06:37">, #<Emox::QuestionMessage id: 3, user_id: 1, question_id: 1, body: "message", created_at: "2020-07-03 12:06:37", updated_at: "2020-07-03 12:06:37">, #<Emox::QuestionMessage id: 4, user_id: 1, question_id: 1, body: "message", created_at: "2020-07-03 12:06:38", updated_at: "2020-07-03 12:06:38">, #<Emox::QuestionMessage id: 5, user_id: 1, question_id: 1, body: "message", created_at: "2020-07-03 12:06:39", updated_at: "2020-07-03 12:06:39">
...
tp Emox.info
# >> load: /Users/ikeda/src/shogi_web/app/models/emox/questions.yml (13)
# >> |--------------------+--------|
# >> |               名前 | 運営   |
# >> |       レーティング | 1500.0 |
# >> |             クラス | C-     |
...
# >> | User                   |     9 |      9 |
# >> | Emox::Question         |    23 |     23 |
# >> | Emox::QuestionMessage  |     5 |      5 |
# >> | Emox::Room             |     1 |      1 |
# >> | Emox::RoomMembership   |     2 |      2 |
# >> | Emox::RoomMessage      |     0 |        |
# >> | Emox::Battle           |     2 |      2 |
# >> | Emox::BattleMembership |     4 |      4 |
# >> | Emox::Season           |    11 |     11 |
# >> | Emox::SeasonXrecord    |    10 |     10 |
# >> | Emox::MainXrecord      |     9 |      9 |
# >> | Emox::Setting          |     9 |      9 |
# >> | Emox::GoodMark         |     1 |      1 |
# >> | Emox::BadMark          |     1 |      1 |
# >> | Emox::ClipMark         |     1 |      1 |
