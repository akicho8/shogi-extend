...
Swars::Importer::AllRuleImporter.new(remote_run: true, user_key: "shouracco", page_max: 1).run

# Swars::Importer::AllRuleImporter.new(remote_run: true, user_key: "Lord_Asriel", page_max: 1).run
