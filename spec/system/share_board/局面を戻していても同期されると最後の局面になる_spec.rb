...
RSpec.describe __FILE__, type: :system, share_board_spec: true do
  it "スライダーがキャンセルされる" do
    ...
    window_b { sp_controller_click("first") }        # bは「すぐに」最初の局面に戻した。b からは1秒後に reflector_action が実行されるのだが、そのときにはすでに4手目まで進んでいる
    window_a { piece_move_o("27", "26", "☗2六歩") } # reflector_action が呼ばれるよりも前に3手目が指され、
