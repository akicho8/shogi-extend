...
RSpec.describe __FILE__, type: :system, share_board_spec: true do
  it "works" do
    ...
    assert_selector(".EndingModal .modal-card-head", text: "勝ち", exact_text: true)        # モーダルのタイトル
    assert_selector(".EndingModal .modal-card-body", text: "aさんが詰ましてaさんの勝ちです", exact_text: true) # モーダルの本文
