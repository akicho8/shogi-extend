...
RSpec.describe __FILE__, type: :system, share_board_spec: true do
  it "works" do
    ...
    # 2回目のモーダル表示
    assert_selector(".resend_confirm_message", text: "bさんが抜けている場合は対局を中断後、対局設定から外して、対局時計を再開してください", exact_text: true) # しかしモーダルが出てbが応答しないのがわかる
    ...
    assert_text "bさんが抜けた場合は対局設定から外して再開してください"
