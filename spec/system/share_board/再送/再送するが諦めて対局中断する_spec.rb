...
RSpec.describe __FILE__, type: :system, share_board_spec: true do
  it "works" do
    ...
    # 2回目のモーダル表示
    assert_selector(".resend_confirm_message", text: "bさんが抜けている場合は対局を中断後、ルール設定から外して、対局時計を再開してください", exact_text: true) # しかしモーダルが出てbが応答しないのがわかる
    ...
    assert_history_text("対局中断")                                  # 履歴にログが出ている
    assert_text "bさんが抜けた場合はルール設定から外して再開してください"
