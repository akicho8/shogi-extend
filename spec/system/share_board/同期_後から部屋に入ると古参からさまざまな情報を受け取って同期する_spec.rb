...
RSpec.describe type: :system, share_board_spec: true do
  describe "盤面" do
    it "最大2手まである棋譜の1手目を指している部屋に入ったとき1手目になる" do
      a_block do
        visit_app(room_code: :test_room, fixed_user_name: "alice", fixed_order_names: "alice,bob", body: "76歩34歩")
  ...
  describe "順番設定" do
    it "works" do
      a_block do
        visit_app(room_code: :test_room, fixed_user_name: "alice", fixed_order_names: "alice,bob")
  ...
  describe "タイトル" do
    it "works" do
      a_block do
        visit_app(room_code: :test_room, fixed_user_name: "alice", title: "(new_title)")
      end
      b_block do
        visit_app(room_code: :test_room, fixed_user_name: "bob")
