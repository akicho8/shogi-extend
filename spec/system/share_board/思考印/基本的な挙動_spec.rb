...
RSpec.describe __FILE__, type: :system, share_board_spec: true do
  ...
  it "クリックした升目に円と名前が出る" do
    ...
    click_try_at_76
    assert_selector(".place_7_6 .ThinkMarkLayer .think_mark_effect_container")
  ...
  it "名前が空なら円だけでる" do
    ...
    click_try_at_76
    assert_selector(".place_7_6 .ThinkMarkLayer .think_mark_effect_container") # 円はあるが名前はない
    assert_no_selector(".place_7_6 .ThinkMarkLayer .think_mark_user_name")     # 名前が空ではなく名前欄自体がない
  end
