...
RSpec.describe "動画作成", type: :system, kiwi: true do
  ...
  describe "トリム" do
    it "空の場合" do
      ...
      is_asserted_by { value == "position sfen lnsgkgsnl/1r5b1/ppppppppp/9/9/9/PPPPPPPPP/1B5R1/LNSGKGSNL b - 1" }
    end
    it "入力済みの場合" do
      ...
      is_asserted_by { value == "position sfen lnsgkgsnl/1r5b1/ppppppppp/9/9/2P6/PP1PPPPPP/1B5R1/LNSGKGSNL w - 1 moves 8c8d 7i6h" }
    end
  end
