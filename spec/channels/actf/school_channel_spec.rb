...
RSpec.describe Actf::SchoolChannel, type: :channel do
  ...
  describe "#subscribe" do
    ...
    it "オンラインリスト通知" do
      expect { subject }.to have_broadcasted_to("actf/school_channel").with({
  ...
  describe "#unsubscribe" do
    ...
    it "オフラインリスト通知" do
      expect { unsubscribe }.to have_broadcasted_to("actf/school_channel").with({
          online_user_ids: [],
          room_user_ids: [],
        })
    end
