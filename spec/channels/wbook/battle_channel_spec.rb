...
RSpec.describe Wbook::BattleChannel, type: :channel do
  before(:context) do
    Wbook.setup
    Emox.setup
  end
  ...
  describe "#speak" do
    ...
    it do
      ...
      assert { user1.wbook_room_messages.count == 1 }
    end
  end
  ...
  describe "#kotae_sentaku" do
    ...
    it do
      ...
      }.to have_broadcasted_to("wbook/battle_channel/#{current_battle.id}").with(bc_action: "kotae_sentaku_broadcasted", bc_params: data)
  ...
  describe "#next_trigger" do
    ...
    it do
      ...
      }.to have_broadcasted_to("wbook/battle_channel/#{current_battle.id}").with(bc_action: "next_trigger_broadcasted", bc_params: data)
    end
  end
  ...
  describe "#play_board_share" do
    ...
    it do
      ...
      }.to have_broadcasted_to("wbook/battle_channel/#{current_battle.id}").with(bc_action: "play_board_share_broadcasted", bc_params: data)
    end
  end
  ...
  describe "#goal_hook" do
    ...
    it "結果画面へ" do
      ...
      }.to have_broadcasted_to("wbook/battle_channel/#{current_battle.id}")
    end
  ...
  describe "#judgement_run" do
    ...
    it "結果" do
      ...
      assert { user1.wbook_latest_xrecord.rating == 1516 }
      assert { user2.wbook_latest_xrecord.rating == 1484 }

      assert { user1.wbook_latest_xrecord.straight_win_count == 1 }
      assert { user1.wbook_latest_xrecord.straight_lose_count == 0 }
      assert { user2.wbook_latest_xrecord.straight_win_count == 0 }
      assert { user2.wbook_latest_xrecord.straight_lose_count == 1 }
    end
  end
end
