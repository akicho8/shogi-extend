...
RSpec.describe ShareBoard::RoomChannel, type: :channel do
  ...
  describe "局面配布" do
    ...
    it "works" do
      ...
      }.to have_broadcasted_to(channel_key).with(bc_action: "reflector_action_broadcasted", bc_params: data)
    end
  end
  ...
  describe "タイトル共有" do
    ...
    it "works" do
      ...
      expect {
        subscription.room_name_share(data)
      }.to have_broadcasted_to(channel_key).with(bc_action: "room_name_share_broadcasted", bc_params: data)
    end
  end
  ...
  describe "思考印" do
    ...
    it "think_mark_toggle_action" do
      data = data_factory({})
      expect {
        subscription.think_mark_toggle_action(data)
      }.to have_broadcasted_to(channel_key).with(bc_action: "think_mark_toggle_action_broadcasted", bc_params: data)
    end
  ...
  describe "投了発動" do
    ...
    it "works" do
      data = data_factory
      expect {
        subscription.resign_action(data)
      }.to have_broadcasted_to(channel_key).with(bc_action: "resign_action_broadcasted", bc_params: data)
    end
  end
