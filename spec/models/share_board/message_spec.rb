...
RSpec.describe ShareBoard::Message do
  it "to_h" do
    ...
    assert2 { object.to_h == { role: "user", content: "a/b/c" } }
  end

  it "to_gpt" do
    object = ShareBoard::Message.new(:user, "a/b/c")
    assert2 { object.to_gpt == { role: "user", content: "a/b/c" } }
  end

  # it "to_redis_value" do
  #   object = ShareBoard::Message.new("user", "a/b/c")
  #   assert2 { object.to_redis_value == "user/a/b/c" }
  # end
  #
  ...
  it "to_json" do
    object = ShareBoard::Message.new(:user, "a/b/c")
    assert2 { JSON.parse(object.to_json) == {"role"=>"user", "content"=>"a/b/c"} }
  end
