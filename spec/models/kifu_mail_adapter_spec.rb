...
# >> KifuMailAdapter
# >> ▼再生
# >> https://tinyurl.com/2n3ta48y
# >> 
# >> ▼*再生URLの元
# >> http://localhost:4000/share-board?black=%28black%29&body=position+sfen+lnsgkgsnl%2F1r5b1%2Fppppppppp%2F9%2F9%2F9%2FPPPPPPPPP%2F1B5R1%2FLNSGKGSNL+b+-+1+moves+6i5h+4a5b+4i4h+6a6b&member=%28member%29&other=%28other%29&title=%28title%29&white=%28white%29
# >> 
# >> ▼*KENTO
...
# >>   works
# >> 
# >> Top 1 slowest examples (1.46 seconds, 51.9% of total time):
# >>   KifuMailAdapter works
# >>     1.46 seconds -:4
# >> 
# >> Finished in 2.82 seconds (files took 3.88 seconds to load)
