...
# == Schema Information ==
#
# Skill (wbook_skills as Wbook::Skill)
#
# |------------+--------------------+-------------+-------------+------+-------|
...
module Wbook
  RSpec.describe Battle, type: :model do
    ...
    def test1(skill_key, skill_point, diff)
      user1.wbook_main_xrecord.update!(skill: Skill.fetch(skill_key), skill_point: skill_point)
      user1.wbook_main_xrecord.skill_add(diff)
