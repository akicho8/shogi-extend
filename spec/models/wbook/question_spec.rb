...
module Wbook
  RSpec.describe Question, type: :model do
    ...
    describe "update_from_js 保存" do
      ...
      it "works" do
        # 1つ目を作る
        question = user1.wbook_questions.build
    ...
    describe "フォルダ" do
      ...
      it "移動方法1" do
        user1.wbook_trash_box.questions << question1
        assert { question1.folder.class == Wbook::TrashBox }
      end
      it "移動方法2(フォーム用)" do
    ...
    it "公開フォルダに移動させたタイミングで投稿通知" do
      ...
      Wbook::LobbyMessage.destroy_all

      assert { Wbook::LobbyMessage.count == 0 }

      question1.update_from_js(folder_key: "active")
      assert { Wbook::LobbyMessage.count == 1 }
...
# >> ."position sfen 4k4/9/4G4/9/9/9/9/9/9 b G2r2b2g4s4n4l1p 1 moves G*5b"
# >> "position sfen 4k4/9/4G4/9/9/9/9/9/9 b G2r2b2g4s4n4l1p 1 moves G*5b"
# >> ["/Users/ikeda/src/shogi_web/app/models/wbook/question/info_mod.rb:80", :to_kif, "position sfen 4k4/9/4G4/9/9/9/9/9/9 b G2r2b2g4s4n4l1p 1 moves G*5b"]
# >> ."position sfen 4k4/9/4G4/9/9/9/9/9/9 b G2r2b2g4s4n4l1p 1 moves G*5b"
# >> "position sfen 4k4/9/4G4/9/9/9/9/9/9 b G2r2b2g4s4n4l1p 1 moves G*5b"
# >> ."position sfen 4k4/9/4G4/9/9/9/9/9/9 b G2r2b2g4s4n4l1p 1 moves G*5b"
# >> "position sfen 4k4/9/4G4/9/9/9/9/9/9 b G2r2b2g4s4n4l1p 1 moves G*5b"
