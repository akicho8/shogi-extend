...
# == Schema Information ==
#
# Skill (xclock_skills as Xclock::Skill)
#
# |------------+--------------------+-------------+-------------+------+-------|
...
module Xclock
  RSpec.describe Battle, type: :model do
    ...
    def test1(skill_key, skill_point, diff)
      user1.xclock_main_xrecord.update!(skill: Skill.fetch(skill_key), skill_point: skill_point)
      user1.xclock_main_xrecord.skill_add(diff)
