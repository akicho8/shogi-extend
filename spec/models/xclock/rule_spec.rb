...
# == Schema Information ==
#
# Rule (xclock_rules as Xclock::Rule)
#
# |------------+--------------------+-------------+-------------+------+-------|
...
module Xclock
  RSpec.describe Rule, type: :model do
    ...
    it "class_methods" do
      Xclock::Rule.all.collect(&:key) # => ["test_rule", "good_rule", "good_marathon_rule", "beginner_rule", "normal_rule", "pro_rule", "latest_rule", "technical_rule", "singleton_rule", "marathon_rule", "hybrid_rule", "classic_only_rule", "ahiru_only_rule"]
      assert { Rule.all.count >= 1 }
    end

    it "works" do
      rule = Xclock::Rule.first
