...
RSpec.describe QuickScript::Swars::TacticStatScript, type: :model do
  it "整合性" do
    ...
    assert { case1(["▲68銀"])           == [{勝ち: 1, 勝率: 1.0, 名前: "嬉野流", 引分: 0, 種類: "戦法", 負け: 0, 人気度: 1.0, 出現率: 0.5, スタイル: "王道", 使用人数: 1, 出現回数: 1}] }
    assert { case1(["▲68銀△42銀"])     == [{勝ち: 1, 勝率: 0.5, 名前: "嬉野流", 引分: 0, 種類: "戦法", 負け: 1, 人気度: 1.0, 出現率: 1.0, スタイル: "王道", 使用人数: 2, 出現回数: 2}] }
    assert { case1(["▲68銀△42銀"] * 2) == [{勝ち: 2, 勝率: 0.5, 名前: "嬉野流", 引分: 0, 種類: "戦法", 負け: 2, 人気度: 1.0, 出現率: 1.0, スタイル: "王道", 使用人数: 2, 出現回数: 4}] }
  end
