...
RSpec.describe QuickScript::Swars::TacticCrossScript, type: :model do
  it "整合性" do
    ...
    assert { case1(["1級", "1級"], ["▲68銀"])           == [{ 棋力: "1級", 名前: "嬉野流", 種類: "戦法", スタイル: "王道", 勝率: 1.0, 出現率: 0.5, 出現回数: 1, 勝ち: 1, 負け: 0, 引分: 0, 使用人数: 1, 人気度: 1.0 }] }
    assert { case1(["1級", "1級"], ["▲68銀△42銀"])     == [{ 棋力: "1級", 名前: "嬉野流", 種類: "戦法", スタイル: "王道", 勝率: 0.5, 出現率: 1.0, 出現回数: 2, 勝ち: 1, 負け: 1, 引分: 0, 使用人数: 2, 人気度: 1.0 }] }
    assert { case1(["1級", "1級"], ["▲68銀△42銀"] * 2) == [{ 棋力: "1級", 名前: "嬉野流", 種類: "戦法", スタイル: "王道", 勝率: 0.5, 出現率: 1.0, 出現回数: 4, 勝ち: 2, 負け: 2, 引分: 0, 使用人数: 2, 人気度: 1.0 }] }
    assert { case1(["1級", "1級"], ["▲68銀△62玉"])     == [{ 棋力: "1級", 名前: "嬉野流", 種類: "戦法", スタイル: "王道", 勝率: 1.0, 出現率: 0.5, 出現回数: 1, 勝ち: 1, 負け: 0, 引分: 0, 使用人数: 1, 人気度: 0.5 }, { 棋力: "1級", 名前: "新米長玉", 種類: "戦法", スタイル: "準変態", 勝率: 0.0, 出現率: 0.5, 出現回数: 1, 勝ち: 0, 負け: 1, 引分: 0, 使用人数: 1, 人気度: 0.5 }] }

    assert { case1(["1級", "2級"], ["▲68銀"])           == [{ 棋力: "1級", 名前: "嬉野流", 種類: "戦法", スタイル: "王道", 勝率: 1.0, 出現率: 1.0, 出現回数: 1, 勝ち: 1, 負け: 0, 引分: 0, 使用人数: 1, 人気度: 1.0 }] }
    assert { case1(["1級", "2級"], ["▲68銀△42銀"])     == [{ 棋力: "1級", 名前: "嬉野流", 種類: "戦法", スタイル: "王道", 勝率: 1.0, 出現率: 1.0, 出現回数: 1, 勝ち: 1, 負け: 0, 引分: 0, 使用人数: 1, 人気度: 1.0 }, { 棋力: "2級", 名前: "嬉野流", 種類: "戦法", スタイル: "王道", 勝率: 0.0, 出現率: 1.0, 出現回数: 1, 勝ち: 0, 負け: 1, 引分: 0, 使用人数: 1, 人気度: 1.0 }] }
    assert { case1(["1級", "2級"], ["▲68銀△42銀"] * 2) == [{ 棋力: "1級", 名前: "嬉野流", 種類: "戦法", スタイル: "王道", 勝率: 1.0, 出現率: 1.0, 出現回数: 2, 勝ち: 2, 負け: 0, 引分: 0, 使用人数: 1, 人気度: 1.0 }, { 棋力: "2級", 名前: "嬉野流", 種類: "戦法", スタイル: "王道", 勝率: 0.0, 出現率: 1.0, 出現回数: 2, 勝ち: 0, 負け: 2, 引分: 0, 使用人数: 1, 人気度: 1.0 }] }
    assert { case1(["1級", "2級"], ["▲68銀△62玉"])     == [{ 棋力: "1級", 名前: "嬉野流", 種類: "戦法", スタイル: "王道", 勝率: 1.0, 出現率: 1.0, 出現回数: 1, 勝ち: 1, 負け: 0, 引分: 0, 使用人数: 1, 人気度: 1.0 }, { 棋力: "2級", 名前: "新米長玉", 種類: "戦法", スタイル: "準変態", 勝率: 0.0, 出現率: 1.0, 出現回数: 1, 勝ち: 0, 負け: 1, 引分: 0, 使用人数: 1, 人気度: 1.0 }] }
  end
