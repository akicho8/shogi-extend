...
module QuickScript
  module Swars
    RSpec.describe AllDownloadScript, type: :model do
      it "works" do
        ...
        # 棋譜取得の予約
        params = {user_key: sw_user.key, attachment_mode: "with_zip"}
        json = Swars::AllDownloadScript.new(params, {_method: "post", current_user: current_user}).as_json
