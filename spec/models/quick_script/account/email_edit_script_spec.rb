...
module QuickScript
  module Account
    RSpec.describe EmailEditScript, type: :model do
      it "works" do
        user = User.create!
        new_email = "#{SecureRandom.hex}@localhost"
        json = EmailEditScript.new({email: new_email}, {current_user: user, _method: :post}).as_json
...
# >>   QuickScript::Account::EmailEditScript works
# >>     0.25009 seconds -:6
# >> 
