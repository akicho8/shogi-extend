...
# == Schema Information ==
#
# Skill (wkbk_skills as Wkbk::Skill)
#
# |------------+--------------------+-------------+-------------+------+-------|
...
module Wkbk
  RSpec.describe Battle, type: :model do
    ...
    def test1(skill_key, skill_point, diff)
      user1.wkbk_main_xrecord.update!(skill: Skill.fetch(skill_key), skill_point: skill_point)
      user1.wkbk_main_xrecord.skill_add(diff)
