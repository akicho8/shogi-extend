...
# == Schema Information ==
#
# Wkbk::Folder (wkbk_folders as Wkbk::Folder)
#
# |----------------+----------------+-------------+---------------------+------+-------|
...
# | books_count    | Wkbk::Books count    | integer(4)  | DEFAULT(0) NOT NULL |      |       |
# | articles_count | Wkbk::Articles count | integer(4)  | DEFAULT(0) NOT NULL |      |       |
