...
RSpec.describe Wkbk::AnswerLog, type: :model do
  ...
  it "works" do
    ...
    user.wkbk_answer_logs.create!(article: book.articles[0], answer_kind: Wkbk::AnswerKind.fetch("correct"), book: book, spent_sec: 1)
    user.wkbk_answer_logs.create!(article: book.articles[0], answer_kind: Wkbk::AnswerKind.fetch("mistake"), book: book, spent_sec: 1)
  end
end
