...
# == Schema Information ==
#
# Question (wkbk_questions as Wkbk::Question)
#
# |---------------------+---------------------+-------------+-------------+------+-------|
...
#
#- Remarks ----------------------------------------------------------------------
# [Warning: Need to add relation] Wkbk::Question モデルに belongs_to :lineage を追加してください
# [Warning: Need to add relation] Wkbk::Question モデルに belongs_to :source_about を追加してください
# [Warning: Need to add relation] Wkbk::Question モデルに belongs_to :user を追加してください
#--------------------------------------------------------------------------------
...
module Wkbk
  RSpec.describe Question, type: :model do
    ...
    describe "update_from_js 保存" do
      ...
      it "works" do
        # 1つ目を作る
        question = user1.wkbk_questions.build
    ...
    describe "フォルダ" do
      ...
      it "移動方法1" do
        user1.wkbk_trash_box.questions << question1
        assert { question1.folder.class == Wkbk::TrashBox }
      end
      it "移動方法2(フォーム用)" do
...
# >> ."position sfen 4k4/9/4G4/9/9/9/9/9/9 b G2r2b2g4s4n4l1p 1 moves G*5b"
# >> "position sfen 4k4/9/4G4/9/9/9/9/9/9 b G2r2b2g4s4n4l1p 1 moves G*5b"
# >> ["/Users/ikeda/src/shogi_web/app/models/wkbk/question/info_mod.rb:80", :to_kif, "position sfen 4k4/9/4G4/9/9/9/9/9/9 b G2r2b2g4s4n4l1p 1 moves G*5b"]
# >> ."position sfen 4k4/9/4G4/9/9/9/9/9/9 b G2r2b2g4s4n4l1p 1 moves G*5b"
# >> "position sfen 4k4/9/4G4/9/9/9/9/9/9 b G2r2b2g4s4n4l1p 1 moves G*5b"
# >> ."position sfen 4k4/9/4G4/9/9/9/9/9/9 b G2r2b2g4s4n4l1p 1 moves G*5b"
# >> "position sfen 4k4/9/4G4/9/9/9/9/9/9 b G2r2b2g4s4n4l1p 1 moves G*5b"
