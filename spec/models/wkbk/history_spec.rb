...
# == Schema Information ==
#
# History (wkbk_histories as Wkbk::History)
#
# |-------------+----------+------------+-------------+--------------+-------|
...
module Wkbk
  RSpec.describe History, type: :model do
    ...
    it "解答" do
      ...
      history = user1.wkbk_histories.create!(question: question1, ox_mark: Wkbk::OxMark.fetch(:correct))
      assert { history }
      assert { User.bot.wkbk_lobby_messages.last.body.match?(/user1.*さん.*本日1問.*解きました/) }
    end
  end
end
