...
module Swars
  module Agent
    RSpec.describe RecordAdapter, type: :model, swars_spec: true do
      ...
      it "works" do
        record_adapter = RecordAdapter.new(swars_react_props)
        assert { result[:key] == "alice-DevUser2-20200101_123456" }
        ...
        assert { result[:user_infos] == [{user_key: "alice", grade_key: "三段"}, {user_key: "DevUser2", grade_key: "四段"}] }
