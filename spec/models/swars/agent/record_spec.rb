  ...
  module Agent
    RSpec.describe Record, type: :model, swars_spec: true do
      it "development" do
        ...
        is_asserted_by { object.dig("gameHash", "name") == "MockUser1-MockUser2-20000101_112233" }
      end
      it "production" do
        object = Record.new(key: BattleKey.create("Kato_Hifumi-SiroChannel-20190317_140844"), remote_run: true).fetch
        is_asserted_by { object.dig("gameHash", "name") == "Kato_Hifumi-SiroChannel-20190317_140844" }
      end
    end
  end
end
