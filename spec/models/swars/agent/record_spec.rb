...
module Swars
  module Agent
    RSpec.describe Record, type: :model, swars_spec: true do
      it "development" do
        object = Record.new(key: BattleKey.wrap("DevUser1-DevUser2-20200101_123456")).fetch
        assert { object.dig("gameHash", "name") == "MockUser1-MockUser2-20000101_112233" }
      end
      it "production" do
        object = Record.new(key: BattleKey.wrap("Kato_Hifumi-SiroChannel-20190317_140844"), remote_run: true).fetch
