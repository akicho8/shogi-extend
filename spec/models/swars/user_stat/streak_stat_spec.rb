...
module Swars
  RSpec.describe UserStat::StreakStat, type: :model, swars_spec: true do
    def case1(list)
      user = User.create!
      ...
      user.user_stat.streak_stat.to_h
    end
...
# >> 
# >> Swars::UserStat::StreakStat
# >>   works
# >> 
# >> Top 1 slowest examples (1.62 seconds, 44.1% of total time):
# >>   Swars::UserStat::StreakStat works
# >>     1.62 seconds -:15
# >> 
