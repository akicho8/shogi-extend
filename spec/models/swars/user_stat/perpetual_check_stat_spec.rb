...
# >>   UserStat::PerpetualCheckStat 開幕千日手回数 / 引き分け数 開幕千日手回数
# >>     1.2 seconds -:14
# >>   UserStat::PerpetualCheckStat 開幕千日手回数 / 引き分け数 引き分け数
# >>     0.50682 seconds -:19
# >>   UserStat::PerpetualCheckStat 開幕千日手回数 / 引き分け数 バッジ ただの千日手
# >>     0.24646 seconds -:37
# >>   UserStat::PerpetualCheckStat 開幕千日手回数 / 引き分け数 バッジ 開幕千日手
# >>     0.20018 seconds -:33
# >> 
