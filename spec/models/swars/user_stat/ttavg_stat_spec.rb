...
module Swars
  RSpec.describe UserStat::TtavgStat, type: :model, swars_spec: true do
    describe "勝敗別平均手数" do
      before do
        @black = User.create!
      end
      ...
      def case1(judge_key, n)
        ...
        @black.user_stat.tavg_stat.to_chart.collect { |e| e[:value] }
      end
...
# >> 
# >> Swars::UserStat::TtavgStat
# >>   勝敗別平均手数
# >>     works
# >> 
# >> Top 1 slowest examples (1.57 seconds, 43.0% of total time):
# >>   Swars::UserStat::TtavgStat 勝敗別平均手数 works
# >>     1.57 seconds -:17
# >> 
