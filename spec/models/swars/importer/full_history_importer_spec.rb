...
module Swars
  module Importer
    RSpec.describe FullHistoryImporter, type: :model, swars_spec: true do
      it "works" do
        assert { Battle.count == 0 }
        FullHistoryImporter.new(user_key: "DevUser1").call
      ...
      describe "hard_crawl に対応して hard_crawled_at と soft_crawled_at を更新する" do
        it "見ているページに新しい対局がない場合はすぐに終わる (デフォルト)" do
          ...
          Timecop.freeze("2001-01-01") do
            FullHistoryImporter.new(user_key: "DevUser1").call # オプションなしの場合
          end
