...
module Swars
  RSpec.describe User::Stat::AverageMovesAtResignationStat, type: :model, swars_spec: true do
...
# >>
# >> User::Stat::AverageMovesAtResignationStat
# >>   勝敗別平均手数
# >>     works
# >>
# >> Top 1 slowest examples (1.57 seconds, 43.0% of total time):
# >>   User::Stat::AverageMovesAtResignationStat 勝敗別平均手数 works
# >>     1.57 seconds -:17
# >>
