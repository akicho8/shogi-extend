...
module Swars
  RSpec.describe User::Stat::MateSpeedStat, type: :model, swars_spec: true do
    describe "詰ます速度" do
      def case1(final_key)
