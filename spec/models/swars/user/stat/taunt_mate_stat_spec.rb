...
RSpec.describe Swars::User::Stat::TauntMateStat, type: :model, swars_spec: true do
  describe "1手詰を焦らして悦に入った回数" do
    def case1(last_sec)
      @black = Swars::User.create!
      Swars::Battle.create!(csa_seq: Swars::KifuGenerator.generate(time_list: [0, 0, last_sec]), final_key: :CHECKMATE) do |e|
    ...
    describe "バッジ" do
      ...
      it "1手詰焦らしマン" do
        case1
        assert { @black.stat.badge_stat.active?(:"1手詰焦らしマン") }
      end
    end
  end
end
...
# >>
# >> Swars::User::Stat::TauntMateStat
# >>   1手詰を焦らして悦に入った回数
# >>     works
# >>
# >> Swars::Top 1 slowest examples (1.49 seconds, 41.8% of total time):
# >>   Swars::User::Stat::TauntMateStat 1手詰を焦らして悦に入った回数 works
# >>     1.49 seconds -:18
# >>
