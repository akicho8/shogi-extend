...
module Swars
  RSpec.describe User::Stat::PerpetualCheckStat, type: :model, swars_spec: true do
    describe "開幕千日手回数 / 引き分け数" do
      def case1(n)
        ...
        black.stat.perpetual_check_stat
      end
...
# >>   User::Stat::PerpetualCheckStat 開幕千日手回数 / 引き分け数 開幕千日手回数
# >>     1.2 seconds -:14
# >>   User::Stat::PerpetualCheckStat 開幕千日手回数 / 引き分け数 引き分け数
# >>     0.50682 seconds -:19
# >>   User::Stat::PerpetualCheckStat 開幕千日手回数 / 引き分け数 バッジ ただの千日手
# >>     0.24646 seconds -:37
# >>   User::Stat::PerpetualCheckStat 開幕千日手回数 / 引き分け数 バッジ 開幕千日手
# >>     0.20018 seconds -:33
# >> 
