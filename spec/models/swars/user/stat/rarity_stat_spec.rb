...
module Swars
  RSpec.describe User::Stat::RarityStat, type: :model, swars_spec: true do
    describe "棋風" do
...
# >>   User::Stat::RarityStat 棋風 to_chart
# >>     1.24 seconds -:14
# >>   User::Stat::RarityStat 棋風 majority?
# >>     0.32325 seconds -:19
# >>   User::Stat::RarityStat 棋風 minority?
# >>     0.18998 seconds -:23
# >> 
