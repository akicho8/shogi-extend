...
# | outbreak_turn | Swars::Outbreak turn    | integer(4)     |             |                   | F     |
# | accessed_at   | 最終アクセス日時 | datetime       | NOT NULL    |                   | G     |
# | sfen_hash     | Swars::Sfen hash        | string(255)    |             |                   |       |
# | xmode_id      | Swars::Xmode            | integer(8)     | NOT NULL    |                   | H     |
# | preset_id     | Swars::Preset           | integer(8)     | NOT NULL    | => Swars::Preset#id      | I     |
# | rule_id       | Swars::Rule             | integer(8)     | NOT NULL    |                   | J     |
# | final_id      | Swars::Final            | integer(8)     | NOT NULL    |                   | K     |
# |---------------+------------------+----------------+-------------+-------------------+-------|
#
#- Swars::Remarks ----------------------------------------------------------------------
# Swars::Preset.has_many :swars_battles
