require "./setup"
_ { Swars::User["SugarHuuko"].stat.average_moves_at_resignation_stat.average }        # => "120.85 ms"
s { Swars::User["SugarHuuko"].stat.average_moves_at_resignation_stat.average }        # => 108
