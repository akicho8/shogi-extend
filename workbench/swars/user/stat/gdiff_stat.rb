require "./setup"
_ { Swars::User["SugarHuuko"].stat.gdiff_stat.average }        # => "159.74 ms"
s { Swars::User["SugarHuuko"].stat.gdiff_stat.average }        # => -1.48
