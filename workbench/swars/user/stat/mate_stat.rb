require "./setup"
s { Swars::User["SugarHuuko"].stat.mate_stat.count } # => 0
_ { Swars::User["SugarHuuko"].stat.mate_stat.count } # => "21.98 ms"
...
# >>   ↳ app/models/swars/user/stat/mate_stat.rb:12:in `count'
