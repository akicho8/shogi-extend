...
_ { Swars::User["SugarHuuko"].stat.all_tag.counts_hash } # => "206.90 ms"
ActsAsTaggableOn.strict_case_match = true
_ { Swars::User["SugarHuuko"].stat.all_tag.counts_hash } # => "27.60 ms"

# _ { Swars::User["SugarHuuko"].stat.all_tag.counts_hash[:"居飛車"] } # => "249.66 ms"
# s { Swars::User["SugarHuuko"].stat.all_tag.counts_hash[:"居飛車"] } # => 50
# s { Swars::User["SugarHuuko"].stat.win_tag.counts_hash[:"居飛車"] } # => 35
#
