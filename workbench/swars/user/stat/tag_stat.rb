...
_ { Swars::User["SugarHuuko"].stat.tag_stat.counts_hash }     # => "204.09 ms"
Swars::User["SugarHuuko"].stat.tag_stat.win_count(:"居飛車")  # => 35
Swars::User["SugarHuuko"].stat.tag_stat.lose_count(:"居飛車") # => 15
Swars::User["SugarHuuko"].stat.tag_stat.draw_count(:"居飛車") # => 0
