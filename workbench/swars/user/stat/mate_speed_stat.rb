require "./setup"
_ { Swars::User["SugarHuuko"].stat.mate_speed_stat.average }        # => "119.50 ms"
s { Swars::User["SugarHuuko"].stat.mate_speed_stat.average }        # => 1.86
...
# >>   ↳ app/models/swars/stat/mate_speed_stat.rb:15:in `average'
