require "./setup"
_ { Swars::User["SugarHuuko"].stat.daily_win_loss_list_stat.to_chart }        # => "254.99 ms"
s { Swars::User["SugarHuuko"].stat.daily_win_loss_list_stat.to_chart }        # => [{:battled_on=>Wed, 05 Jun 2024, :day_type=>nil, :judge_counts=>{:win=>4, :lose=>0}}, {:battled_on=>Sat, 01 Jun 2024, :day_type=>:info, :judge_counts=>{:win=>5, :lose=>2}}, {:battled_on=>Fri, 31 May 2024, :day_type=>nil, :judge_counts=>{:win=>26, :lose=>13}}]
...
# >>   ↳ app/models/swars/stat/daily_win_loss_list_stat.rb:24:in `collect'
