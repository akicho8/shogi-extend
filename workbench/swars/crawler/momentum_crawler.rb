...
# >> 最後のページと思われるので終わる
# >> 2024-11-22T10:57:08.341Z pid=71816 tid=1heg INFO: Sidekiq 7.1.6 connecting to Redis with options {:size=>10, :pool_name=>"internal", :url=>"redis://localhost:6379/4"}
...
# >> |         at_least | 1                                |
# >> |            limit | 2                                |
# >> | hard_crawled_old | 86400                            |
# >> |------------------+----------------------------------|
# >> |---------------------+--------+------------+------+-----+-----+------+----------+------------+---------------------+--------|
# >> | 日時                | ID     | ユーザー名 | 段級 | 前  | 後  | 差分 | 検索回数 | 最終検索   | 最終対局            | エラー |
# >> |---------------------+--------+------------+------+-----+-----+------+----------+------------+---------------------+--------|
# >> | 2024-11-22 19:57:08 | 135378 | raminitk   | 初段 | 104 | 104 |   +0 |       14 | 9/13 00:28 | 2024-10-17 22:09:05 |        |
# >> | 2024-11-22 19:57:08 | 181315 | abc        | 1級  |   1 |   1 |   +0 |        8 | 9/29 13:59 | 2024-07-06 15:53:28 |        |
# >> |---------------------+--------+------------+------+-----+-----+------+----------+------------+---------------------+--------|
