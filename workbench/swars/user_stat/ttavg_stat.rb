require "../setup"
_ { Swars::User["SugarHuuko"].user_stat.ttavg_stat.average }        # => "120.85 ms"
s { Swars::User["SugarHuuko"].user_stat.ttavg_stat.average }        # => 108
...
# >>   ↳ app/models/swars/user_stat/ttavg_stat.rb:15:in `average'
