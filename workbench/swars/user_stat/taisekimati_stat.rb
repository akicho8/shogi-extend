require "../setup"
_ { Swars::User["SugarHuuko"].user_stat.taisekimati_stat.count } # => "218.52 ms"
s { Swars::User["SugarHuuko"].user_stat.taisekimati_stat.count } # => 0
...
# >>   ↳ app/models/swars/user_stat/taisekimati_stat.rb:18:in `block in count'
