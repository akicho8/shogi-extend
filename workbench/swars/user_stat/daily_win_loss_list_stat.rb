require "../setup"
_ { Swars::User["SugarHuuko"].user_stat.daily_win_loss_list_stat.to_chart_slow }   # => "297.36 ms"

_ { Swars::User["SugarHuuko"].user_stat.daily_win_loss_list_stat.to_chart }        # => "47.28 ms"
s { Swars::User["SugarHuuko"].user_stat.daily_win_loss_list_stat.to_chart }        # => [{:battled_on=>Tue, 21 May 2024, :day_type=>nil, :judge_counts=>{:win=>7, :lose=>3}}, {:battled_on=>Mon, 20 May 2024, :day_type=>nil, :judge_counts=>{:win=>25, :lose=>4}}, {:battled_on=>Sun, 19 May 2024, :day_type=>:danger, :judge_counts=>{:win=>2, :lose=>0}}, {:battled_on=>Wed, 15 May 2024, :day_type=>nil, :judge_counts=>{:win=>5, :lose=>1}}]
_ { Swars::User["SugarHuuko"].user_stat.daily_win_loss_list_stat.to_chart_slow }   # => "80.97 ms"
s { Swars::User["SugarHuuko"].user_stat.daily_win_loss_list_stat.to_chart_slow }   # => [{:battled_on=>Tue, 21 May 2024, :day_type=>nil, :judge_counts=>{"win"=>7, "lose"=>3}}, {:battled_on=>Mon, 20 May 2024, :day_type=>nil, :judge_counts=>{"win"=>25, "lose"=>4}}, {:battled_on=>Sun, 19 May 2024, :day_type=>:danger, :judge_counts=>{"win"=>2, "lose"=>0}}, {:battled_on=>Wed, 15 May 2024, :day_type=>nil, :judge_counts=>{"win"=>5, "lose"=>1}}]
...
# >>   ↳ app/models/swars/user_stat/daily_win_loss_list_stat.rb:40:in `group_by'
# >>   Swars::Battle Load (0.2ms)  SELECT `swars_battles`.* FROM `swars_battles` WHERE `swars_battles`.`id` = 49247810 LIMIT 1
# >>   ↳ app/models/swars/user_stat/daily_win_loss_list_stat.rb:40:in `block in to_chart_slow'
