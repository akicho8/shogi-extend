...
# >> |               medal_stat | [{:message=>"居飛車党", :method=>"raw", :name=>"⬆️", :type=>nil}, {:message=>"嬉野流で勝った", :method=>"raw", :name=>"↗️", :type=>nil}, {:message=>"3連勝した", :method=>"raw", :name=>"🍡", :type=>nil}, {:message=>"千日手をした", :method=>"raw", :name=>"🍌", :type=>nil}]                                                |
