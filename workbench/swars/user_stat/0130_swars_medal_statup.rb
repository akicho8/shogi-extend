...
tp user1.user_stat.medal_stat.to_debug_hash
tp user1.user_stat.medal_stat.to_a
tp user1.user_stat.to_hash
...
# >> |               grade_by_rules_stat.to_chart | {:ten_min=>{:rule_name=>"10分", :grade_name=>"30級"}, :three_min=>{:rule_name=>"3分", :grade_name=>nil}, :ten_sec=>{:rule_name=>"10秒", :grade_name=>nil}}                                                                                                                                                                           |
# >> |             judge_counts | {"win"=>3, "lose"=>0}                                                                                                                                                                                                                                                                                                                |
# >> |               judge_keys | ["win", "win", "win"]                                                                                                                                                                                                                                                                                                                |
# >> |               medal_stat | [{:message=>"居飛車党", :method=>"raw", :name=>"⬆️", :type=>nil}, {:message=>"嬉野流で勝った", :method=>"raw", :name=>"↗️", :type=>nil}, {:message=>"3連勝した", :method=>"raw", :name=>"🍡", :type=>nil}, {:message=>"千日手があった", :method=>"raw", :name=>"🍌", :type=>nil}]                                                |
...
# >> | consecutive_wins_and_losses_stat.to_h | {"win"=>3, "lose"=>0}                                                                                                                                                                                                                                                                                                                |
# >> |           daily_win_loss_list_stat.to_chart | [{:battled_on=>Fri, 10 May 2024, :day_type=>nil, :judge_counts=>{"win"=>1, "lose"=>0}, :all_tags=>nil}, {:battled_on=>Thu, 09 May 2024, :day_type=>nil, :judge_counts=>{"win"=>1, "lose"=>0}, :all_tags=>nil}, {:battled_on=>Sat, 01 Jan 2000, :day_type=>:info,...                                                                  |
...
# >> |     matrix_stat.vs_attack_items | [{:tag=>{"name"=>"2手目△３ニ飛戦法", "count"=>2}, :appear_ratio=>0.6666666666666666, :judge_counts=>{"win"=>2, "lose"=>0}}]                                                                                                                                                                                                         |
