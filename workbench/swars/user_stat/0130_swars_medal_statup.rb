...
# >> |               grade_stat.to_chart | {:ten_min=>{:rule_name=>"10分", :grade_name=>"30級"}, :three_min=>{:rule_name=>"3分", :grade_name=>nil}, :ten_sec=>{:rule_name=>"10秒", :grade_name=>nil}}                                                                                                                                                                           |
...
# >> | streak_stat.to_h | {"win"=>3, "lose"=>0}                                                                                                                                                                                                                                                                                                                |
# >> |           day_stat.to_chart | [{:battled_on=>Fri, 10 May 2024, :day_type=>nil, :judge_counts=>{"win"=>1, "lose"=>0}, :all_tags=>nil}, {:battled_on=>Thu, 09 May 2024, :day_type=>nil, :judge_counts=>{"win"=>1, "lose"=>0}, :all_tags=>nil}, {:battled_on=>Sat, 01 Jan 2000, :day_type=>:info,...                                                                  |
