...
# ShareBoard::Room.mock(room_key: 'test_room', battle_attribues: {sfen: sfen})
tp ShareBoard::Room

# >> |----+----------------------------------+---------------+---------------------------+---------------------------+---------------------+-------------|
# >> | id | key                              | battles_count | created_at                | updated_at                | chat_messages_count | name        |
# >> |----+----------------------------------+---------------+---------------------------+---------------------------+---------------------+-------------|
# >> |  1 | test_room                        |             1 | 2025-10-12 20:27:30 +0900 | 2025-10-12 20:27:30 +0900 |                   0 | (room.name) |
# >> |  2 | 0692ab8dc302f8820eff0a9abd37d54e |             1 | 2025-10-12 20:27:30 +0900 | 2025-10-12 20:27:30 +0900 |                   0 | (room.name) |
# >> |----+----------------------------------+---------------+---------------------------+---------------------------+---------------------+-------------|
