...
hv = counts_hash # => {"棋力" => "九段", "種類" => "戦法", "スタイル" => "王道", "名前" => "原始棒銀", "勝率" => 1.0, "頻度" => 1.0, "出現数" => 1, "勝ち" => 1, "負け" => 0, "引分" => 0}
tp hv
...
# ~> 	from -:30:in 'block in <main>'
# ~> 	from -:30:in 'Hash#transform_values'
# ~> 	from -:30:in '<main>'
# >> 2025-06-01 19:03:15 1/1 100.00 % T1 TacticCrossScript
# >> |----------+------|
# >> |     棋力 | 九段 |
# >> |     種類 | 戦法 |
# >> | スタイル | 王道 |
