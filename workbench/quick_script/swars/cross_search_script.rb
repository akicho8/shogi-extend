...
QuickScript::Swars::CrossSearchScript.new.bookmark_url # => "http://localhost:4000/lab/swars/cross-search?bg_request_key=&bookmark_url_key=false&download_key=&exec=true&final_keys=&new_tab_key=&preset_keys=&query=&range_max=&rule_keys=&want_max=&x_grade_keys=&x_judge_keys=&x_style_keys=&x_tag=&x_tag_cond_key=&x_user_keys=&xmode_keys=&y_grade_keys=&y_judge_keys=&y_style_keys=&y_tag=&y_tag_cond_key=&y_user_keys="
