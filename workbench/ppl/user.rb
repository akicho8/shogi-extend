...
# >> |----+---------------+---------------------------+---------------------------|
# >> | 16 |             5 | 2025-08-15 11:11:04 +0900 | 2025-08-15 11:11:04 +0900 |
# >> | 17 |             6 | 2025-08-15 11:11:04 +0900 | 2025-08-15 11:11:04 +0900 |
# >> | 18 |             7 | 2025-08-15 11:11:04 +0900 | 2025-08-15 11:11:04 +0900 |
# >> |----+---------------+---------------------------+---------------------------|
# >> |----+-----------+-------+---------+---------+-----------------+---------+-------------------------+-------------------------+---------------+----------------------+-------------------+---------------------+-------------------+-------------------+---------------------------+---------------------------|
...
# >> |----+-----------+-------+---------+---------+-----------------+---------+-------------------------+-------------------------+---------------+----------------------+-------------------+---------------------+-------------------+-------------------+---------------------------+---------------------------|
# >> | 13 |           | alice |       1 |       3 |               1 |       3 |                      16 |                       7 |             1 |                   14 |                 5 |                  16 |                 7 |                 3 | 2025-08-15 11:11:04 +0900 | 2025-08-15 11:11:04 +0900 |
# >> |----+-----------+-------+---------+---------+-----------------+---------+-------------------------+-------------------------+---------------+----------------------+-------------------+---------------------+-------------------+-------------------+---------------------------+---------------------------|
# >> |----+------------------+---------+-----------+-----------+-----+-----+------+----+---------------------------+---------------------------|
# >> | id | league_season_id | user_id | result_id | start_pos | age | win | lose | ox | created_at                | updated_at                |
# >> |----+------------------+---------+-----------+-----------+-----+-----+------+----+---------------------------+---------------------------|
# >> | 14 |               16 |      13 |         4 |         0 |   1 |   3 |    0 |    | 2025-08-15 11:11:04 +0900 | 2025-08-15 11:11:04 +0900 |
# >> | 15 |               17 |      13 |         3 |         0 |   2 |   2 |    0 |    | 2025-08-15 11:11:04 +0900 | 2025-08-15 11:11:04 +0900 |
# >> | 16 |               18 |      13 |         1 |         0 |   3 |   1 |    0 |    | 2025-08-15 11:11:04 +0900 | 2025-08-15 11:11:04 +0900 |
# >> |----+------------------+---------+-----------+-----------+-----+-----+------+----+---------------------------+---------------------------|
