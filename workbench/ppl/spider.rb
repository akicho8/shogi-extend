...
rows = Ppl::Spider.new(generation: 66, max: 1, verbose: false, sleep: 0).call # => [{result_key: "維", start_pos: 1, name: "古賀悠聖", _mentor: "中田功", age: 18, win: 6, lose: 12, ox: "oxxoxxxoxxxxooxxxo"}]
