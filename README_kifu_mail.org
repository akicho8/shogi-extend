...
| 投了ボタンから実行     | http://localhost:4000/share-board?room_key=my_room&user_name=a&fixed_member=a,b,c,d,e&fixed_order_state=to_o2_state&fixed_order=a,b,c,d&handle_name_validate=false&autoexec=cc_auto_start |
