...
| 投了ボタンから実行     | http://localhost:4000/share-board?room_key=my_room&user_name=a&FIXED_MEMBER=a,b,c,d,e&FIXED_ORDER=a,b,c,d&room_after_create=cc_auto_start |
...
nuxt_side/components/ShareBoard/mod_resign/app_kifu_mail.js
