...
| 投了ボタンから実行     | http://localhost:4000/share-board?room_code=my_room&fixed_user_name=a&fixed_member_names=a,b,c,d,e&fixed_order_state=to_o2_state&fixed_order_names=a,b,c,d&handle_name_validate=false&autoexec=cc_create,cc_play_handle |
