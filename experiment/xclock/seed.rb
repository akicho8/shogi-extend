...
# Xclock::Question.count            # => 1
# exit

Xclock::Lineage.all.collect(&:key)                 # => ["詰将棋", "実戦詰め筋", "手筋", "必死", "必死逃れ", "定跡", "秘密"]
Xclock::Judge.all.collect(&:key)                   # => ["win", "lose", "draw", "pending"]
Xclock::Rule.all.collect(&:key)                    # => ["sy_marathon", "sy_singleton", "sy_hybrid"]
Xclock::Final.all.collect(&:key)                   # => ["f_give_up", "f_disconnect", "f_success", "f_draw", "f_pending"]

10.times do
  Xclock::Season.create!
end
Xclock::Season.count              # => 11
...
Xclock::Question.count           # => 23

question = Xclock::Question.first!
question.lineage.key               # => "詰将棋"

# 最初の問題だけゴミ箱へ
question = Xclock::Question.first!
# question.update!(folder: question.user.xclock_trash_box) の方法はださい
question.user.xclock_trash_box.questions << question
question.folder # => #<Xclock::TrashBox id: 3, user_id: 1, type: "Xclock::TrashBox", created_at: "2020-07-03 12:06:18", updated_at: "2020-07-03 12:06:18">

# 2番目の問題は下書きへ
question = Xclock::Question.second!
question.folder_key           # => "active"
question.folder_key = :draft
question.save!                 # => true
question.folder.type           # => "Xclock::DraftBox"
# tp question.as_json
# exit

# 部屋を立てる
room = Xclock::Room.create! do |e|
...
battle                          # => #<Xclock::Battle id: 1, room_id: 1, parent_id: nil, rule_id: 1, final_id: 5, begin_at: "2020-07-03 12:06:35", end_at: nil, battle_pos: 0, created_at: "2020-07-03 12:06:35", updated_at: "2020-07-03 12:06:35">

battle.users.count                # => 2
battle.battle_pos               # => 0

battle2 = battle.battle_chain_create # => #<Xclock::Battle id: 2, room_id: 1, parent_id: 1, rule_id: 1, final_id: 5, begin_at: "2020-07-03 12:06:35", end_at: nil, battle_pos: 1, created_at: "2020-07-03 12:06:35", updated_at: "2020-07-03 12:06:35">
...
# # すべての問題に解答する
Xclock::Question.all.each.with_index do |question, i|
  ox_mark_key = Xclock::OxMarkInfo[i.modulo(Xclock::OxMarkInfo.count)].key
  user1.xclock_histories.create!(question: question, ox_mark: Xclock::OxMark.fetch(ox_mark_key))
end

# tp Xclock::Season.all
# tp user1.xclock_season_xrecords
# 
# exit
puts user1.info
# exit
...
# 切断したことにする
user1.xclock_latest_xrecord.update!(final: Xclock::Final.fetch(:f_disconnect))
tp user1.xclock_latest_xrecord
tp user1.xclock_main_xrecord

# Good, Bad, Clip
user1.xclock_good_marks.create!(question: Xclock::Question.first!)
user1.xclock_bad_marks.create!(question: Xclock::Question.second!)
user1.xclock_clip_marks.create!(question: Xclock::Question.third!)

# 問題に対してコメント
5.times do
  question = Xclock::Question.first!
  question.messages.create!(user: user1, body: "message") # => #<Xclock::QuestionMessage id: 1, user_id: 1, question_id: 1, body: "message", created_at: "2020-07-03 12:06:36", updated_at: "2020-07-03 12:06:36">, #<Xclock::QuestionMessage id: 2, user_id: 1, question_id: 1, body: "message", created_at: "2020-07-03 12:06:37", updated_at: "2020-07-03 12:06:37">, #<Xclock::QuestionMessage id: 3, user_id: 1, question_id: 1, body: "message", created_at: "2020-07-03 12:06:37", updated_at: "2020-07-03 12:06:37">, #<Xclock::QuestionMessage id: 4, user_id: 1, question_id: 1, body: "message", created_at: "2020-07-03 12:06:38", updated_at: "2020-07-03 12:06:38">, #<Xclock::QuestionMessage id: 5, user_id: 1, question_id: 1, body: "message", created_at: "2020-07-03 12:06:39", updated_at: "2020-07-03 12:06:39">
...
tp Xclock.info
# >> load: /Users/ikeda/src/shogi_web/app/models/xclock/questions.yml (13)
# >> |--------------------+--------|
# >> |               名前 | 運営   |
# >> |       レーティング | 1500.0 |
# >> |             クラス | C-     |
...
# >> |------------------------+-------+--------|
# >> | User                   |     9 |      9 |
# >> | Xclock::Question         |    23 |     23 |
# >> | Xclock::QuestionMessage  |     5 |      5 |
# >> | Xclock::Room             |     1 |      1 |
# >> | Xclock::RoomMembership   |     2 |      2 |
# >> | Xclock::RoomMessage      |     0 |        |
# >> | Xclock::Battle           |     2 |      2 |
# >> | Xclock::BattleMembership |     4 |      4 |
# >> | Xclock::Season           |    11 |     11 |
# >> | Xclock::SeasonXrecord    |    10 |     10 |
# >> | Xclock::MainXrecord      |     9 |      9 |
# >> | Xclock::Setting          |     9 |      9 |
# >> | Xclock::GoodMark         |     1 |      1 |
# >> | Xclock::BadMark          |     1 |      1 |
# >> | Xclock::ClipMark         |     1 |      1 |
