...
user = User.sysop
3.times do |i|
  question = user.xclock_questions.create! do |e|
...
# }.deep_symbolize_keys
#
# question = user.xclock_questions.find_or_initialize_by(id: params[:question][:id])
# question.update_from_js(params)
# question
# question.moves_answers.collect{|e|e.moves_str} # => ["4c5b"]

# lobby = Xclock::LobbyChannel.new
# lobby                           # =>
...
# Xclock::Battle.destroy_all

# user1 = User.create!
# user2 = User.create!
#
# battle = Xclock::Battle.create! do |e|
#   e.memberships.build(user: user1, judge_key: "win")
#   e.memberships.build(user: user2, judge_key: "lose")
# end

# battle.messages.create!(user: user1, body: "a") # => #<Xclock::Message id: 4, user_id: 19, battle_id: 4, body: "a", created_at: "2020-05-05 14:45:49", updated_at: "2020-05-05 14:45:49">
# tp user1.xclock_season_xrecord.update!(rating: 1600)
# tp user1.xclock_season_xrecord

# def initialize(connection, identifier, params = {})
# Xclock::BattleChannel.new(nil, nil, a: 1) # =>
