...
user.avatar                                                                        # => #<ActiveStorage::Attached::One:0x00007fa391a96fc8 @name="avatar", @record=#<Colosseum::User id: 42, key: "3e4cddd3e5ac8017512f070cfe5e1ac4", name: "名無しの棋士33号", joined_at: "2018-10-18 02:43:46", fighting_at: nil, matching_at: nil, cpu_brain_key: nil, user_agent: "", race_key: "human", created_at: "2018-10-18 02:43:46", updated_at: "2018-10-18 02:43:48", email: "3e4cddd3e5ac8017512f070cfe5e1ac4@localhost">, @dependent=:purge_later>
