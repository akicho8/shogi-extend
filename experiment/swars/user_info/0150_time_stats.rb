...
# s = Swars::User.find_by!(user_key: "SugarHuuko").user_info.medal_set.new_scope
...
Swars::User.find_by!(user_key: "SugarHuuko").user_info.medal_set.start_draw_ratio # => 0.18
Swars::User.find_by!(user_key: "SugarHuuko").user_info.medal_set.draw_ratio       # => 0.14
