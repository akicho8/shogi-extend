...
# >> |     every_my_attack_list | [{:tag=>{"name"=>"新嬉野流", "count"=>2}, :appear_ratio=>0.6666666666666666, :judge_counts=>{"win"=>2, "lose"=>0}}]                                                                                                                                                                                                                  |
# >> |     every_vs_attack_list | [{:tag=>{"name"=>"2手目△３ニ飛戦法", "count"=>2}, :appear_ratio=>0.6666666666666666, :judge_counts=>{"win"=>2, "lose"=>0}}]                                                                                                                                                                                                         |
