...
# >> |----------------+--------+------+------|
# >> |--------------------------+--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
# >> |              onetime_key | f8480113186c455475b8d33b8bda69dd                                                                                                                                                                                                                                                                                                     |
# >> |               sample_max | 50                                                                                                                                                                                                                                                                                                                                   |
# >> |                     rule |                                                                                                                                                                                                                                                                                                                                      |
# >> |                    xmode |                                                                                                                                                                                                                                                                                                                                      |
...
# >> |           every_day_list | [{:battled_on=>Mon, 06 May 2024, :day_type=>:danger, :judge_counts=>{"win"=>1, "lose"=>0}, :all_tags=>nil}, {:battled_on=>Sun, 05 May 2024, :day_type=>:danger, :judge_counts=>{"win"=>1, "lose"=>0}, :all_tags=>nil}, {:battled_on=>Sat, 01 Jan 2000, :day_type...                                                                  |
# >> |         every_grade_list | [{:grade_name=>"30級", :judge_counts=>{:win=>3, :lose=>0}, :appear_ratio=>1.0}]                                                                                                                                                                                                                                                      |
# >> |     every_my_attack_list | [{:tag=>{"name"=>"新嬉野流", "count"=>2}, :appear_ratio=>0.6666666666666666, :judge_counts=>{"win"=>2, "lose"=>0}}, {:tag=>{"name"=>"力戦", "count"=>1}, :appear_ratio=>0.3333333333333333, :judge_counts=>{"win"=>1, "lose"=>0}}]                                                                                                   |
# >> |     every_vs_attack_list | [{:tag=>{"name"=>"2手目△３ニ飛戦法", "count"=>2}, :appear_ratio=>0.6666666666666666, :judge_counts=>{"win"=>2, "lose"=>0}}, {:tag=>{"name"=>"力戦", "count"=>1}, :appear_ratio=>0.3333333333333333, :judge_counts=>{"win"=>1, "lose"=>0}}]                                                                                          |
