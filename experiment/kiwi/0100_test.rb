...
# >> |    recordable_id | 54                                                                                                                                                                                                                                                                  |
# >> |       all_params | {:media_builder_params=>{:tmpdir_remove=>false, :recipe_key=>"is_recipe_gif", :audio_theme_key=>"audio_theme_is_none", :color_theme_key=>"color_theme_is_real_wood1", :cover_text=>"(cover_text.title)\n(cover_text.description)", :renderer_override_params=>{}... |
