...
# >> |    recordable_id | 54                                                                                                                                                                                                                                                                  |
# >> |       all_params | {:media_builder_params=>{:tmpdir_remove=>false, :recipe_key=>"is_recipe_gif", :audio_theme_key=>"is_audio_theme_none", :color_theme_key=>"is_color_theme_groovy_board_texture01", :cover_text=>"(cover_text.title)\n(cover_text.description)", :renderer_override_params=>{}... |
