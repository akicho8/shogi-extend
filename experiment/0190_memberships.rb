...
tp Membership.all
# >>    (0.2ms)  BEGIN
# >>   SQL (0.6ms)  INSERT INTO `battle_rooms` (`room_owner_id`, `ps_preset_key`, `po_preset_key`, `lifetime_key`, `name`, `kifu_body_sfen`, `clock_counts`, `turn_max`, `created_at`, `updated_at`) VALUES (35, '平手', '平手', 'lifetime_m5', '野良1号 vs 野良2号', 'position sfen lnsgkgsnl/1r5b1/ppppppppp/9/9/9/PPPPPPPPP/1B5R1/LNSGKGSNL b - 1', '---\n:black: []\n:white: []\n', 0, '2018-05-06 09:52:40', '2018-05-06 09:52:40')
# >> nil
