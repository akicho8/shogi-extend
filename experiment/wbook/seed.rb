...
Wbook::Question.count             # => 0
Wbook::Lineage.all.collect(&:key) # => []
...
tp Wbook.info
# ~> /Users/ikeda/src/shogi-extend/app/models/concerns/memory_record_bind.rb:51:in `rescue in fetch': Wbook::Rule.fetch(:marathon_rule) (ArgumentError)
# ~> keys: []
# ~> 	from /Users/ikeda/src/shogi-extend/app/models/concerns/memory_record_bind.rb:44:in `fetch'
# ~> 	from /Users/ikeda/src/shogi-extend/app/models/wbook/setting.rb:27:in `block in <class:Setting>'
...
# ~> 	from -:11:in `<main>'
# ~> /usr/local/var/rbenv/versions/2.6.5/lib/ruby/gems/2.6.0/gems/activerecord-6.0.3.2/lib/active_record/core.rb:211:in `find_by!': Couldn't find Wbook::Rule (ActiveRecord::RecordNotFound)
