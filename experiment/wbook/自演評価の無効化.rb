...
user1.wbook_good_marks.create!(question: question1)
user1.wbook_good_marks.count     # => 1

user2.wbook_bad_marks.create!(question: question1)
user2.wbook_bad_marks.count     # => 1

user1.wbook_bad_marks.create!(question: question1)
user1.wbook_bad_marks.count     # => 1
...
# end
Wbook::Question.good_bad_click_by_owner_reject_all
