...
# ~> /usr/local/var/rbenv/versions/2.6.5/lib/ruby/gems/2.6.0/gems/activerecord-6.0.3.2/lib/active_record/inheritance.rb:205:in `compute_type': uninitialized constant User::Wbook::MainXrecord (NameError)
