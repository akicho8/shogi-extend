...
question.folder # => #<Actb::TrashBox id: 3, user_id: 1, type: "Actb::TrashBox", created_at: "2020-07-03 12:06:18", updated_at: "2020-07-03 12:06:18">
...
battle                          # => #<Actb::Battle id: 1, room_id: 1, parent_id: nil, rule_id: 1, final_id: 5, begin_at: "2020-07-03 12:06:35", end_at: nil, battle_pos: 0, created_at: "2020-07-03 12:06:35", updated_at: "2020-07-03 12:06:35">
...
5.times do
  question = Actb::Question.first!
  question.messages.create!(user: user1, body: "message") # => #<Actb::QuestionMessage id: 1, user_id: 1, question_id: 1, body: "message", created_at: "2020-07-03 12:06:36", updated_at: "2020-07-03 12:06:36">, #<Actb::QuestionMessage id: 2, user_id: 1, question_id: 1, body: "message", created_at: "2020-07-03 12:06:37", updated_at: "2020-07-03 12:06:37">, #<Actb::QuestionMessage id: 3, user_id: 1, question_id: 1, body: "message", created_at: "2020-07-03 12:06:37", updated_at: "2020-07-03 12:06:37">, #<Actb::QuestionMessage id: 4, user_id: 1, question_id: 1, body: "message", created_at: "2020-07-03 12:06:38", updated_at: "2020-07-03 12:06:38">, #<Actb::QuestionMessage id: 5, user_id: 1, question_id: 1, body: "message", created_at: "2020-07-03 12:06:39", updated_at: "2020-07-03 12:06:39">
...
# >> | 15 | a24b7e3d0f93a7e80564611c4c2ac1db |       1 |         1 |          1 | 4k4/9/4G4/9/9/9/9/9/9 b G2r2b2g4s4n4l2p 1                                |            180 |                5 | (title1)               | (description) | (hint_desc) | (other_author) |                   |                  |                     | 2020-07-03 21:06:29 +0900 | 2020-07-02 22:06:29 +0900 |       0.0 |                   3 |               1 |                0 |               0 |                0 |              0 |
...
# >> | 17 | 60be8e67f025c26cd01e2e3be3b062a2 |       1 |         1 |          1 | 4k4/9/4G4/9/9/9/9/9/9 b G2r2b2g4s4n4l4p 1                                |            180 |                5 | (title3)               | (description) | (hint_desc) | (other_author) |                   |                  |                     | 2020-07-03 21:06:30 +0900 | 2020-07-03 00:06:30 +0900 |       0.0 |                   3 |               1 |                0 |               0 |                0 |              0 |
...
# >> | 19 | 58469d87abf05095e66c28d84cdd48d1 |       1 |         1 |          1 | 4k4/9/4G4/9/9/9/9/9/9 b G2r2b2g4s4n4l6p 1                                |            180 |                5 | (title5)               | (description) | (hint_desc) | (other_author) |                   |                  |                     | 2020-07-03 21:06:32 +0900 | 2020-07-03 02:06:32 +0900 |       0.0 |                   3 |               1 |                0 |               0 |                0 |              0 |
...
# >> | 21 | 9251b1024d9665dc36ae724f47b44020 |       1 |         1 |          1 | 4k4/9/4G4/9/9/9/9/9/9 b G2r2b2g4s4n4l8p 1                                |            180 |                5 | (title7)               | (description) | (hint_desc) | (other_author) |                   |                  |                     | 2020-07-03 21:06:33 +0900 | 2020-07-03 04:06:33 +0900 |       0.0 |                   3 |               1 |                0 |               0 |                0 |              0 |
...
# >> | 23 | 6ab9d03c89f16c7e785e1b1887914e0e |       1 |         1 |          1 | 4k4/9/4G4/9/9/9/9/9/9 b G2r2b2g4s4n4l10p 1                               |            180 |                5 | (title9)               | (description) | (hint_desc) | (other_author) |                   |                  |                     | 2020-07-03 21:06:34 +0900 | 2020-07-03 06:06:34 +0900 |       0.0 |                   3 |               1 |                0 |               0 |                0 |              0 |
# >> |----+----------------------------------+---------+-----------+------------+--------------------------------------------------------------------------+----------------+------------------+------------------------+---------------+-------------+----------------+-------------------+------------------+---------------------+---------------------------+---------------------------+-----------+---------------------+-----------------+------------------+-----------------+------------------+----------------|
# >> |------------------------+-------+--------|
# >> | model                  | count | 最終ID |
# >> |------------------------+-------+--------|
...
# >> | Actb::Season           |    11 |     11 |
# >> | Actb::SeasonXrecord    |    10 |     10 |
# >> | Actb::MainXrecord      |     9 |      9 |
# >> | Actb::Setting          |     9 |      9 |
# >> | Actb::GoodMark         |     1 |      1 |
# >> | Actb::BadMark          |     1 |      1 |
# >> | Actb::ClipMark         |     1 |      1 |
