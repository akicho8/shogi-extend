...
tp battle
tp battle.meta_info[:header]
tp battle.memberships # => #<ActiveRecord::Associations::CollectionProxy [#<General::Membership id: 21, battle_id: 11, judge_key: "win", location_key: "black", position: 0, created_at: "2018-03-11 03:18:20", updated_at: "2018-03-11 03:18:20">, #<General::Membership id: 22, battle_id: 11, judge_key: "lose", location_key: "white", position: 1, created_at: "2018-03-11 03:18:20", updated_at: "2018-03-11 03:18:20">]>
tp battle.convert_infos.count  # => 


# ~> /usr/local/var/rbenv/versions/2.5.0/lib/ruby/gems/2.5.0/gems/activemodel-5.1.5/lib/active_model/attribute_methods.rb:432:in `method_missing': undefined method `convert_infos' for #<General::Battle:0x00007fd8ec1d9ff8> (NoMethodError)
...
# >> |------------+--------|
# >> |----+--------------------------+-----------+--------------+----------+---------------------------+---------------------------|
# >> | id | battle_id | judge_key | location_key | position | created_at                | updated_at                |
# >> |----+--------------------------+-----------+--------------+----------+---------------------------+---------------------------|
