...
# >>   SQL (0.2ms)  INSERT INTO `chat_memberships` (`preset_key`, `chat_room_id`, `user_id`, `location_key`, `position`, `created_at`, `updated_at`) VALUES ('平手', 16, 35, 'black', 0, '2018-05-06 09:52:40', '2018-05-06 09:52:40')
# >> nil
...
# >>   SQL (0.2ms)  INSERT INTO `chat_memberships` (`preset_key`, `chat_room_id`, `user_id`, `location_key`, `position`, `created_at`, `updated_at`) VALUES ('平手', 16, 36, 'white', 1, '2018-05-06 09:52:40', '2018-05-06 09:52:40')
# >>    (0.4ms)  COMMIT
...
# >>   User Load (0.6ms)  SELECT `users`.* FROM `users` INNER JOIN `chat_memberships` ON `users`.`id` = `chat_memberships`.`user_id` WHERE `chat_memberships`.`chat_room_id` = 16 ORDER BY `chat_memberships`.`position` ASC
