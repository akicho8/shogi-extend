...
# >> |        win_user_id | 56                                                                                                                                                                                                                                                                                                                          |
# >> |           turn_max | 152                                                                                                                                                                                                                                                                                                                         |
# >> |          meta_info | {:header=>{"先手"=>"72b4b 30級", "後手"=>"319e0 30級", "開始日時"=>"2020/01/06 10:56:11", "棋戦"=>"将棋ウォーズ(10分切れ負け 香落ち)", "場所"=>"http://kif-pona.heroz.jp/games/86ecb7e6ee79a3d563602c2c69471744", "持ち時間"=>"00:10+00", "下手の備考"=>"居飛車, 相居飛車", "上手の備考"=>"居飛車, 相居飛車"}, :detail_n... |
